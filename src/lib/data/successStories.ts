...
export const successStories: SuccessStory[] = [
  ...
  },
  {
    ...
    timelineMonths: 4,
    quote: "From Cairo to Cambridge! VANHSYA helped me secure admission to my dream university and navigate the visa process seamlessly.",
...
export const getStoriesByCountry = (country: string) => {
  return successStories.filter(story => 
    story.countryTo.toLowerCase() === country.toLowerCase()
  );
};
