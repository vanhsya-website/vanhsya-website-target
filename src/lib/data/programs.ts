...
export const programs: Program[] = [
  {
    ...
    description:
      'Share VANHSYA with friends and family, get paid when they sign up for our services. The more you refer, the more you earn!',
  ...
  },
  {
    ...
    description:
      'Every VANHSYA application automatically enters you into our monthly lucky draw with amazing prizes including flight tickets and visa fee refunds.',
    href: '/lucky-draw',
    badge: 'WIN',
    icon: 'sparkles',
    features: [
  ...
  },
  {
    ...
    description:
      'Collect lottery voucher codes for exclusive discounts on services, priority processing, and premium upgrades throughout your migration journey.',
  ...
  },
  {
    ...
    description:
      'Book a completely free 30-minute consultation with our certified immigration experts to discuss your options and get personalized guidance.',
    href: '/consultation',
    badge: 'FREE',
    icon: 'phone',
    features: [
  ...
  },
  {
    ...
    description:
      'Join our exclusive VIP membership for priority processing, dedicated support, and access to premium services.',
    href: '/vip-membership',
    badge: 'EXCLUSIVE',
    icon: 'crown',
    features: [
