...
export const aiTools: AITool[] = [
  {
    ...
    description: "AI-powered points assessment across multiple countries and visa programs with instant results.",
    badge: "PREMIUM",
    icon: "calculator",
  ...
  },
  {
    ...
    description: "Intelligent checklist generator and document validation system with AI-powered recommendations.",
    badge: "POPULAR",
    icon: "file-text",
  ...
  },
  {
    ...
    description: "Advanced fraud detection for immigration agencies, offers, and suspicious communications.",
    badge: "HOT",
    icon: "shield-check",
  ...
  },
  {
    ...
    description: "Smart task manager with AI-powered reminders and progress tracking for your migration journey.",
    icon: "check-square",
  ...
  },
  {
    ...
    description: "Conversational AI consultant providing tailored advice for your specific migration scenario.",
    badge: "NEW",
    icon: "bot",
  ...
  },
  {
    ...
    description: "Round-the-clock support chatbot for quick questions and immediate assistance.",
    badge: "24/7",
    icon: "message-square",
  ...
  },
  {
    ...
    description: "Interactive visualization of migration trends, success rates, and processing times worldwide.",
    badge: "LIVE",
    icon: "globe",
  ...
  },
  {
    ...
    description: "AI-powered matching system to connect you with the perfect immigration consultant for your needs.",
    icon: "calendar",
    href: "/consultation",
    features: [
