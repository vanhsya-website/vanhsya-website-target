...
export const services: Service[] = [
  {
    ...
    description:
      'Professional work permits for skilled workers seeking employment opportunities in top destinations worldwide.',
  ...
  },
  {
    ...
    description:
      'Student visas for pursuing higher education in prestigious universities and colleges globally.',
  ...
  },
  {
    ...
    description:
      'Travel visas for leisure, business trips, and exploring new destinations with fast-track processing.',
  ...
  },
  {
    ...
    description:
      'Comprehensive family sponsorship and reunion programs to bring your family together.',
  ...
  },
  {
    ...
    description:
      'Secure your future with permanent residence status in your chosen destination country.',
  ...
  },
  {
    ...
    description:
      'Investor and entrepreneur visa programs to expand your business internationally.',
