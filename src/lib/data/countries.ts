...
export const countries: Country[] = [
  {
    ...
    description: "Canada offers world-class healthcare, education, and countless opportunities for skilled immigrants through multiple immigration pathways.",
  ...
  },
  {
    ...
    description: "Australia combines a strong economy with an unbeatable lifestyle, offering skilled migrants excellent opportunities Down Under.",
  ...
  },
  {
    ...
    description: "The UK offers rich history, cultural diversity, and excellent career opportunities in one of the world's leading economies.",
    href: "/countries/uk",
    flag: "🇬🇧", 
    region: "Europe",
    popularPrograms: [
  ...
  },
  {
    ...
    description: "The USA offers unparalleled opportunities for career growth, innovation, and achieving the American Dream.",
    href: "/countries/usa",
    flag: "🇺🇸",
    region: "North America",
    badge: "FASTEST",
  ...
  },
  {
    ...
    description: "New Zealand offers a perfect work-life balance with stunning natural beauty and a welcoming immigration policy.",
  ...
  },
  {
    ...
    description: "Germany offers excellent career opportunities, high quality of life, and is the gateway to the European Union.",
