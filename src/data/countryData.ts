export const countryData = {
  australia: {
    ...
    flag: '🇦🇺',
    description:
      "Discover the land down under with excellent quality of life, world-class education, and abundant career opportunities. Australia offers multiple pathways for skilled workers, students, investors, and families to build their future in one of the world's most liveable countries.",
    capital: 'Canberra',
    population: '26.6M',
    language: 'English',
    currency: 'AUD',
        ...
        programs: [
          {
            ...
            description:
              'Points-based permanent residence - no sponsor required',
            basePrice: 4640,
    ...
    provinces: [
      ...
      },
      {
        ...
        population: '6.7M',
        programs: [
          'VIC 190 Skilled Nominated',
          'VIC 491 Regional',
          'Investor and Entrepreneur Stream',
          'PhD Stream',
        ],
        highlights: [
          'Cultural and sports capital',
    ...
    benefits: [
      {
        ...
        description:
          'Comprehensive healthcare system covering medical, hospital, and pharmaceutical services',
        icon: '🏥',
      },
      {
        title: 'World-Class Education',
        description:
          'Top-ranked universities and excellent public education system',
        icon: '🎓',
      },
      {
        title: 'Work-Life Balance',
        description:
          'Strong labor laws, 4+ weeks annual leave, and outdoor lifestyle culture',
        icon: '⚖️',
      },
      {
        title: 'Natural Beauty & Wildlife',
        description:
          'Unique landscapes from beaches to outback, and iconic wildlife',
        icon: '🌿',
      },
      {
        title: 'Strong Economy',
        description:
          'Stable economy with low unemployment and high minimum wages',
        icon: '💼',
      },
      {
        title: 'Multicultural Society',
        description:
          'Welcoming communities with people from over 200 countries',
        icon: '🌍',
      },
      {
    ...
    whyChoose: [
      {
        ...
        description:
          '30+ years of continuous economic growth with AAA credit rating and low unemployment (3.5%)',
      },
      {
        title: 'Immigration-Friendly Policies',
        description:
          'Clear pathways to permanent residency and citizenship with transparent points system',
      },
      {
        title: 'Excellent Climate',
        description:
          'Year-round sunshine, beautiful beaches, and outdoor lifestyle opportunities',
      },
      {
        title: 'Strategic Location',
        description:
          'Gateway to Asia-Pacific region with strong trade relationships and business opportunities',
      },
      {
        title: 'World-Class Infrastructure',
        description:
          'Modern cities, excellent public transport, and reliable utilities',
      },
      {
        title: 'Safe Environment',
        description:
          'Low crime rates, political stability, and strong rule of law',
      },
    ],
  ...
  uk: {
    ...
    flag: '🇬🇧',
    description:
      'Experience the rich history, world-class education, and global business opportunities in the UK. Home to prestigious universities and a gateway to Europe with excellent career prospects.',
    capital: 'London',
    population: '67M',
    language: 'English',
    currency: 'GBP',
    ...
    whyChoose: [
      {
        ...
        description:
          "Home to world's top universities including Oxford and Cambridge",
      },
      {
  ...
  usa: {
    ...
    flag: '🇺🇸',
    description:
      "Pursue the American Dream with endless opportunities in the world's largest economy. From Silicon Valley innovation to Wall Street finance, discover your potential in the land of opportunity.",
    ...
    whyChoose: [
      {
        ...
        description:
          "World's largest economy with endless business opportunities",
      },
      {
        title: 'Innovation Hub',
  ...
  germany: {
    ...
    flag: '🇩🇪',
    description:
      "Experience Europe's economic powerhouse with excellent work-life balance, free education, and strong social benefits. Germany offers numerous opportunities for skilled professionals and students.",
    capital: 'Berlin',
    population: '83M',
    language: 'German',
    currency: 'EUR',
    ...
    whyChoose: [
      {
        title: 'Strong Economy',
        description:
          "Europe's largest economy with excellent job opportunities",
      },
      {
        title: 'Free Education',
        description:
          'No tuition fees at public universities, even for international students',
      },
      {
  ...
  newzealand: {
    ...
    flag: '🇳🇿',
    description:
      'Discover the land of the long white cloud with stunning natural beauty, excellent quality of life, and welcoming communities. New Zealand offers unique opportunities for skilled workers and entrepreneurs.',
    capital: 'Wellington',
    population: '5.1M',
    language: 'English',
    currency: 'NZD',
  ...
  singapore: {
    ...
    flag: '🇸🇬',
    description:
      "Experience Asia's financial hub with excellent infrastructure, multicultural society, and strategic location. Singapore offers exceptional opportunities for business, education, and career growth.",
    capital: 'Singapore',
    population: '5.9M',
    language: 'English',
    currency: 'SGD',
  ...
  uae: {
    ...
    flag: '🇦🇪',
    description:
      'Experience the modern Middle East with tax-free income, luxury lifestyle, and business opportunities. The UAE offers golden visa programs and excellent career prospects in a dynamic economy.',
    capital: 'Abu Dhabi',
    population: '10M',
