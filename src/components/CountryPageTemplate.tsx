        ...
        <div className='container-max'>
          ...
          >
            <h2 className='heading-xl text-gray-800 mb-6'>
              {countryData.name}{' '}
              <span className='text-gradient-cyan'>Immigration Programs</span>
            </h2>
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              Choose from multiple pathways to {countryData.name} residence and
              work authorization
            </p>
          </motion.div>
        ...
        <section className='section-padding bg-white'>
          <div className='container-max'>
            ...
            >
              <h2 className='heading-xl text-gray-800 mb-6'>
                {countryData.name}{' '}
                <span className='text-gradient-cyan'>States & Regions</span>
              </h2>
              <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
          ...
          <div className='grid lg:grid-cols-2 gap-12 items-center'>
            ...
            >
              <h2 className='heading-xl text-gray-800 mb-8'>
                Why Choose{' '}
                <span className='text-gradient-cyan'>{countryData.name}?</span>
              </h2>
            ...
            >
              <div
                className={`modern-card ${countryData.heroGradient} text-white`}
              >
                <h3 className='text-2xl font-bold mb-6'>
                  {countryData.name} Immigration Stats 2024
                </h3>
                ...
                <div className='mt-6 p-4 bg-white/10 rounded-lg'>
                  <p className='text-sm text-white/90'>
                    {countryData.name} is actively seeking skilled workers,
                    students, and entrepreneurs to contribute to its growing
        ...
        <div className='container-max text-center'>
          ...
          >
            ...
            <p className='text-xl text-white/90 mb-8 max-w-3xl mx-auto'>
              Get expert guidance from licensed immigration consultants and
