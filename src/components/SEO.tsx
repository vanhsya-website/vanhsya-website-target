...
export function generateMetadata({
  ...
  const fullTitle = title.includes('VANHSYA') ? title : `${title} | VANHSYA Global Migration`;
  const baseUrl = 'https://www.vanhsyaglobal.com';
  
  return {
    title: fullTitle,
    description,
    keywords: [...keywords, 'migration', 'visa', 'work visa', 'study visa', 'VANHSYA'].join(', '),
...
export const pageSEO = {
  home: {
    title: 'VANHSYA Global Migration - Your trusted migration partner',
    description: 'VANHSYA Global Migration - Your trusted migration partner. Expert guidance for work, study, family, and business visas with transparent pricing and verified success rates.',
    keywords: ['migration', 'visa', 'work visa', 'study visa', 'migration services', 'trusted migration partner']
  },
  services: {
