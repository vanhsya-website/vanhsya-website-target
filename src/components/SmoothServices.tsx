...
const services = [
  {
    ...
    description:
      'Advanced machine learning algorithms analyze your background, skills, and goals to identify optimal immigration pathways.',
    features: [
  ...
  },
  {
    ...
    description:
      'AI-powered document verification ensures completeness and accuracy, preventing costly delays and rejections.',
    features: [
  ...
  },
  {
    ...
    description:
      'Intelligent matching system connects you with the best countries based on your profile and preferences.',
    features: [
  ...
  },
  {
    ...
    description:
      'Predictive analytics provide accurate timelines and suggest strategies to accelerate your application.',
    features: [
  ...
  },
  {
    ...
    description:
      'Continuous monitoring ensures your application meets all current regulations and requirements.',
    features: [
  ...
  },
  {
    ...
    description:
      'Data-driven insights and success metrics help optimize your application for maximum approval chances.',
    features: [
      ...
      >
        ...
        <div className='text-center max-w-4xl mx-auto mb-20'>
          ...
          >
            ...
            platform. Every service is designed to maximize your success and
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className='relative h-full bg-gradient-to-br from-neutral-900/80 to-neutral-900/40 backdrop-blur-xl border border-neutral-800/50 rounded-2xl p-8 overflow-hidden'>
                ...
                {/* Animated Border */}
                <div
                  className='absolute inset-0 rounded-2xl border-2 border-transparent bg-gradient-to-r from-purple-500/20 via-transparent to-blue-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500'
                  style={{
                ...
                <div className='relative z-10 mb-6'>
                  <div
                    className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-r ${service.color} shadow-lg group-hover:shadow-xl transition-shadow duration-300`}
                  >
                ...
                <div className='relative z-10'>
                  ...
                  <ul className='space-y-3'>
                    {service.features.map((feature, featureIndex) => (
                      ...
                      >
                        <div
                          className={`w-2 h-2 rounded-full bg-gradient-to-r ${service.color} shadow-sm`}
                        />
          ...
          <div className='bg-gradient-to-r from-neutral-900/80 to-neutral-900/40 backdrop-blur-xl border border-neutral-800/50 rounded-2xl p-12 relative overflow-hidden'>
            ...
            <div className='relative z-10 max-w-3xl mx-auto'>
              ...
              <p className='text-xl text-neutral-300 mb-8 leading-relaxed'>
                Join thousands of successful immigrants who chose our AI-powered
                platform. Start your journey with a comprehensive assessment
                today.
              </p>
