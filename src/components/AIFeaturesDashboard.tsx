      ...
      <div className='container-max'>
        ...
        >
          ...
          <p className='text-xl text-blue-200 max-w-3xl mx-auto'>
            Real-time insights into our AI-powered platform performance and user
            engagement
          </p>
        </motion.div>
            ...
            >
              <Link href={feature.link}>
                <div className='bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-6 border border-white border-opacity-20 hover:bg-opacity-20 transition-all duration-300 cursor-pointer h-full'>
                  <div
                    className={`w-14 h-14 rounded-lg bg-gradient-to-r ${feature.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                  >
