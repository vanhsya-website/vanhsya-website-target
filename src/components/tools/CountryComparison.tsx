...
export default function CountryComparison() {
  ...
  const [availableCountries, setAvailableCountries] =
    useState<CountryData[]>(mockCountries);
  ...
  const removeCountry = (countryId: string) => {
    ...
    if (country) {
      ...
      setAvailableCountries(
        [...availableCountries, country].sort((a, b) =>
      ...
      <div className='bg-white rounded-lg p-4 border border-gray-200'>
        ...
        >
          {values.map((value, index) => {
            ...
            const scoreClass =
              typeof value === 'number'
                ? getScoreColor(isInverted ? 100 - value : value)
                : 'text-gray-600 bg-gray-100';

            return (
              <div key={index} className='text-center'>
                <div
                  className={`px-2 py-1 rounded text-sm font-medium ${scoreClass}`}
                >
          ...
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='text-purple-100'>
                Compare immigration destinations side by side to make informed
                decisions
              </p>
            </div>
            <button
          ...
          {selectedCountries.length === 0 ? (
            <div className='text-center py-12'>
              ...
              <p className='text-gray-600 mb-6'>
                Select countries to compare their immigration opportunities and
                living conditions
              </p>
              <button
                onClick={() => setShowAddModal(true)}
