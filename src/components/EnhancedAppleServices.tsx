  ...
  const services = [
    {
      ...
      title: 'Work Visa',
      description:
        'Apply for work visas to global destinations with professional guidance.',
    ...
    },
    {
      ...
      title: 'Study Visa',
      description:
        'Unlock global education opportunities with comprehensive assistance.',
    ...
    },
    {
      ...
      title: 'Business Visa',
      description:
        'Expand your business globally with tailored investor solutions.',
    ...
    },
    {
      ...
      title: 'Family Visa',
      description:
        'Reunite with loved ones through family sponsorship programs.',
                  ...
                  <div className='service-card bg-white shadow-lg hover:shadow-2xl transition-all duration-500 rounded-3xl overflow-hidden h-full'>
                    ...
                    <div className='relative h-48 overflow-hidden'>
                      ...
                      <div className='relative w-full h-full'>
                        ...
                        <div
                          className={`absolute inset-0 bg-gradient-to-br ${service.gradient} bg-opacity-80 flex items-center justify-center`}
                        >
