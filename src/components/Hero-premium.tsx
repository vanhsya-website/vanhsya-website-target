...
const countries: CountryCard[] = [
  { name: 'Canada', flag: '🇨🇦', successRate: 94, processing: '6-8 months', popular: true },
  { name: 'Australia', flag: '🇦🇺', successRate: 91, processing: '8-12 months', popular: true },
  { name: 'New Zealand', flag: '🇳🇿', successRate: 88, processing: '6-10 months', popular: false },
  { name: 'Germany', flag: '🇩🇪', successRate: 85, processing: '4-6 months', popular: true },
  { name: 'UK', flag: '🇬🇧', successRate: 82, processing: '3-5 months', popular: false },
  { name: 'Netherlands', flag: '🇳🇱', successRate: 87, processing: '5-7 months', popular: false },
];

const stats: StatCard[] = [
  { value: '25K+', label: 'Successful Cases', icon: TrophyIcon, color: 'text-yellow-600 bg-yellow-100' },
  { value: '50+', label: 'Countries', icon: GlobeAmericasIcon, color: 'text-blue-600 bg-blue-100' },
  { value: '15+', label: 'Years Experience', icon: StarIcon, color: 'text-purple-600 bg-purple-100' },
  { value: '24/7', label: 'Support', icon: UserGroupIcon, color: 'text-green-600 bg-green-100' },
];
...
const testimonials: TestimonialCard[] = [
  {
    name: 'Priya Sharma',
    country: 'Canada',
    quote: 'VANHSYA made my Canadian dream come true. Their AI-powered guidance was incredible!',
  ...
  },
  {
    name: 'Ahmed Hassan',
    country: 'Australia',
    quote: 'The most professional immigration service I\'ve ever experienced. Highly recommended!',
    image: '/api/placeholder/60/60',
    rating: 5
  },
  {
    ...
    country: 'Germany',
    quote: 'From start to finish, VANHSYA was with me every step. Amazing team and results!',
    image: '/api/placeholder/60/60',
    rating: 5
  },
];
...
export default function HeroEnhanced() {
  ...
  const floatingElements = generateFloatingElements(20, 'hero-premium-particles');
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium">AI-Powered Immigration Solutions</span>
            </motion.div>
            ...
            >
              ...
              <p className="text-xl text-white/80 leading-relaxed max-w-lg">
                Experience the future of immigration with our AI-powered platform. 
          ...
          >
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-white mb-6">Popular Destinations</h3>
              <div className="grid grid-cols-2 gap-4">
                {countries.map((country, index) => (
                  ...
                  >
                    ...
                    <div className="text-white/60 text-sm">{country.processing}</div>
                    ...
                    <div className="mt-3 flex items-center gap-2">
                      <div className="flex-1 bg-white/20 rounded-full h-2">
                        <motion.div
                          ...
                          initial={{ width: 0 }}
                          animate={{ 
                            width: activeCountry === country.name ? `${country.successRate}%` : '0%' 
                          }}
                          transition={{ duration: 1, ease: "easeOut" }}
                        />
                      </div>
                      <span className="text-white/80 text-sm font-medium">{country.successRate}%</span>
                    </div>
                  </motion.div>
                ))}
              </div>
            ...
            <div className="relative p-6 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl">
              <h3 className="text-lg font-semibold text-white mb-4">Client Success Stories</h3>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-white/60 text-sm">Migrated to {testimonials[currentTestimonial].country}</div>
                    </div>
                  </div>
