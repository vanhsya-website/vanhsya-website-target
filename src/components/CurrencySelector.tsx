...
const currencies: Currency[] = [
  ...
  { code: 'CZK', symbol: 'Kč', name: 'Czech Koruna', flag: '🇨🇿', rate: 22.5 },
  {
    code: 'HUF',
    symbol: 'Ft',
  ...
  { code: 'THB', symbol: '฿', name: 'Thai Baht', flag: '🇹🇭', rate: 35.8 },
  {
    code: 'MYR',
    symbol: 'RM',
  ...
  { code: 'MMK', symbol: 'K', name: 'Myanmar Kyat', flag: '🇲🇲', rate: 2100.0 },
  { code: 'LAK', symbol: '₭', name: 'Lao Kip', flag: '🇱🇦', rate: 20500.0 },
  {
    code: 'KHR',
    symbol: '៛',
    name: 'Cambodian Riel',
...
export function CurrencyProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <CurrencyContext.Provider
      value={{ selectedCurrency, setCurrency, convertPrice, formatPrice }}
    >
      {children}
    </CurrencyContext.Provider>
  );
