...
export function PerformanceDashboard() {
  ...
  const getTrendIcon = (trend: string) => {
    switch (trend) {
      case 'up':
        return <FiTrendingUp className='w-3 h-3 text-green-400' />;
      case 'down':
        return <FiTrendingUp className='w-3 h-3 text-red-400 rotate-180' />;
      case 'stable':
        return <div className='w-3 h-1 bg-gray-400 rounded' />;
      default:
        return null;
    }
  };
                        ...
                        >
                          <div className='flex items-center space-x-4'>
                            ...
                            <div>
                              ...
                              <p
                                className={`text-sm capitalize ${getStatusColor(system.status)}`}
                              >
                                {system.status}
                              </p>
                            </div>
                ...
                <GlassCard className='p-6'>
                  ...
                  <div className='space-y-3'>
                    {[
                      {
                        time: '2 min ago',
                        event: 'AI Assessment completed for user #4521',
                        type: 'success',
                      },
                      {
                        time: '5 min ago',
                        event: 'New job posting added by TechCorp Canada',
                        type: 'info',
                      },
                      {
                        time: '8 min ago',
                        event: 'Document verification completed',
                        type: 'success',
                      },
                      {
                        time: '12 min ago',
                        event: 'Referral bonus credited to user #3847',
                        type: 'success',
                      },
                      {
                        time: '15 min ago',
