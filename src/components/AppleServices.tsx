  ...
  const services = [
    {
      ...
      title: 'Work Visa',
      description:
        'Professional opportunities worldwide with expert guidance through work visa processes.',
    ...
    },
    {
      ...
      title: 'Study Visa',
      description:
        'Unlock global education opportunities with comprehensive study visa assistance.',
    ...
    },
    {
      ...
      title: 'Business Visa',
      description:
        'Expand your business globally with tailored business and investor visa solutions.',
    ...
    },
    {
      ...
      title: 'Tourist Visa',
      description:
        'Explore the world with hassle-free tourist and visitor visa services.',
    ...
    },
    {
      ...
      title: 'Family Visa',
      description:
        'Reunite with loved ones through family sponsorship and reunion programs.',
    ...
    },
    {
      ...
      description:
        'Complete travel solutions with competitive flight booking and travel planning.',
    ...
    >
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        >
          ...
          >
            From work permits to family reunions, we provide comprehensive visa
            and migration services tailored to your unique journey.
          </motion.p>
        </motion.div>
