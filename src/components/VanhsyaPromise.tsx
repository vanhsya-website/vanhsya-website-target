  ...
  const promises: Promise[] = [
    {
      ...
      description:
        'Complete transparency in all costs and charges. Every rupee is tracked and justified.',
    ...
    },
    {
      ...
      description:
        'From initial assessment to final settlement - everything managed in one secure platform.',
    ...
    },
    {
      ...
      description:
        'Adhering to international standards and regulations across all countries we serve.',
    ...
    },
    {
      ...
      description:
        'Earn rewards and get your migration free by referring friends and family.',
      ...
      <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        >
          ...
          <p className='text-lg text-gray-300 max-w-3xl mx-auto'>
            We're revolutionizing migration services with unprecedented
            transparency, security, and client protection. Here's our commitment
            to you.
          </p>
        </motion.div>
            ...
            <div className='border-t border-white/10 pt-8'>
              ...
              <p className='text-lg text-gray-300 leading-relaxed'>
                ...
                <span className='text-green-400 font-semibold'>
                  10,000 safe, transparent migrations
                </span>{' '}
                through our AI-powered platform, eliminating fraud and ensuring
                every client reaches their destination safely and legally.
              </p>
            </div>
          </GlassCard>
        </motion.div>
          ...
          <div className='inline-flex items-center space-x-4 p-6 bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-400/20 rounded-2xl max-w-4xl mx-auto'>
            ...
            <div className='text-left'>
              ...
              <p className='text-gray-300 text-sm leading-relaxed'>
                No agent intermediaries. All data secure and encrypted. Every
                process is audited and compliant with international standards.
                Your migration journey is protected at every step.
              </p>
            </div>
          </div>
        </motion.div>
