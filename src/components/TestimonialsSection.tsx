  ...
  const testimonials: TestimonialProps[] = [
    {
      ...
      rating: 5,
      comment:
        'VANHSYA made my Canadian dream come true. Their team was incredibly professional and kept me informed throughout the entire process. The transparency about fees and timelines was exactly what I needed.',
      date: 'March 2024',
      profileImage: 'SC',
    ...
    },
    {
      ...
      rating: 5,
      comment:
        'From the initial consultation to receiving my visa, VANHSYA provided exceptional service. They helped me understand the point system and guided me through each step with patience and expertise.',
      date: 'February 2024',
      profileImage: 'MR',
    ...
    },
    {
      ...
      rating: 5,
      comment:
        'The team at VANHSYA was fantastic. They were always available to answer my questions and made the complex UK visa process seem straightforward. Highly recommend their services.',
      date: 'January 2024',
      profileImage: 'PS',
    ...
    },
    {
      ...
      rating: 5,
      comment:
        'Reuniting with my family seemed impossible until I found VANHSYA. Their compassionate approach and thorough knowledge of family immigration made all the difference.',
      date: 'December 2023',
      profileImage: 'DT',
    ...
    },
    {
      ...
      rating: 5,
      comment:
        'Professional, efficient, and trustworthy. VANHSYA helped me secure my EU Blue Card for Germany. The process was smooth and their communication was excellent throughout.',
      date: 'November 2023',
      profileImage: 'AM',
      ...
      <div className='container-max'>
        ...
        >
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed'>
            Real stories from real clients who trusted VANHSYA with their
            immigration journey. Every testimonial is verified and represents
        ...
        >
          <div className='grid grid-cols-1 md:grid-cols-4 gap-8 text-center'>
            ...
            <div>
              ...
              <div className='text-sm text-gray-500 mt-1'>
                No hidden fees or false claims
              </div>
            </div>
            <div>
