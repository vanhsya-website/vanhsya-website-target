...
const features = [
  {
    ...
    title: 'Expert Team',
    description:
      'Certified immigration consultants with 15+ years of experience',
  },
  {
    icon: Trophy,
      ...
      <div className='container-max'>
        ...
        <div className='grid lg:grid-cols-2 gap-12 items-center mb-20'>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className='vanhsya-heading text-5xl md:text-6xl mb-8'>
              Your Trusted Partner in
              <span className='block bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent'>
                Global Migration
              </span>
            </h2>
            <p className='vanhsya-subheading text-xl mb-8'>
              With over 15 years of expertise in immigration services, VANHSYA
              has helped thousands of individuals and families achieve their
              dreams of living, working, and studying abroad.
            </p>
            <p className='text-slate-600 text-lg leading-relaxed mb-10'>
              We understand that immigration is more than just paperwork - it's
              about dreams, aspirations, and building a better future. That's
              why we combine technical expertise with genuine care to deliver
              exceptional results.
            </p>
        ...
        >
          <div className='text-center mb-12'>
            ...
            <p className='text-modern'>
              We've streamlined the immigration process to make it as smooth as
              possible
            </p>
          </div>
            ...
            {[
              {
                step: '01',
                title: 'Consultation',
                desc: 'Free assessment of your profile',
              },
              {
                step: '02',
                title: 'Documentation',
                desc: 'Prepare and verify all documents',
              },
              {
                step: '03',
                title: 'Application',
              ...
              },
              {
                step: '04',
                title: 'Success',
                desc: 'Receive your visa approval',
              },
            ].map((item, index) => (
              <motion.div
                key={item.step}
