...
import { ArrowRight, CheckCircle, Users, Trophy, Clock, Shield } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          >
            ...
            <p className="vanhsya-subheading text-xl mb-8">
              With over 15 years of expertise in immigration services, VANHSYA has helped 
              thousands of individuals and families achieve their dreams of living, working, 
              and studying abroad.
            </p>
