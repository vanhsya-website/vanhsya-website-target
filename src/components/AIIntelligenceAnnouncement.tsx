...
import { Brain, X, Sparkles, ArrowRight, TrendingUp, Shield, Zap } from 'lucide-react';
...
const AIIntelligenceAnnouncement: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const dismissed = localStorage.getItem('ai-intelligence-announcement-dismissed');
    if (!dismissed) {
        ...
        >
          ...
          >
              ...
              {[...Array(12)].map((_, i) => (
                <motion.div
                  ...
                  style={{
                    ...
                    background: ['#3b82f6', '#8b5cf6', '#ef4444', '#10b981', '#f59e0b'][Math.floor(Math.random() * 5)],
            ...
            <p className="text-sm text-slate-300 mb-4 leading-relaxed">
              Experience the world's first AI-powered migration intelligence platform 
              with real-time insights, predictive analytics, and revolutionary ScamShield protection.
            </p>              {/* CTA Button */}
              ...
              <div className="mt-4 pt-4 border-t border-white/10">
                <div className="grid grid-cols-3 gap-3">
                  {[
                    { icon: TrendingUp, label: 'Real-time Analytics', color: 'text-green-400', bgColor: 'from-green-500/20 to-green-600/30' },
                    { icon: Shield, label: 'ScamShield Protection', color: 'text-blue-400', bgColor: 'from-blue-500/20 to-blue-600/30' },
                    { icon: Zap, label: 'Success Optimization', color: 'text-yellow-400', bgColor: 'from-yellow-500/20 to-yellow-600/30' }
                  ].map((feature, index) => (
                    <motion.div
                      key={feature.label}
                      initial={{ 
                    ...
                    >
                      ...
                      <motion.div
                        ...
                        whileHover={{
                          scale: 1.5,
                          rotate: 360,
                          filter: 'brightness(1.5) saturate(2) drop-shadow(0 0 20px currentColor)'
                        }}
