        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-8 text-sm">
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/services/work-visa">Work Visa</Link></li>
              <li><Link href="/services/study-visa">Study Visa</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/ai-tools/eligibility-calculator">Eligibility Calculator</Link></li>
              <li><Link href="/ai-tools/document-wizard">Document Wizard</Link></li>
              <li><Link href="/ai-tools/scam-detector">Scam Detector</Link></li>
              <li><Link href="/ai-tools/checklist-assistant">Checklist Assistant</Link></li>
              <li><Link href="/ai-tools/chatbot">AI Chatbot</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/countries/usa">USA</Link></li>
              <li><Link href="/countries/uk">UK</Link></li>
              <li><Link href="/countries/germany">Germany</Link></li>
            </ul>
          </div>
          <div>
