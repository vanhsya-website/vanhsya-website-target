  ...
  return (
    ...
    >
        ...
        <div className='grid grid-cols-2 gap-3 mb-4'>
          <div className='bg-white/10 rounded-lg p-3'>
            ...
            <div className='text-sm font-semibold text-white'>
              {nationalityData.processingTime}
            </div>
          </div>
      ...
      {nationalityData && (
        <div className='mb-4'>
          <div
            className={`flex items-center gap-2 px-3 py-2 rounded-lg ${getEmbassyColor(nationalityData.embassyDifficulty)}`}
          >
      ...
      <div className='mt-auto'>
        {country.servicesAvailable ? (
          <button
            onClick={() =>
              onRequestConsultation(country, nationality, userGoal)
            }
