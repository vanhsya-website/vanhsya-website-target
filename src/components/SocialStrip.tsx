  ...
  const platforms: SocialPlatform[] = [
    {
      name: 'Instagram',
      icon: Instagram,
      followers: isLoading ? '...' : `${(followerCounts.instagram / 1000).toFixed(1)}K`,
    ...
    },
    {
      name: 'YouTube',
      icon: Youtube,
      followers: isLoading ? '...' : `${(followerCounts.youtube / 1000).toFixed(1)}K`,
      handle: 'Vanhsya Live',
    ...
    },
    {
      name: 'LinkedIn',
      icon: Linkedin,
      followers: isLoading ? '...' : `${(followerCounts.linkedin / 1000).toFixed(1)}K`,
      handle: 'VANHSYA',
    ...
    },
    {
      name: 'Facebook',
      icon: Facebook,
      followers: isLoading ? '...' : `${(followerCounts.facebook / 1000).toFixed(1)}K`,
    ...
    },
    {
      name: 'Twitter',
      icon: Twitter,
      followers: isLoading ? '...' : `${(followerCounts.twitter / 1000).toFixed(1)}K`,
    ...
    <section className={`bg-white rounded-2xl border border-gray-200 p-8 ${className}`}>
      <div className="text-center mb-8">
        <div className="flex items-center justify-center gap-2 mb-3">
          ...
          <h2 className="text-2xl font-bold text-gray-900">Join Our Live Community</h2>
        </div>
        <p className="text-gray-600 max-w-2xl mx-auto">
          Follow VANHSYA across social platforms for real-time immigration updates, success stories, and live expert sessions.
        </p>
      </div>
            ...
            >
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  <div className={`w-12 h-12 rounded-xl ${platform.bgColor} flex items-center justify-center transition-colors relative`}>
      ...
      <div className="mt-8 text-center">
        <p className="text-sm text-gray-500 mb-4">
          🔔 Get instant notifications for immigration updates, live Q&A sessions, and success stories
        </p>
