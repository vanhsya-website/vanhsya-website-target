  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div variants={itemVariants} className='mb-12 space-y-6'>
          ...
          >
            <VanhsyaLogo
              ...
              height={100}
              animated={true}
              className='w-96 h-24 md:w-[400px] md:h-[100px]'
            />
          </motion.div>
          ...
          >
            Welcome to the{' '}
            <span className='font-bold text-gold-400'>New Migration Era</span>{' '}
            powered by VANHSYA. Revolutionary AI intelligence,{' '}
            <span className='font-bold text-green-400'>99.8% success rate</span>
            , and pioneering technology that transforms global migration
            forever.
          </motion.p>
        </motion.div>
        ...
        >
          {['AI Certified', 'ISO 27001', 'SOC 2 Compliant', 'GDPR Ready'].map(
            (cert, index) => (
              <motion.div
                key={index}
