...
const countries = [
  {
    ...
    description:
      'World-class healthcare, excellent education system, and welcoming immigration policies make Canada a top destination.',
    programs: [
      {
        name: 'Express Entry',
  ...
  },
  {
    ...
    description:
      'Stunning landscapes, vibrant cities, and a relaxed lifestyle combined with excellent career opportunities.',
    programs: [
      {
  ...
  },
  {
    ...
    description:
      'Rich history, world-renowned universities, and a thriving economy with global business connections.',
    programs: [
      {
        name: 'Skilled Worker',
  ...
  },
  {
    ...
    description:
      "Europe's economic powerhouse with exceptional engineering opportunities and comprehensive social benefits.",
    programs: [
    ...
    >
      ...
      <div className='absolute inset-0 overflow-hidden'>
        {Array.from({ length: 6 }, (_, i) => (
          ...
          >
            <div
              className={`w-16 h-16 border-2 border-purple-500/20 ${i % 2 === 0 ? 'rounded-full' : 'rotate-45'}`}
            />
          </motion.div>
        ))}
      </div>
      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
        ...
        <div className='text-center max-w-4xl mx-auto mb-16'>
          ...
          >
            Discover immigration opportunities across 195+ countries with
            real-time data, success rates, and personalized pathway
            recommendations.
          </motion.p>
        </div>
                      ...
                      <div className='flex items-center gap-3'>
                        ...
                        <div>
                          ...
                          <div className='text-white font-medium'>
                            {
                              activeCountry.programs[selectedProgram]
                                .processingTime
                            }
                          </div>
                        </div>
              ...
              <div className='grid grid-cols-2 gap-4'>
                ...
                >
                  ...
                  <p className='text-neutral-400 text-sm'>
                    Estimate your total immigration costs
                  </p>
                </motion.button>
                ...
                >
                  ...
                  <p className='text-neutral-400 text-sm'>
                    Explore cities and lifestyle options
                  </p>
                </motion.button>
              </div>
            </div>
        ...
        >
          <div className='bg-gradient-to-r from-purple-600/10 to-indigo-600/10 backdrop-blur-xl border border-purple-500/20 rounded-2xl p-8'>
            ...
            <p className='text-neutral-300 mb-6'>
              We cover 195+ countries with personalized immigration pathways for
              each destination.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
