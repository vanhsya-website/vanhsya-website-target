...
const timelineSteps = [
  {
    ...
    description:
      'Connect with our immigration experts for a comprehensive assessment of your profile and goals.',
    duration: '30 minutes',
    features: [
      'Profile evaluation',
  ...
  },
  {
    ...
    description:
      'Our AI-powered document review ensures 99.8% accuracy while our experts handle all paperwork.',
    duration: '2-4 weeks',
    features: [
  ...
  },
  {
    ...
    description:
      'Strategic application submission with real-time tracking and government liaison support.',
    duration: '1-2 weeks',
    features: [
      'Strategic timing',
      'Real-time tracking',
  ...
  },
  {
    ...
    description:
      'Continuous monitoring and proactive communication with immigration authorities on your behalf.',
  ...
  },
  {
    ...
    description:
      'Celebrate your approval and access lifetime settlement support for a smooth transition.',
    ...
    >
      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
        ...
        <div className='text-center max-w-4xl mx-auto mb-20'>
          ...
          >
            Experience our proven 5-step process that has helped 25,000+
            families achieve their immigration dreams with a 99.1% success rate.
          </motion.p>
        </div>
            ...
            {timelineSteps.map((step, index) => (
              ...
              >
                ...
                <div className='relative flex-shrink-0'>
                  ...
                  {/* Glow Effect */}
                  <div
                    className={`absolute inset-0 w-16 h-16 rounded-full ${step.bgGlow} blur-xl opacity-50`}
                  />
                </div>
                  ...
                  <div className='grid grid-cols-2 gap-3 mb-6'>
                    {step.features.map((feature, featureIndex) => (
                      <motion.div
                        ...
                        transition={{
                          duration: 0.4,
                          delay: step.delay + 0.1 + featureIndex * 0.05,
                        }}
                ...
                <div
                  className='hidden md:block absolute top-8 w-8 h-0.5 bg-gradient-to-r from-neutral-700 to-neutral-600 z-0'
                  style={{
        ...
        >
          <div className='bg-gradient-to-r from-purple-600/10 to-indigo-600/10 backdrop-blur-xl border border-purple-500/20 rounded-2xl p-8 max-w-2xl mx-auto'>
            ...
            <p className='text-neutral-300 mb-6'>
              ...
              immigration dreams. Your success story starts with a simple
              conversation.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
