      ...
      <div className='container-max'>
        ...
        >
          ...
          <p className='text-xl text-white/80 max-w-3xl mx-auto'>
            Experience the future of immigration services with our cutting-edge
            AI suite. From eligibility assessment to document verification - all
        ...
        >
          <GlassServiceCard className='text-center'>
            ...
            <div className='text-white/70 text-sm'>
              Global database of fraudulent documents
            </div>
          </GlassServiceCard>
          ...
          <GlassServiceCard className='text-center'>
            ...
            <div className='text-white/70 text-sm'>
              Round-the-clock intelligent assistance
            </div>
          </GlassServiceCard>
        </motion.div>
        ...
        >
          <GlassServiceCard className='bg-gradient-to-r from-primary-600/20 to-accent-500/20 border-primary-500/30'>
            ...
            <p className='text-white/80 mb-6 max-w-2xl mx-auto'>
              Join thousands of successful applicants who have used our AI tools
              to streamline their migration journey. Get started with our free
