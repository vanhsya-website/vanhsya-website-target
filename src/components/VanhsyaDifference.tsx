  ...
  const differences: DifferencePoint[] = [
    {
      ...
      description:
        'Revolutionary AI-powered migration system with machine learning algorithms that analyze millions of data points for guaranteed success.',
    ...
    },
    {
      ...
      description:
        'Revolutionary real-time tracking with blockchain verification - see every application step, officer response, and decision in real-time.',
    ...
    },
    {
      ...
      description:
        "The world's most advanced AI fraud detection system protecting against 500+ scam patterns and fake agencies.",
    ...
    },
    {
      ...
      description:
        'Breakthrough milestone-based payment system with cryptocurrency-grade security - pay only when goals are achieved.',
    ...
    },
    {
      ...
      description:
        'Advanced machine learning algorithms that predict success probability and optimize your application for maximum approval chances.',
    ...
    },
    {
      ...
      description:
        "Direct access to 75+ countries' immigration systems with verified government partnerships and real-time embassy connections.",
    ...
    },
    {
      ...
      description:
        'Direct access to licensed consultants and government channels - completely eliminating middlemen and commission-driven agents.',
    ...
    },
    {
      ...
      description:
        "Every testimonial is blockchain-verified, DNA-authenticated, and satellite-location confirmed - the industry's first unbreakable verification system.",
        ...
        {[...Array(8)].map((_, i) => (
          <motion.div
            ...
            animate={{
              y: [
                -250,
                typeof window !== 'undefined' ? window.innerHeight + 250 : 1000,
              ],
              opacity: [0, 0.6, 0],
            }}
            transition={{
      ...
      <div className='relative px-6 mx-auto max-w-7xl sm:px-8'>
        ...
        >
          ...
          >
            ...
            <span className='font-bold text-slate-200'>
              The VANHSYA Revolutionary Difference
            </span>
            <motion.div
              animate={{ rotate: [0, -5, 5, 0] }}
          ...
          <motion.p
            ...
            transition={{ duration: 3, repeat: Infinity }}
          >
            Experience the revolutionary features that make VANHSYA the world's
            most advanced migration platform. These breakthrough innovations
            ...
            >
                  ...
                  boxShadow:
                    hoveredIndex === index
                      ? [
                          ...
                          '0 25px 50px rgba(100, 116, 139, 0.2)',
                          '0 10px 30px rgba(0,0,0,0.3)',
                        ]
                      : '0 10px 30px rgba(0,0,0,0.3)',
                }}
              ...
              >
                ...
                <motion.div
                    ...
                    boxShadow:
                      hoveredIndex === index
                        ? [
                            ...
                            '0 20px 40px rgba(100, 116, 139, 0.4)',
                            '0 10px 20px rgba(0,0,0,0.2)',
                          ]
                        : '0 10px 20px rgba(0,0,0,0.2)',
                  }}
                  transition={{ duration: 2, repeat: Infinity }}
                >
                  <span className='text-white'>{difference.icon}</span>
                </motion.div>
                  ...
                  animate={{
                    ...
                    boxShadow:
                      hoveredIndex === index
                        ? [
                            '0 0 0 rgba(0,0,0,0)',
                            '0 5px 15px rgba(100, 116, 139, 0.3)',
                            '0 0 0 rgba(0,0,0,0)',
                          ]
                        : '0 0 0 rgba(0,0,0,0)',
                  }}
        ...
        >
          ...
          <motion.p
            ...
            transition={{ duration: 3, repeat: Infinity }}
          >
            Join 100,000+ successful migrants who chose the most powerful
            platform in history
          </motion.p>
        </motion.div>
      </div>
