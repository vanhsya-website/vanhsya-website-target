...
const testimonials = [
  {
    ...
    quote:
      "VANHSYA made our Canadian dream a reality. Their AI-powered documentation review caught details we missed, and their expert guidance made the entire process stress-free. We're now proud Canadian residents!",
    timeline: '8 months',
  ...
  },
  {
    ...
    quote:
      "The most professional immigration service we've ever encountered. VANHSYA's team guided us through every step of the Australian immigration process with precision and care. Highly recommended!",
    timeline: '10 months',
  ...
  },
  {
    ...
    quote:
      "Exceptional service from start to finish. VANHSYA's expertise in European immigration law and their personalized approach made my transition to Germany seamless. They truly care about their clients' success.",
    timeline: '4 months',
  ...
  },
  {
    ...
    quote:
      "VANHSYA exceeded all our expectations. Their technology-driven approach combined with human expertise created a perfect immigration experience. We're now living our dream life in New Zealand!",
    timeline: '12 months',
  ...
  },
  {
    ...
    quote:
      "As a tech entrepreneur, I needed specialized guidance for the UK Global Talent visa. VANHSYA's deep understanding of immigration policies and their strategic approach helped me secure my visa in record time.",
    timeline: '3 months',
  ...
  },
  {
    ...
    quote:
      'Moving to Switzerland seemed impossible until we found VANHSYA. Their meticulous attention to detail and comprehensive support system made our relocation smooth and successful. Thank you for making our Swiss dream come true!',
    timeline: '6 months',
    ...
    >
      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
        ...
        <div className='text-center max-w-4xl mx-auto mb-16'>
          ...
          >
            Join thousands of families who trusted VANHSYA with their
            immigration dreams and are now living their best lives in their
            chosen countries.
          </motion.p>
        </div>
          ...
          >
              ...
              <div className='bg-gradient-to-br from-neutral-900/80 to-neutral-900/40 backdrop-blur-xl border border-neutral-800/50 rounded-3xl p-8 lg:p-10'>
                ...
                <div className='flex items-center gap-3 mb-6'>
                  <span className='text-3xl'>
                    {testimonials[currentSlide].flag}
                  </span>
                  <div>
            ...
            <div className='order-1 lg:order-2'>
              <motion.div whileHover={{ scale: 1.02 }} className='relative'>
                ...
                {/* Glow Effect */}
                <div
                  className={`absolute inset-0 rounded-3xl ${testimonials[currentSlide].bgGlow} blur-2xl opacity-20`}
                />
              </motion.div>
            </div>
          </motion.div>
        ...
        >
          <div className='bg-gradient-to-r from-purple-600/10 to-indigo-600/10 backdrop-blur-xl border border-purple-500/20 rounded-2xl p-8 max-w-2xl mx-auto'>
            ...
            <p className='text-neutral-300 mb-6'>
              Join thousands of families who have successfully immigrated with
              VANHSYA. Your journey to a new life starts with a single
              conversation.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
