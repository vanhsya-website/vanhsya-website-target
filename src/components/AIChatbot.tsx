...
const AIChatbot = () => {
  ...
  const predefinedResponses: { [key: string]: string } = {
    'cv builder':
      'Our AI CV Builder offers 4 professional templates: Modern, Creative, Executive, and Academic. It uses AI to optimize your content and helps you create industry-specific CVs that stand out!',
    referral:
      'Our referral system lets you earn rewards by inviting friends! Generate your unique referral code, share it, and earn points for every successful referral. Points can be redeemed for premium features.',
    'lucky draw':
      'Join our monthly lucky draw for exciting prizes! Entry is automatic for active users. Current prizes include premium subscriptions, AI consultation sessions, and innovation grants up to $1,000!',
    'ai innovations':
      'We offer cutting-edge AI solutions including smart CV building, intelligent referral systems, automated lucky draws, AI analytics, and transparent innovation tracking. All with 100% transparency!',
    pricing:
      'We believe in transparency! Many of our AI features are free to start. Premium features start at just $9.99/month with no hidden fees. Check our pricing page for detailed information.',
    support:
      'Our AI-powered support is available 24/7! You can also reach our human experts via email at support@vanhsya.com or through our contact form. We typically respond within 2 hours.',
  };
