...
import { 
  ...
  Copy, Check, Star, Award,
  Heart, Eye, TrendingUp, Zap
} from 'lucide-react';
...
export default function SocialShare({
  ...
  url = typeof window !== 'undefined' ? window.location.href : 'https://vanhsya.com',
            ...
            >
              ...
              >
                <div className="text-center mb-6">
                  <h3 className="text-xl font-bold text-white mb-2">Share & Earn Credits</h3>
                  <p className="text-gray-400 text-sm">Earn credits by sharing VANHSYA with your network</p>
                </div>
                  ...
                  {shareRewards.map((reward) => (
                    ...
                    >
                      ...
                      <div className="flex-1 text-left">
                        <div className="font-medium text-sm">{reward.platform}</div>
                        <div className="text-xs opacity-80">+{formatPrice(reward.reward)}</div>
                      </div>
                ...
                {earnedCredits > 0 && (
                  ...
                  >
                    ...
                    <div className="text-green-400 font-bold">+{formatPrice(earnedCredits)} Credits Earned!</div>
                  </motion.div>
                )}
              </motion.div>
            </motion.div>
    ...
    <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm">Spread the word and get rewarded</p>
        </div>
      </div>
              ...
              >
                ...
                <div className="flex-1 text-left relative z-10">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className="font-medium">+{formatPrice(reward.reward)} credits</span>
                  </div>
                </div>
                {sharedPlatforms.includes(reward.platform) && (
      ...
      <div className="bg-black/30 rounded-xl p-4">
        ...
        {copied && (
          ...
          >
            <span className="text-green-400 font-medium text-sm">+{formatPrice(10)} credits earned!</span>
          </motion.div>
        )}
      </div>
      ...
      {earnedCredits > 0 && (
        ...
        >
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <span className="text-xl font-bold text-white">Total Credits Earned</span>
          </div>
