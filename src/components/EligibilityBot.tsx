...
export default function EligibilityBot() {
  ...
  const calculateEligibility = async () => {
    ...
    // Education scoring
    if (
      answers.education === "Master's Degree" ||
      answers.education === 'PhD/Doctorate'
    )
      score += 25;
    ...
    if (score >= 80) {
      ...
      recommendations.push(
        'You have excellent chances for skilled migration programs'
      );
    } else if (score >= 60) {
      eligiblePrograms.push(
      ...
      recommendations.push(
        'Consider improving language scores for better chances'
      );
    } else {
              ...
              {isCalculating ? (
                <div className='text-center py-12'>
                  ...
                  <p className='text-white/70'>
                    Our AI is evaluating your eligibility across 50+ immigration
                    programs
                  </p>
                </div>
              ) : result ? (
                ...
                <div className='space-y-6'>
                    ...
                    <div className='space-y-3'>
                      {currentStepData.options?.map((option, index) => (
                        <button
                          key={index}
                          onClick={() =>
                            handleAnswer(currentStepData.id, option)
                          }
                  ...
                  <div className='flex justify-between pt-4'>
                    ...
                    >
                      {currentStep === eligibilitySteps.length - 1
                        ? 'Calculate'
                        : 'Next'}
                    </button>
                  </div>
