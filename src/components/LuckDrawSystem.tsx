      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Spin the wheel and win amazing prizes! Free consultations, express processing, and exclusive discounts await you.
          </p>
        </div>
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
              ...
              <div className="grid grid-cols-3 gap-4 mb-8">
                <div className="text-center">
                  <div className="text-2xl font-bold text-purple-600">{participants.toLocaleString()}</div>
                  <div className="text-sm text-gray-600">Participants</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-600">{userEntries}</div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 mt-2">
                  {userEntries > 0 ? `${userEntries} spins remaining` : 'Share with friends to get more spins!'}
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-2xl font-bold text-gray-800">Available Prizes</h3>
                <button
              ...
              <div className="space-y-4">
                {prizes.slice(0, 5).map((prize) => (
                  ...
                  >
                    <div className={`w-12 h-12 rounded-full bg-gradient-to-r ${prize.color} flex items-center justify-center text-white text-xl`}>
                      {prize.icon}
                    </div>
                    <div className="flex-1">
                      <h4 className="font-semibold text-gray-800">{prize.title}</h4>
                      <p className="text-sm text-gray-600">{prize.description}</p>
                    </div>
                    <div className="text-right">
                      <div className="font-bold text-purple-600">{prize.value}</div>
                      <div className="text-xs text-gray-500">{prize.probability}% chance</div>
                    </div>
                  </motion.div>
                ))}
              </div>
        ...
        {showRules && (
          ...
          >
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-gray-800 mb-6">Lucky Draw Rules</h3>
              ...
              <div className="space-y-4 text-sm text-gray-600">
                ...
                <div>
                  <h4 className="font-semibold text-gray-800 mb-2">Prize Redemption:</h4>
                  <ul className="space-y-1">
