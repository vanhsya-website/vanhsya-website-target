...
export default function DocumentAnalyzer({
  ...
  const analyzeDocument = useCallback(
    async (file: File): Promise<DocumentAnalysis> => {
      ...
      const mockAnalysis: DocumentAnalysis = {
        ...
        documentType: file.name.toLowerCase().includes('passport')
          ? 'Passport'
        ...
        requirements: {
          ...
          missing:
            Math.random() > 0.5
              ? ['Notarization required', 'Translation needed']
              : [],
        },
      };
      ...
      >
        ...
        <div className='bg-gradient-to-r from-purple-600 to-purple-800 px-8 py-6 text-white'>
          ...
          <p className='text-purple-100'>
            Upload your immigration documents for instant AI-powered analysis
            and validation
          </p>
        </div>
                ...
                >
                  ...
                  <div className='text-center'>
                    ...
                    <p className='text-gray-600 mt-1'>
                      Our AI is examining your document for compliance and
                      quality
                    </p>
                  </div>
                </motion.div>
              ...
              >
                ...
                <div className='bg-gray-50 rounded-xl p-6'>
                  <div className='flex items-center justify-between mb-4'>
                    ...
                    <div
                      className={`px-4 py-2 rounded-full ${getScoreBgColor(analysis.score)}`}
                    >
                      <span
                        className={`font-bold ${getScoreColor(analysis.score)}`}
                      >
                        {analysis.score}/100
                      </span>
                    </div>
