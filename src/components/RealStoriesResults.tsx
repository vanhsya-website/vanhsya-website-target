  ...
  const testimonials: Testimonial[] = [
    {
      ...
      rating: 5,
      quote:
        'VANHSYA made my Canadian dream a reality. Their AI tools caught errors in my application that other consultants missed. The transparency was incredible - I could track every step. No hidden fees, just honest service.',
    ...
    },
    {
      ...
      rating: 5,
      quote:
        "After being scammed by two agencies, I found VANHSYA. Their Scam Shield saved me from another fake job offer. The team's expertise and the AI verification gave me confidence. Now I'm living my Australian dream!",
    ...
    },
    {
      ...
      rating: 5,
      quote:
        'The best decision I made was choosing VANHSYA. Their certified consultants guided me through every step. The AI document checker found issues before submission. Professional, transparent, and successful!',
    ...
    },
    {
      ...
      rating: 5,
      quote:
        "VANHSYA's referral program helped me save thousands. Their expert team handled my PNP application flawlessly. The live tracking feature kept me informed throughout. Highly recommended for serious migrants.",
      ...
      <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        >
          ...
          <p className='text-lg text-gray-300 max-w-3xl mx-auto mb-4'>
            Every review is video-recorded, geotagged, LinkedIn-authenticated,
            and publicly traceable.
          </p>
          <p className='text-amber-300 font-semibold'>
            No paid actors, ever. Just real clients sharing their genuine
            migration journey.
          </p>
        </motion.div>
                ...
                <GlassCard className='space-y-6'>
                  ...
                  <div className='grid grid-cols-2 gap-4 pt-4 border-t border-white/10'>
                    ...
                    <div>
                      ...
                      <p className='text-white font-medium'>
                        {currentTestimonial.migrationDate}
                      </p>
                    </div>
                  </div>
