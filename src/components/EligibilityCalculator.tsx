          ...
          >
            <div
              className={`w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6 ${
                result.eligibility === 'Highly Eligible'
                  ? 'bg-green-500'
                  : result.eligibility === 'Eligible'
                    ? 'bg-blue-500'
                    : result.eligibility === 'May Be Eligible'
                      ? 'bg-yellow-500'
                      : 'bg-red-500'
              }`}
            >
        ...
        >
          <div className='text-center mb-8'>
            ...
            <p className='text-gray-600'>
              Get an instant assessment of your immigration eligibility in just
              2 minutes
            </p>
          </div>
            ...
            >
                ...
                {currentQuestion.options.map(option => (
                  ...
                  >
                    <input
                      ...
                      checked={
                        formData[
                          currentQuestion.id as keyof CalculatorState
                        ] === option.value
                      }
                      onChange={e =>
                        setFormData({
              ...
              <div className='flex justify-between mt-8'>
                ...
                <motion.button
                  ...
                  whileHover={{
                    scale: formData[currentQuestion.id as keyof CalculatorState]
                      ? 1.05
                      : 1,
                  }}
                  className={`px-6 py-2 rounded-lg font-medium ${
          ...
          <div className='text-center mt-6'>
            <div className='flex items-center justify-center text-sm text-gray-500'>
              ...
              This is a preliminary assessment. Contact our experts for detailed
              evaluation.
            </div>
          </div>
        </motion.div>
