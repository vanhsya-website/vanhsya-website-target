...
export default function VIPComparison() {
  const features: Feature[] = [
    ...
    {
      name: 'Direct lawyer consultation',
      free: false,
      vip: true,
      highlight: true,
    },
  ...
  const renderFeatureValue = (value: boolean | string, isVip = false) => {
    if (typeof value === 'boolean') {
      return value ? (
        <Check
          className={`w-5 h-5 ${isVip ? 'text-purple-600' : 'text-green-600'}`}
        />
      ) : (
    ...
    return (
      <span
        className={`text-sm font-medium ${isVip ? 'text-purple-700' : 'text-gray-700'}`}
      >
        {value}
      </span>
    );
    ...
    <section className='bg-white rounded-2xl border border-gray-200 overflow-hidden'>
      ...
      <div className='bg-gradient-to-r from-purple-50 to-purple-100 p-8 text-center'>
        ...
        <p className='text-gray-600 max-w-2xl mx-auto'>
          Compare our Free and VIP membership benefits to find the perfect plan
        ...
        <table className='w-full'>
          <thead>
            <tr className='border-b border-gray-200'>
              <th className='text-left p-6 font-medium text-gray-500 w-1/2'>
                Features
              </th>
      ...
      <div className='bg-gray-50 p-8'>
        <div className='grid gap-4 sm:grid-cols-2 max-w-4xl mx-auto'>
          ...
          <div className='text-center'>
            ...
            <p className='text-sm text-purple-600 mb-4'>
              For serious immigration candidates
            </p>
            <Link
        ...
        <div className='mt-8 pt-6 border-t border-gray-200 text-center'>
          <p className='text-sm text-gray-500 mb-4'>
            🎁 Limited Time: First month 50% off for new VIP members
          </p>
