    ...
    >
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-xl font-semibold text-neutral-800">{country.name}</h3>
      ...
      {/* Description */}
      <p className="text-neutral-700 mb-4 leading-relaxed flex-grow">{country.description}</p>
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <div className="bg-neutral-50 rounded-lg p-3">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs font-medium text-neutral-600">Programs</span>
          </div>
          <div className="text-lg font-semibold text-neutral-800">{country.stats.programs}</div>
        </div>
        <div className="bg-neutral-50 rounded-lg p-3">
          <div className="flex items-center gap-2 mb-1">
          ...
          <div className="text-lg font-semibold text-neutral-800">{country.stats.processing}</div>
        </div>
        <div className="bg-neutral-50 rounded-lg p-3">
          <div className="flex items-center gap-2 mb-1">
            <DollarSign className="w-4 h-4 text-neutral-500" />
            <span className="text-xs font-medium text-neutral-600">Investment</span>
          </div>
          <div className="text-lg font-semibold text-neutral-800">{country.stats.investment}</div>
        </div>
        <div className="bg-neutral-50 rounded-lg p-3">
          <div className="flex items-center gap-2 mb-1">
            <TrendingUp className="w-4 h-4 text-neutral-500" />
            <span className="text-xs font-medium text-neutral-600">Success Rate</span>
          </div>
          <div className="text-lg font-semibold text-neutral-800">{country.stats.success}</div>
        </div>
      </div>

      {/* Highlights */}
      <div className="mb-4">
        <h4 className="text-sm font-medium text-neutral-800 mb-2">Key Highlights</h4>
