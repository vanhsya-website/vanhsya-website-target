...
export default function MigrationReadinessCard({
  className = '',
  ...
  return (
    <div
      className={`group relative overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 border-2 border-emerald-200 hover:border-emerald-300 transition-all duration-300 hover:shadow-xl ${className}`}
    >
      {/* Background Pattern */}
      ...
      <div className='relative p-8'>
        ...
        <p className='text-gray-600 mb-6 leading-relaxed'>
          Get your personalized Migration Readiness Score in under 3 minutes.
          Our AI analyzes your profile and provides tailored recommendations for
