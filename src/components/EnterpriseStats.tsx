...
import { Users, Globe, Award, Clock, TrendingUp, Shield, CheckCircle, Star } from 'lucide-react';
...
const EnterpriseStats: React.FC<EnterpriseStatsProps> = ({ className = '' }) => {
  const ref = useRef(null);
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center mb-20">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
              Our numbers speak for themselves. Join a community of successful immigrants 
              who have transformed their lives with VANHSYA's expert guidance and innovative solutions.
            </p>
          </motion.div>
              ...
              >
                <div className="relative h-full bg-gradient-to-br from-slate-50 to-white rounded-2xl p-8 border border-slate-200 hover:border-slate-300 transition-all duration-500 hover:shadow-2xl hover:shadow-slate-900/10 hover:-translate-y-2">
                  ...
                  <div className="relative z-10 flex items-center justify-between mb-6">
                    <div className={`inline-flex items-center justify-center w-14 h-14 bg-gradient-to-br ${stat.gradient} rounded-2xl group-hover:scale-110 transition-transform duration-300`}>
                  ...
                  {[
                    ...
                    >
                      ...
                      <div className="text-center">
                        ...
                        <div className="text-blue-300 text-xs">Moved to {testimonial.country}</div>
                      </div>
                    </motion.div>
                  ))}
                </div>
          ...
          <motion.div variants={itemVariants} className="mt-20">
            <div className="text-center mb-12">
              ...
              <p className="text-slate-600 max-w-2xl mx-auto">
                Our commitment to excellence has earned recognition from leading organizations and certifications.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                >
                  ...
                  <div className="text-slate-900 font-semibold text-lg">{cert.name}</div>
                  <div className="text-slate-600 text-sm">{cert.description}</div>
                </motion.div>
              ))}
            </div>
          </motion.div>
