          ...
          <div className='grid grid-cols-2 md:grid-cols-4 gap-6'>
            {awards.map((award, index) => (
              ...
              >
                ...
                <span className='text-sm font-semibold text-blue-300 text-center'>
                  {award.text}
                </span>
              </motion.div>
            ))}
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12'>
          ...
          <motion.div variants={itemVariants} className='lg:col-span-2'>
            ...
            <p className='text-slate-300 mb-6 leading-relaxed'>
              The world's most powerful AI-driven migration platform. Experience
              quantum processing, 99.8% success rate, and revolutionary service
              that redefines possibility in global migration.
            </p>
              ...
              {[
                {
                  icon: Phone,
                  text: '+1-800-VANHSYA',
                  href: 'tel:+18008264792',
                },
                {
                  icon: Mail,
                  text: 'support@vanhsya.com',
        ...
        >
          <div className='text-center mb-6'>
            <h3 className='text-2xl font-bold text-white mb-2'>
              Stay Updated with AI Migration Insights
            </h3>
            <p className='text-blue-200'>
              Get the latest updates, success stories, and migration
          ...
          <div className='flex flex-col md:flex-row justify-between items-center gap-6'>
            ...
            <div className='text-center'>
              <p className='text-slate-400 flex items-center gap-2'>
                Made with <Heart className='w-4 h-4 text-red-500' /> by VANHSYA
                Team
              </p>
              <p className='text-slate-500 text-sm mt-1'>
                © 2024 VANHSYA. All rights reserved. | Privacy Policy | Terms
                of Service
              </p>
            </div>
          </div>
