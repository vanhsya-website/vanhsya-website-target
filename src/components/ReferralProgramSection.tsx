...
import { FiGift, FiUsers, FiTrendingUp, FiArrowRight, FiStar, FiTarget } from 'react-icons/fi';
          ...
          {referralTiers.map((tier, index) => (
            ...
            >
              <GlassCard className={`h-full text-center group hover:scale-105 transition-all duration-300 ${
                ...
                {/* Reward */}
                <div className={`text-lg font-bold bg-gradient-to-r ${tier.color} bg-clip-text text-transparent mb-4`}>
                  {tier.reward}
                </div>
