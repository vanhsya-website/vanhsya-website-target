      ...
      <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        >
          ...
          <p className='text-lg text-gray-300 max-w-3xl mx-auto mb-4'>
            <span className='text-yellow-300 font-bold'>
              Pay small, refer 10 friends, get full package FREE!
            </span>
          </p>
          <p className='text-gray-300 max-w-3xl mx-auto'>
            Help your friends migrate safely while earning rewards for yourself.
            The more you refer, the more you save - up to 100% of your migration
            fees.
          </p>
        </motion.div>
            ...
            <div className='space-y-4'>
              ...
              <div className='w-full bg-white/20 rounded-full h-4'>
                <motion.div
                  ...
                  initial={{ width: 0 }}
                  whileInView={{
                    width: `${(currentStats.totalReferrals / 10) * 100}%`,
                  }}
                  viewport={{ once: true }}
            ...
            >
              <GlassCard
                className={`h-full text-center group hover:scale-105 transition-all duration-300 ${
                  currentStats.totalReferrals >= tier.referrals
              ...
              >
                ...
                <div className='flex justify-center mb-4'>
                  <div
                    className={`px-4 py-2 bg-gradient-to-r ${tier.color} rounded-full text-white font-bold text-sm flex items-center space-x-2`}
                  >
                    {tier.name === 'Platinum' && (
                ...
                {/* Reward */}
                <div
                  className={`text-lg font-bold bg-gradient-to-r ${tier.color} bg-clip-text text-transparent mb-4`}
                >
                  {tier.reward}
                </div>
                ...
                {/* Achievement Status */}
                {currentStats.totalReferrals >= tier.referrals ? (
                  <div className='px-3 py-2 bg-green-500/20 border border-green-400/30 rounded-lg text-green-300 text-sm font-medium'>
                    ✅ Achieved!
                  </div>
                ) : (
                  <div className='px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-gray-400 text-sm'>
                    {tier.referrals - currentStats.totalReferrals} more needed
                  </div>
                )}
              </GlassCard>
            </motion.div>
        ...
        >
          <GlassCard className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-lg text-gray-300 mb-6'>
              Top referrers win exclusive global experiences and lifetime
              benefits!
            </p>
            ...
            <div className='text-purple-300 font-medium'>
              Your current rank:{' '}
              <span className='text-white'>#{currentStats.rank}</span>
        ...
        >
          ...
          <p className='text-gray-400 text-sm mt-4 max-w-2xl mx-auto'>
            Join thousands of successful referrers who have earned FREE
            migrations and helped their friends achieve their dreams safely.
          </p>
        </motion.div>
      </div>
    </section>
