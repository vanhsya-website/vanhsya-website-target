...
const AIFeaturesShowcase: React.FC = () => {
  const features = [
    {
      ...
      description: 'Real-time migration trends and analytics across 150+ countries with live data visualization.',
      icon: BarChart3,
    ...
    },
    {
      ...
      description: 'Get expert immigration advice enhanced by AI analysis and personalized recommendations.',
      icon: Bot,
    ...
    },
    {
      ...
      description: 'Monitor live immigration analytics, success rates, and processing times with advanced metrics.',
      icon: Activity,
      href: '/dashboard',
      badge: 'LIVE',
    ...
    },
    {
      ...
      description: 'Advanced AI-powered fraud detection system protecting you from immigration scams.',
      icon: Shield,
      href: '/scam-detector',
      badge: 'HOT',
  ...
  return (
    <section className={`py-24 ${VanhsyaTheme.backgrounds.main} relative overflow-hidden`}>
      {/* Animated Background */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className={`text-5xl md:text-6xl font-bold ${VanhsyaTheme.text.gradient} mb-6`}>
            AI-Powered Immigration Suite
          </h2>
          <p className={`text-xl ${VanhsyaTheme.text.secondary} max-w-4xl mx-auto mb-8`}>
            Experience the future of immigration with our comprehensive AI-powered platform. 
            From real-time analytics to expert consultations, everything you need for successful migration.
          </p>
        </motion.div>
          ...
          {features.map((feature) => (
            ...
            >
              ...
              >
                ...
                <div className="flex items-start justify-between mb-6">
                  ...
                  <div className="flex items-center gap-2">
                    <span className={`px-3 py-1 text-xs font-bold rounded-full ${
                      feature.badge === 'LIVE' ? 'bg-red-500/20 text-red-400 border border-red-500/30' :
                      feature.badge === 'NEW' ? 'bg-green-500/20 text-green-400 border border-green-500/30' :
                      feature.badge === 'HOT' ? 'bg-orange-500/20 text-orange-400 border border-orange-500/30' :
                ...
                {/* Content */}
                <div className="mb-8">
                  <h3 className={`text-2xl font-bold ${VanhsyaTheme.text.primary} mb-4 group-hover:text-white transition-colors`}>
                    {feature.title}
                  </h3>
                  <p className={`${VanhsyaTheme.text.secondary} leading-relaxed mb-6`}>
                    {feature.description}
                  </p>
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-6">
                    {feature.stats.map((stat, statIndex) => (
                      ...
                      >
                        <div className={`text-xs font-medium ${VanhsyaTheme.text.secondary}`}>
                          {stat}
                        </div>
                      </div>
                    ))}
        ...
        >
          <div className={`${VanhsyaTheme.backgrounds.glass} rounded-3xl p-8 border border-white/20 mx-auto max-w-4xl`}>
            ...
            <h3 className={`text-3xl font-bold ${VanhsyaTheme.text.primary} mb-4`}>
              Ready to Experience the Future of Immigration?
            </h3>
            <p className={`text-lg ${VanhsyaTheme.text.secondary} mb-8`}>
              Join thousands of successful migrants who trust VANHSYA's AI-powered immigration platform. 
              Start your journey with our comprehensive suite of intelligent tools.
            </p>
