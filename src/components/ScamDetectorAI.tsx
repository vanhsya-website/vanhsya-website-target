...
const ScamDetectorAI: React.FC = () => {
  ...
  const [companyData, setCompanyData] = useState<CompanyVerification | null>(
    null
  );
  ...
  const recentAlerts: ScamAlert[] = [
    {
      ...
      description:
        'Multiple reports of companies promising 100% visa guarantees with upfront payments',
      confidence: 96,
      indicators: [
    ...
    },
    {
      ...
      description:
        'Companies offering fake educational certificates for visa applications',
      confidence: 87,
      indicators: [
        'Document forgery',
    ...
    },
    {
      ...
      description:
        'Fraudulent job offers requiring payment for visa processing',
      confidence: 94,
      indicators: [
    ...
    >
      ...
      <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        >
          ...
          >
            World's most advanced AI-powered scam detection system. Protect
            yourself from migration fraud with real-time threat intelligence and
            instant verification.
          </p>

          <div className='flex flex-wrap justify-center gap-4 mb-8'>
            <div
              className={`flex items-center gap-2 px-4 py-2 ${VanhsyaTheme.backgrounds.glass} rounded-xl`}
            >
              ...
              >
                <div className='text-center mb-8'>
                  ...
                  <p className={VanhsyaTheme.text.secondary}>
                    Enter company name, website URL, or any suspicious
                    information for instant verification
                  </p>
                </div>
                      ...
                      >
                        <div className='flex items-start justify-between mb-3'>
                          <div className='flex items-center gap-3'>
                            <div
                              className={`p-2 bg-gradient-to-r ${getStatusColor(result.type)} rounded-lg`}
                            >
                          ...
                          <div className='text-right'>
                            ...
                            <div
                              className={`font-bold ${VanhsyaTheme.text.primary}`}
                            >
                              {result.confidence}%
                            </div>
                          </div>
                ...
                {companyData && (
                  ...
                  >
                    ...
                    <div
                      className={`p-6 ${VanhsyaTheme.backgrounds.glass} rounded-xl border border-white/20`}
                    >
                      <div className='flex items-center justify-between mb-6'>
                        <div>
                          <h4
                            className={`text-lg font-bold ${VanhsyaTheme.text.primary}`}
                          >
                            {companyData.name}
                          </h4>
                          <div className='flex items-center gap-2 mt-2'>
                            <div
                              className={`p-1 bg-gradient-to-r ${getStatusColor(companyData.status)} rounded`}
                            >
                              {getStatusIcon(companyData.status)}
                            </div>
                            <span
                              className={`font-medium ${companyData.status === 'verified' ? 'text-green-400' : companyData.status === 'suspicious' ? 'text-yellow-400' : 'text-red-400'}`}
                            >
                        ...
                        <div className='text-right'>
                          <div
                            className={`text-3xl font-bold ${VanhsyaTheme.text.primary}`}
                          >
                      ...
                      <div className='grid grid-cols-2 md:grid-cols-5 gap-4'>
                        <div className='text-center'>
                          <div
                            className={`text-2xl ${companyData.details.registration ? 'text-green-400' : 'text-red-400'}`}
                          >
                        ...
                        <div className='text-center'>
                          <div
                            className={`text-2xl ${companyData.details.license ? 'text-green-400' : 'text-red-400'}`}
                          >
                        ...
                        <div className='text-center'>
                          <div
                            className={`text-xl font-bold ${companyData.details.complaints > 5 ? 'text-red-400' : 'text-green-400'}`}
                          >
                        ...
                        <div className='text-center'>
                          <div
                            className={`text-xl font-bold ${VanhsyaTheme.text.primary}`}
                          >
                            {companyData.details.operatingYears}
                          </div>
                          <div
                            className={`text-sm ${VanhsyaTheme.text.secondary}`}
                          >
                  ...
                  {recentAlerts.map((alert, index) => (
                    ...
                    >
                      <div className='flex items-start gap-4'>
                        <div
                          className={`p-3 bg-gradient-to-r ${getStatusColor(alert.type)} rounded-xl flex-shrink-0`}
                        >
                        ...
                        <div className='flex-1'>
                          ...
                          <p className={`${VanhsyaTheme.text.secondary} mb-4`}>
                            {alert.description}
                          </p>
        ...
        >
          {[
            ...
            >
              <div
                className={`p-4 bg-gradient-to-r ${stat.color} rounded-xl w-fit mx-auto mb-4`}
              >
