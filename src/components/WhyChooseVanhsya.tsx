...
import { 
  Sparkles, Shield, Globe, Zap, Brain, Award, 
  Clock, CheckCircle2, Star, Crown, Rocket, Heart
} from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Revolutionary quantum processing with 500+ pattern analysis for unmatched accuracy and speed.',
      stats: '99.8% Accuracy',
    ...
    },
    {
      ...
      description: 'Blockchain-powered protection with zero-knowledge encryption ensuring your data remains sovereign.',
    ...
    },
    {
      ...
      description: 'Connected to 195+ countries with real-time embassy updates and diplomatic intelligence.',
      stats: '195+ Countries',
    ...
    },
    {
      ...
      description: 'Quantum-speed document processing and instant eligibility assessment in real-time.',
    ...
    },
    {
      ...
      description: 'Industry-leading 99.8% success rate with guaranteed outcomes and full transparency.',
    ...
    },
    {
      ...
      description: 'Never-sleeping quantum AI support system providing instant assistance across all time zones.',
      ...
      >
        ...
        >
          ...
          >
            ...
            <span className="text-white font-semibold">The New Migration Era</span>
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
            Pioneering the new era of global migration with VANHSYA's revolutionary AI technology, 
            breakthrough security systems, and industry-transforming success rates that reshape the world.
          </motion.p>
        </motion.div>
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              >
                ...
                {/* Hover Effect Border */}
                <motion.div
                  className="absolute inset-0 rounded-3xl border-2 border-transparent group-hover:border-blue-500/50 transition-colors duration-500"
                />
              </motion.div>
            </motion.div>
          ))}
