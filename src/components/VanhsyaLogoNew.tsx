...
export default function VanhsyaLogo({ 
  ...
  return (
    <motion.div
      ...
      initial={animated ? { scale: 1, filter: 'drop-shadow(0 0 15px rgba(147, 51, 234, 0.4))' } : undefined}
      whileHover={animated ? { scale: 1.05, filter: 'drop-shadow(0 0 30px rgba(147, 51, 234, 0.8))' } : undefined}
      animate={animated ? {
        filter: [
