  ...
  const features: Feature[] = [
    {
      ...
      description: 'Advanced artificial intelligence analyzes your profile and provides personalized immigration strategies.',
      benefits: [
    ...
    },
    {
      ...
      description: 'Bank-grade security ensures your sensitive information is protected throughout the process.',
      benefits: [
    ...
    },
    {
      ...
      description: 'Licensed immigration consultants and lawyers provide professional guidance at every step.',
      benefits: [
    ...
    },
    {
      ...
      description: 'Streamlined workflows and automated systems reduce processing time by up to 60%.',
      benefits: [
    ...
    },
    {
      ...
      description: 'Comprehensive immigration services for 195+ countries and territories worldwide.',
      benefits: [
    ...
    },
    {
      ...
      description: 'Advanced analytics and tracking ensure optimal outcomes for your immigration journey.',
      benefits: [
        '99.8% success rate',
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center mb-20">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
              Experience the future of immigration services with our comprehensive platform that combines 
              cutting-edge technology with human expertise to deliver exceptional results.
            </p>
          </motion.div>
                    ...
                    <ul className="space-y-3 mb-6">
                      {feature.benefits.map((benefit, benefitIndex) => (
                        <motion.li
                          ...
                          transition={{ delay: 0.3 + (index * 0.1) + (benefitIndex * 0.05) }}
                        >
                          <CheckCircle className={`w-5 h-5 text-${feature.color}-500 flex-shrink-0 mt-0.5`} />
            ...
            <div className="bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 rounded-3xl p-12 lg:p-16 relative overflow-hidden">
              ...
              <div className="relative z-10 max-w-4xl mx-auto">
                ...
                <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
                  Join thousands of successful immigrants who chose VANHSYA for their journey. 
                  Start with a free consultation and discover your possibilities.
                </p>
                ...
                <div className="mt-12 pt-8 border-t border-slate-700/50">
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
                    {[
                      ...
                      { icon: Globe, label: '195+ Countries', value: 'Covered' },
