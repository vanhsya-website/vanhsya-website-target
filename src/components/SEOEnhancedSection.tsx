    ...
    <section className='relative py-16 bg-gradient-to-b from-slate-950 to-indigo-950 overflow-hidden'>
      ...
      <div className='max-w-7xl mx-auto px-6'>
        ...
        <div className='text-center mb-12'>
          ...
          >
            Experience the future of global migration with VANHSYA's
            revolutionary AI technology. Trusted by 50,000+ clients worldwide
            for visa applications, permanent residence, and immigration
            services.
          </motion.p>
        </div>
        ...
        >
          <div>
            <h3 className='text-2xl font-bold text-white mb-6'>
              Why Choose VANHSYA AI Migration Platform?
            </h3>
          ...
          <div>
            ...
            <div className='bg-slate-800/50 rounded-2xl p-6 border border-slate-700'>
              <p className='text-slate-300 leading-relaxed mb-4'>
                VANHSYA offers comprehensive immigration services for{' '}
                <strong>Canada Express Entry</strong>,
                <strong> Australia Skilled Migration</strong>,{' '}
                <strong>USA Green Card</strong>,
                <strong> UK Global Talent Visa</strong>, and{' '}
                <strong>195+ countries worldwide</strong>.
              </p>
              <p className='text-slate-300 leading-relaxed'>
                Our AI-powered platform provides{' '}
                <em>visa application assistance</em>,
                <em> document preparation</em>, <em>eligibility assessment</em>,
                and
