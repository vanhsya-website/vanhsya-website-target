  ...
  return [
    {
      ...
      description:
        '5 tips to increase your CRS score! Save this for later 💾 #CanadaImmigration #ExpressEntry #CRS',
      views: 245800,
      likes: 15600,
      duration: '0:58',
    ...
    },
    {
      ...
      description:
        'When you get your PR invitation after 2 years of waiting! Congratulations Priya! 🇦🇺✨',
      views: 892400,
      likes: 67800,
      duration: '0:15',
    ...
    },
    {
      ...
      description:
        'This study method helped me get 8.5 in IELTS! Try it and thank me later 🙌 #IELTS #StudyTips',
      views: 156200,
      likes: 12400,
      duration: '1:23',
    ...
    },
    {
      ...
      description:
        'Everything changed! New UK visa requirements you MUST know 🇬🇧 #UKVisa #Immigration2025',
      views: 78900,
      likes: 5600,
      duration: '2:10',
    ...
    },
    {
      ...
      description:
        'POV: Your immigration documents are perfectly organized 💯 Use our AI wizard! #DocumentPrep',
      views: 234500,
      likes: 18900,
      duration: '0:45',
    ...
    },
    {
      ...
      description:
        'Latest Express Entry draw: 3,500 invitations, CRS 496! What this means for you 👇',
      views: 445600,
      likes: 32100,
      duration: '1:05',
      date: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(),
    ...
    <div className='space-y-4'>
      ...
      <div className='text-center pt-4'>
        <button
          ...
          onClick={() =>
            window.open('https://tiktok.com/@vanhsya_global', '_blank')
          }
        >
