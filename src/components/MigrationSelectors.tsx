      ...
      <div className='max-w-4xl mx-auto'>
        ...
        <div className='text-center mb-8'>
          ...
          <p className='text-xl text-white/80'>
            Tell us about yourself and we'll show you the best destinations for
            your profile
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          ...
          <div className='bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6'>
            ...
            {selectedNationality && (
              ...
              >
                ✓ Great! We'll show you the best options for{' '}
        ...
        {(!selectedNationality || !selectedGoal) && (
          ...
          >
            <p className='text-white/60'>
              👆 Please select both your nationality and migration goal to see
