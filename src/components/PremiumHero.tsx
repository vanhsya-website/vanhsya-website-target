...
export default function PremiumHero() {
  ...
  useEffect(() => {
    setMounted(true);
    const deterministicElements = generateFloatingElements(
      25,
            ...
            >
              ...
              >
                ...
                <p className='text-xl sm:text-2xl text-neutral-300 leading-relaxed max-w-2xl lg:max-w-none'>
                  Experience the future of immigration with our advanced AI
                  platform. Streamlined processes, expert guidance, and
                  guaranteed results across 195+ countries.
                </p>
              </motion.div>
