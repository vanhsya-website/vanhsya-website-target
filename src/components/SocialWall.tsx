  ...
  return (
    <div className='fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 z-50'>
      <div className='relative bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-auto'>
        {/* Header */}
        <div
          className={`bg-gradient-to-r ${platformColors[post.platform]} p-6 text-white`}
        >
  ...
  const posts: SocialPost[] = [
    {
      ...
      description:
        '🎉 Incredible news! Our client Priya just received her Australia PR invitation with 85 points! From document preparation to application submission, VANHSYA guided every step. Your dream migration is possible! 💫 #AustraliaPR #SuccessStory #VANHSYA',
      likes: 1247,
      comments: 89,
    ...
    },
    {
      ...
      description:
        'Join our immigration expert for live analysis of the latest Express Entry draw! 3,500 invitations issued with CRS 496. What does this mean for your application? Ask your questions in the chat! 🔴 LIVE NOW',
      likes: 2156,
      comments: 234,
    ...
    },
    {
      ...
      description:
        'Important update: UK government announces new Skilled Worker visa requirements effective March 2025. Key changes include updated salary thresholds and skill level requirements. Our team has prepared a comprehensive guide to help you navigate these changes. Read our latest article for complete details.',
      likes: 567,
      comments: 45,
    ...
    },
    {
      ...
      description:
        '📢 FREE Webinar Alert! "Canada Immigration Pathways 2025" - Join our expert panel discussion on Express Entry, PNP, and other immigration programs. Register now for exclusive insights and Q&A session. Limited seats available! 🇨🇦',
      likes: 892,
      comments: 156,
    ...
    },
    {
      ...
      description:
        '🚨 BREAKING: New Zealand announces changes to Skilled Migrant Category. Key updates: - Updated skill shortage lists - New points system - Revised English requirements. Full analysis coming up! Stay tuned 🇳🇿 #NZImmigration #Breaking',
      likes: 445,
      comments: 67,
    ...
    },
    {
      ...
      description:
        "✅ Immigration document prep doesn't have to be overwhelming! Our AI-powered Document Wizard guides you step-by-step. Check out this client's organized document folder - ready for submission! 💪 Link in bio for free access. #DocumentPrep #AIWizard",
      likes: 678,
      comments: 98,
    ...
    },
    {
      ...
      description:
        "Inspiring journey! Watch Rajesh share his complete migration story - from initial consultation to landing in Melbourne. Learn about the challenges he faced and how VANHSYA's support made the difference. Must-watch for aspiring migrants! 🎬",
      likes: 1834,
      comments: 167,
    ...
    },
    {
      ...
      description:
        'As we enter 2025, immigration policies continue to evolve globally. Our latest industry report analyzes trends across major destinations: Canada, Australia, UK, USA, and New Zealand. Key findings: increased digital processing, skills-based selection, and family reunification focus.',
      likes: 789,
      comments: 123,
      ...
      >
        ...
        <div className='text-center mb-8'>
          ...
          <p className='text-gray-600 max-w-2xl mx-auto'>
            Latest updates, success stories, and immigration insights from
            VANHSYA's official social media channels. Updated in real-time.
          </p>
        </div>
