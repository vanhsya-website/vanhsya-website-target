        ...
        <div className="container-max">
          ...
          >
            ...
            <p className="text-modern max-w-3xl mx-auto">
              Ready to start your immigration journey? Our expert team is available 24/7 to assist you 
                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-green-600 font-medium">+1 (800) 782-6479</p>
                    </div>
                  </motion.a>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-blue-600 font-medium">Free 30-min consultation</p>
                    </div>
                  </motion.button>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-purple-600 font-medium">info@vanhsya.com</p>
                    </div>
                  </motion.a>
