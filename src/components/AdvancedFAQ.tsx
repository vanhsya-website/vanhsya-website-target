...
const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer: 'Visa costs vary significantly by country and type: Government fees: $150-$3,000+, Our service fees: ₹25,000-₹4,00,000 (depending on complexity), Additional costs: Medical exams, police clearances, document translations, courier services. We provide transparent pricing with no hidden costs and offer payment plans for expensive applications. Contact us for a detailed cost breakdown for your specific case.',
    category: 'services',
...
const AdvancedFAQ = () => {
  ...
  const categories: Category[] = [
    ...
    { id: 'visa', name: 'Visa Process', icon: FileText, color: 'text-blue-600' },
    { id: 'immigration', name: 'Immigration', icon: Globe, color: 'text-green-600' },
    { id: 'documentation', name: 'Documentation', icon: BookOpen, color: 'text-purple-600' },
    { id: 'timeline', name: 'Timeline', icon: Clock, color: 'text-orange-600' },
    { id: 'services', name: 'Our Services', icon: Users, color: 'text-pink-600' },
      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Find answers to the most common questions about visas, immigration, and our services. 
        ...
        {searchTerm && (
          <div className="mb-6 text-center">
            <p className="text-gray-600">
              Found <span className="font-semibold text-blue-600">{filteredFAQs.length}</span> result{filteredFAQs.length !== 1 ? 's' : ''} for "{searchTerm}"
            </p>
          </div>
        )}
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-8 text-white">
            ...
            <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
              Our immigration experts are here to help! Get personalized answers to your specific questions 
