    ...
    <section className='relative min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-hidden'>
      ...
      <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
        <motion.div variants={fadeIn} initial='hidden' animate='visible'>
          ...
          >
            Empowering global migration with AI-powered guidance, expert
            support, and seamless digital experiences for your new beginning.
          </motion.p>
          ...
          >
            ...
            >
              ...
              >
                ...
                <svg
                  className='ml-2 w-5 h-5 group-hover:scale-110 transition-transform duration-300'
                  fill='none'
                  stroke='currentColor'
                  viewBox='0 0 24 24'
                >
