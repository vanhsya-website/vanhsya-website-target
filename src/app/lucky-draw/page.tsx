...
import { 
  Trophy, Crown, CheckCircle, Award
} from 'lucide-react';
...
const LuckyDrawPage = () => {
  ...
  const formatPrice = (aedPrice: number) => {
    ...
    const symbol = currencies[selectedCurrency as keyof typeof currencies].symbol;
        ...
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-2xl text-purple-300 font-bold mb-8">
              Win Life-Changing Immigration Services Worth Up To {formatPrice(25000)}!
            </p>
            ...
            <div className="grid grid-cols-4 gap-4 max-w-2xl mx-auto mb-12">
              {Object.entries(timeLeft).map(([unit, value]) => (
                ...
                >
                  ...
                  <div className="text-purple-300 font-bold uppercase">{unit}</div>
                </motion.div>
              ))}
            </div>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-4xl mx-auto leading-relaxed">
              Life-changing immigration services worth thousands of AED - Professional packages designed for your success
            </p>
          </motion.div>
            ...
            {prizes.map((prize, index) => (
              ...
              >
                <div className="relative p-8 bg-white/95 border-2 border-purple-200 rounded-3xl backdrop-blur-sm shadow-xl overflow-hidden min-h-[500px] flex flex-col">
                  {/* Rank Badge */}
                  <div className={`absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-r ${prize.color} rounded-full flex items-center justify-center text-white font-black text-xl shadow-2xl border-4 border-white`}>
                    #{prize.rank}
                  </div>
                  ...
                  <h3 className="text-2xl font-black text-slate-800 mb-3 text-center">{prize.title}</h3>
                  <p className="text-slate-600 text-center mb-6 leading-relaxed">{prize.description}</p>
                  ...
                  <div className="text-center mb-8">
                    ...
                    <span className="text-slate-500 text-lg font-bold">Total Package Value</span>
                  </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="p-8 bg-white/10 backdrop-blur-sm border border-purple-300/30 rounded-2xl">
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Step 1: Contact Us</h3>
                <p className="text-purple-300">Schedule a free consultation with our expert team</p>
              </div>
              <div className="p-8 bg-white/10 backdrop-blur-sm border border-purple-300/30 rounded-2xl">
                <div className="text-4xl mb-4">📋</div>
                <h3 className="text-2xl font-bold text-white mb-4">Step 2: Assessment</h3>
                <p className="text-purple-300">Complete your profile and get automatic entry</p>
              </div>
              <div className="p-8 bg-white/10 backdrop-blur-sm border border-purple-300/30 rounded-2xl">
                <div className="text-4xl mb-4">🎉</div>
                <h3 className="text-2xl font-bold text-white mb-4">Step 3: Win!</h3>
                <p className="text-purple-300">Winners announced live on our social channels</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-xl text-purple-300 mb-8">
              Join thousands of participants and take your first step towards a new life abroad.
            </p>
            <motion.button
      ...
      >
        ...
        <AnimatePresence>
          {showCurrencyDetails && (
            ...
            >
              <div className="text-sm font-bold text-slate-700 mb-3">Select Currency:</div>
