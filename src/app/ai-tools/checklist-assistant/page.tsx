...
const checklistTemplates: ChecklistTemplate[] = [
  {
    ...
    description:
      'Complete checklist for Canadian permanent residence through Express Entry',
    country: 'Canada',
  ...
  },
  {
    ...
    description:
      'Checklist for Australian skilled worker visa (subclass 189/190)',
    country: 'Australia',
          ...
          <div className='container-max'>
            ...
            >
              ...
              <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
                Stay organized throughout your immigration journey with
                personalized checklists, deadlines, and smart reminders powered
                by AI.
              </p>
            </motion.div>
            ...
            >
              <h2 className='text-2xl font-bold text-gray-800 mb-4'>
                Why Use Our Checklist Assistant?
              </h2>
              <div className='grid md:grid-cols-3 gap-6 mt-8'>
                ...
                <div className='text-center'>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Never miss important deadlines with intelligent
                    notifications
                  </p>
                </div>
                <div className='text-center'>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Optimized schedules based on processing times and
                    requirements
                  </p>
                </div>
              </div>
        ...
        <div className='container-max'>
          ...
          >
            ...
            <div className='flex items-center gap-4 text-sm text-gray-600'>
              ...
              <span>
                {
                  tasks.filter(t => !t.completed && !isOverdue(t.dueDate))
                    .length
                }{' '}
                pending
              </span>
                ...
                <div className='flex gap-2'>
                  {[
                    ...
                    <button
                      ...
                      onClick={() =>
                        setFilter(
                          filterOption.id as 'all' | 'pending' | 'completed'
                        )
                      }
