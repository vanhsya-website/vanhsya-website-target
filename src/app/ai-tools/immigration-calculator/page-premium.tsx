...
const calculatorFeatures = [
  {
    ...
    category: 'Scoring',
    type: 'canada',
    description: 'Advanced Comprehensive Ranking System calculator for Canada Express Entry with real-time scoring and optimization suggestions.',
  ...
  },
  {
    ...
    category: 'Assessment',
    type: 'multi-country',
    description: 'Multi-country immigration points calculator supporting Australia SkillSelect, New Zealand EOI, and other points-based systems.',
  ...
  },
  {
    ...
    category: 'Prediction',
    type: 'ai-powered',
    description: 'Revolutionary AI-powered eligibility predictor that analyzes your profile against 150+ visa programs across 25+ countries.',
  ...
  },
  {
    ...
    category: 'Financial',
    type: 'budgeting',
    description: 'Comprehensive financial calculator for immigration costs including government fees, living expenses, and settlement funds.',
  ...
  },
  {
    ...
    category: 'Timeline',
    type: 'scheduling',
    description: 'Smart timeline calculator that predicts processing times based on current trends, visa type, and application complexity.',
    processingTime: '0.2 seconds',
    accuracyRate: 94.2,
    basePrice: 29,
    emiOptions: [
...
const coreCapabilities = [
  {
    ...
    description: 'Instant immigration score calculation with live updates as you input data.',
    accuracy: '99.8%',
    speed: '0.1s',
    icon: Zap,
  ...
  },
  {
    ...
    description: 'Compare immigration options across 25+ countries simultaneously.',
  ...
  },
  {
    ...
    description: 'Advanced machine learning models predict your immigration success probability.',
    accuracy: '96.8%',
    dataPoints: '1000+',
    icon: Brain,
  ...
  },
  {
    ...
    description: 'Smart recommendations to improve your immigration profile and increase success rates.',
  ...
  },
  {
    ...
    description: 'Detailed breakdown of all immigration factors with personalized recommendations.',
    factors: '50+ analyzed',
    depth: 'Expert-level',
    icon: BarChart3,
  ...
  },
  {
    ...
    description: 'Complete financial planning with cost calculators and budget optimization.',
...
const referralPrograms = [
  {
    ...
    description: 'Earn rewards for every successful immigration score calculation referral',
    baseReward: 25,
    bonusReward: 50,
  ...
  },
  {
    ...
    description: 'Premium rewards for referring users who improve their scores significantly',
    baseReward: 40,
    bonusReward: 100,
  ...
  },
  {
    ...
    description: 'Exclusive program for immigration pathway advisors and consultants',
    baseReward: 75,
    bonusReward: 200,
...
const luckyDraws = [
  ...
  },
  {
    ...
    description: 'Complete immigration pathway consultation and documentation review',
    prizeValue: 5000,
    drawDate: '2025-03-01',
  ...
  },
  {
    ...
    description: 'Lifetime access to premium calculator suite plus personal consultant',
    prizeValue: 10000,
    drawDate: '2025-03-31',
...
export default function ImmigrationCalculatorPremiumPage() {
  ...
  const [selectedReferralProgram, setSelectedReferralProgram] = useState('calculator-champion');
  const [selectedLuckyDraw, setSelectedLuckyDraw] = useState('score-boost-draw');
  const [isMenuOpen, setIsMenuOpen] = useState(false);

  // Generate deterministic floating elements to prevent hydration mismatch
  const floatingElements = generateFloatingElements(50, 'immigration-calculator-bg');
  ...
  const selectedFeatureData = calculatorFeatures.find(f => f.id === activeFeature);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-bold text-white hidden sm:block">Immigration Calculator</h1>
            </div>
      ...
      {/* Hero Section */}
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden pt-16">{/* Added pt-16 for nav */}
        ...
        >
          <motion.div
            ...
            animate={{ opacity: isHeroInView ? 1 : 0, scale: isHeroInView ? 1 : 0.5 }}
          ...
          >
            ...
            <span className="text-purple-300 font-medium">AI-Powered Immigration Calculator Suite</span>
          </motion.div>
          ...
          >
            Experience revolutionary AI technology that calculates immigration scores, predicts success rates, 
            and optimizes your pathway to permanent residency across 25+ countries with 99.8% accuracy.
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Comprehensive suite of AI-powered immigration calculators designed to provide accurate 
              scoring, predictions, and pathway optimization for your immigration journey.
            </p>
          </motion.div>
              ...
              <div className="grid lg:grid-cols-2 gap-8">
                <div>
                  <div className="flex items-center gap-4 mb-6">
                    <div className={`p-4 rounded-xl bg-gradient-to-r ${selectedFeatureData.color}`}>
                      <selectedFeatureData.icon className="w-8 h-8 text-white" />
                    </div>
                    <div>
                      <h3 className="text-2xl font-bold text-white mb-2">{selectedFeatureData.name}</h3>
                      <div className="flex items-center gap-4 text-sm text-slate-400">
                        <span className="px-2 py-1 bg-purple-600/20 rounded-lg">{selectedFeatureData.category}</span>
                        <span>{selectedFeatureData.processingTime}</span>
                        <span>{selectedFeatureData.accuracyRate}% accuracy</span>
                      </div>
                    </div>
                  </div>
                  ...
                  {['features', 'benefits', 'technologies'].map((section) => (
                    <div key={section} className="mb-4">
                      <motion.button
                        ...
                        onClick={() => toggleSection(`${activeFeature}-${section}`)}
                      ...
                      >
                        <span className="font-semibold text-white capitalize">{section}</span>
                      ...
                      <motion.div
                        initial={false}
                        animate={{
                          height: expandedSections[`${activeFeature}-${section}`] ? 'auto' : 0,
                          opacity: expandedSections[`${activeFeature}-${section}`] ? 1 : 0
                        }}
                        transition={{ duration: 0.3 }}
                        className="overflow-hidden"
                      >
                        <div className="p-4 space-y-2">
                          {(selectedFeatureData[section as keyof typeof selectedFeatureData] as string[])?.map((item: string, index: number) => (
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gradient-to-br from-purple-600/20 to-blue-600/20 backdrop-blur-sm border border-purple-500/30 rounded-xl p-6">
                    <h4 className="text-xl font-bold text-white mb-4">Pricing & EMI Options</h4>
                    <div className="mb-4">
                    ...
                    <div className="space-y-3">
                      ...
                      {selectedFeatureData.emiOptions.map((emi, index) => (
                        <div key={index} className="flex justify-between items-center p-3 bg-white/5 rounded-lg">
                          <div>
                            <div className="text-white font-medium">{emi.months} months</div>
                            <div className="text-slate-400 text-sm">{emi.interest} interest</div>
                          </div>
                          <div className="text-right">
                            <div className="text-purple-400 font-bold">{formatPrice(emi.monthlyPayment)}/month</div>
                            <div className="text-slate-400 text-sm">Total: {formatPrice(emi.totalCost)}</div>
                          </div>
                        </div>
                      ))}
                    </div>
                  ...
                  <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="text-center">
                        <div className="text-2xl font-bold text-green-400">{selectedFeatureData.accuracyRate}%</div>
                        <div className="text-slate-400 text-sm">Accuracy Rate</div>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl font-bold text-blue-400">{selectedFeatureData.processingTime}</div>
      ...
      <section ref={capabilitiesRef} className="py-24 px-4 relative">
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: isCapabilitiesInView ? 1 : 0, y: isCapabilitiesInView ? 0 : 30 }}
            transition={{ duration: 0.8 }}
            className="text-center mb-16"
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Powered by advanced AI algorithms and machine learning models that deliver 
              unparalleled accuracy in immigration calculations and predictions.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {coreCapabilities.map((capability, index) => (
              ...
              >
                <div className={`inline-flex p-4 rounded-xl bg-gradient-to-r ${capability.color} mb-6`}>
                  <capability.icon className="w-8 h-8 text-white" />
                </div>
                
                <h3 className="text-xl font-bold text-white mb-3">{capability.name}</h3>
                <p className="text-slate-300 mb-4 leading-relaxed">{capability.description}</p>
      ...
      <section ref={calculatorRef} className="py-24 px-4 relative">
        <div className="max-w-4xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: isCalculatorInView ? 1 : 0, y: isCalculatorInView ? 0 : 30 }}
            transition={{ duration: 0.8 }}
            className="text-center mb-16"
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Experience the power of our AI-driven immigration calculator. Get instant results 
              with professional-grade accuracy in seconds.
            </p>
          </motion.div>
          ...
          >
            <div className="grid md:grid-cols-2 gap-8">
              {/* Input Form */}
              <div className="space-y-6">
                <h3 className="text-2xl font-bold text-white mb-6">Quick Assessment</h3>
                ...
                <div>
                  <label className="block text-white mb-2">Education Level</label>
                  <select className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-purple-500">
                ...
                <div>
                  <label className="block text-white mb-2">Work Experience</label>
                  <select className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-purple-500">
                ...
                <div>
                  <label className="block text-white mb-2">Language Test Score</label>
                  <select className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-purple-500">
              ...
              {/* Results Preview */}
              <div className="space-y-6">
                <h3 className="text-2xl font-bold text-white mb-6">Instant Results</h3>
                
                <div className="bg-gradient-to-br from-purple-600/20 to-blue-600/20 backdrop-blur-sm border border-purple-500/30 rounded-xl p-6">
                  <div className="text-center mb-6">
                    <div className="text-4xl font-bold text-purple-400 mb-2">425</div>
                    <div className="text-white font-medium">Estimated CRS Score</div>
                    <div className="text-slate-400 text-sm">Out of 1200 points</div>
                  </div>
                  
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <span className="text-slate-300">Age</span>
                      <span className="text-purple-400 font-medium">100 pts</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-slate-300">Education</span>
                      <span className="text-purple-400 font-medium">120 pts</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-slate-300">Language</span>
                      <span className="text-purple-400 font-medium">135 pts</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-slate-300">Experience</span>
                      <span className="text-purple-400 font-medium">70 pts</span>
                    </div>
                  </div>
                </div>

                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                  <h4 className="text-white font-bold mb-4">Success Probability</h4>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="text-slate-300">Canada Express Entry</span>
                      <span className="text-green-400 font-medium">85%</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-slate-300">Australia SkillSelect</span>
                ...
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4">
                  <div className="flex items-center gap-2 text-green-400">
                    ...
                    <span className="font-medium">Eligible for Multiple Programs</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 px-4 relative">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Earn rewards for sharing our AI-powered immigration calculators and helping others 
              ...
              >
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-green-400 font-bold">{formatPrice(program.baseReward)}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-slate-400">Bonus Reward</span>
                    <span className="text-purple-400 font-bold">{formatPrice(program.bonusReward)}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-slate-400">Requirements</span>
                    <span className="text-blue-400 font-medium text-sm">{program.requirements}</span>
                  </div>
                </div>
      ...
      <section className="py-24 px-4 relative">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Participate in exclusive lucky draws and win amazing prizes including free consultations, 
              premium calculator access, and complete immigration services.
            </p>
          </motion.div>
              ...
              >
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-yellow-400 font-bold">{formatPrice(draw.prizeValue)}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-slate-400">Draw Date</span>
                    <span className="text-blue-400 font-medium">{draw.drawDate}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-slate-400">Tickets Left</span>
                    <span className="text-green-400 font-medium">{draw.ticketsAvailable.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-slate-400">Entry Requirement</span>
                    <span className="text-purple-400 font-medium text-sm">{draw.entryRequirement}</span>
                  </div>
                </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-slate-300 mb-12 max-w-3xl mx-auto">
              Join 5M+ users leveraging cutting-edge AI technology for immigration calculation success. 
              Start your accurate assessment journey today.
            </p>
            ...
            <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-6">
              {Object.entries(calculatorStats).slice(0, 4).map(([key, value], index) => (
                <motion.div
                  key={key}
                  initial={{ opacity: 0, scale: 0.8 }}
