...
export default function EligibilityBot() {
          ...
          <div className='container-max'>
            ...
            >
              ...
              <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
                Based on your profile, here are your best immigration
                opportunities ranked by success probability
              </p>
            </motion.div>
        ...
        <section className='section-padding pt-32 bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center min-h-screen'>
          <div className='text-center'>
            ...
            <p className='text-gray-600 mb-6'>
              Our advanced algorithms are analyzing your responses and matching
              you with the best immigration opportunities.
            </p>
  ...
  return (
    <div className='min-h-screen'>
      <BackNavigation
        currentPage='AI Eligibility Checker'
        customBackUrl='/ai-tools'
        customBackLabel='AI Tools'
      />
                ...
                {currentQ.type === 'slider' && (
                  <div className='space-y-6'>
                    ...
                    <input
                      ...
                      onChange={e =>
                        handleAnswer(currentQ.id, parseInt(e.target.value))
                      }
