        ...
        <div className='container mx-auto px-6 relative z-10'>
          ...
          >
            ...
            <p className='text-lg text-gray-600 mb-6'>
              Experience cutting-edge AI technology designed to streamline your
              immigration process with precision and speed.
            </p>
          </motion.div>
        </div>
      </section>
              ...
              >
                <Link href={tool.href} className='block'>
                  <div className='bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 h-full'>
                    {/* Compact Header */}
                    <div
                      className={`p-5 bg-gradient-to-r ${tool.color} text-white`}
                    >
        ...
        <div className='container mx-auto px-6 text-center'>
          ...
          >
            ...
            <p className='text-lg mb-6 text-purple-100'>
              Join thousands who've accelerated their immigration journey with
              AI.
            </p>
            <motion.button
