  ...
  const calculateScore = () => {
    ...
    setTimeout(() => {
      ...
      const educationPoints =
        educationLevels.find(e => e.value === formData.education)?.points || 0;
      ...
      totalPoints = Object.values(breakdown).reduce(
        (sum: number, points: unknown) => sum + (points as number),
        0
      );
      ...
      if (totalPoints >= 75) {
        ...
        recommendation =
          'You have an excellent chance of success! Your profile is very competitive.';
        nextSteps = [
        ...
        eligibility = 'good';
        recommendation =
          'You have a good chance of success with some improvements.';
        nextSteps = [
        ...
        recommendation =
          'Your profile needs significant improvement to be competitive.';
        nextSteps = [
        ...
        eligibility = 'low';
        recommendation =
          'Your current profile may face challenges. Consider major improvements.';
        nextSteps = [
            ...
            <div className='space-y-3'>
              {educationLevels.map(level => (
                <button
                  key={level.value}
                  onClick={() =>
                    setFormData({ ...formData, education: level.value })
                  }
              ...
              <div className='grid grid-cols-2 gap-4'>
                {[
                  ...
                  <button
                    key={option.label}
                    onClick={() =>
                      setFormData({ ...formData, jobOffer: option.value })
                    }
                    className={`p-4 rounded-xl border-2 transition-all duration-300 ${
        ...
        return (
          <div className='space-y-6'>
            <div className='text-center'>
              ...
              <p className='text-slate-300'>
                What language test have you taken?
              </p>
            </div>
            <div className='space-y-3'>
              {languageTests.map(test => (
                <button
                  key={test.value}
                  onClick={() =>
                    setFormData({ ...formData, language: test.value })
                  }
                  className={`w-full p-4 rounded-xl border-2 transition-all duration-300 flex justify-between items-center ${
          ...
          <div className='space-y-6'>
            ...
            <div>
              <label className='block mb-3 font-medium text-white'>
                ...
                {formData.language &&
                  ` / ${languageTests.find(t => t.value === formData.language)?.maxScore}`}
              </label>
              <input
                type='range'
                min='0'
                max={
                  languageTests.find(t => t.value === formData.language)
                    ?.maxScore || 100
                }
                ...
                onChange={e =>
                  setFormData({
                    ...formData,
                    languageScore: parseInt(e.target.value),
                  })
                }
                className='w-full h-2 rounded-lg appearance-none cursor-pointer bg-white/20 slider'
              />
        ...
        return (
          <div className='space-y-6'>
            <div className='text-center'>
              ...
              <p className='text-slate-300'>
                Which country are you planning to migrate to?
              </p>
            </div>
            <div className='space-y-3'>
        ...
        return (
          <div className='space-y-6'>
            <div className='text-center'>
              ...
              <p className='text-slate-300'>
                How much funds do you have available? (USD)
              </p>
            </div>
            <div>
              <label className='block mb-3 font-medium text-white'>
                Amount: ${formData.funds.toLocaleString()}
              </label>
              <input
                type='range'
                min='0'
                ...
                onChange={e =>
                  setFormData({ ...formData, funds: parseInt(e.target.value) })
                }
                className='w-full h-2 rounded-lg appearance-none cursor-pointer bg-white/20 slider'
              />
              <div className='flex justify-between mt-2 text-sm text-slate-400'>
          ...
          <div className='container max-w-4xl mx-auto'>
            ...
            >
              ...
              <div className='mb-8 text-center'>
                ...
                <div
                  className={`inline-block px-6 py-3 rounded-full border-2 ${getEligibilityColor(result.eligibility)}`}
                >
                  <span className='font-semibold capitalize'>
                    {result.eligibility} Chances
                  </span>
                </div>
        ...
        <div className='container max-w-4xl mx-auto text-center'>
          ...
          >
            ...
            <p className='max-w-3xl mx-auto text-xl leading-relaxed text-slate-300'>
              Get an instant assessment of your immigration eligibility with our
              AI-powered calculator. Receive personalized recommendations to
