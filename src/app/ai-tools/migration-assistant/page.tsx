  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      ...
      type: 'ai',
      message:
        "Hi! I'm VANHSYA's AI Migration Assistant. I can help you with visa requirements, eligibility assessment, document preparation, and migration planning. What would you like to know?",
      timestamp: new Date(),
    },
  ]);
  ...
  const features = [
    {
      ...
      description:
        'Advanced algorithms analyze your profile and provide personalized recommendations',
    },
    {
      icon: Globe,
    ...
    },
    {
      ...
      description:
        'Monitor your application progress with intelligent insights',
    },
  ];
        ...
        <div className='container mx-auto max-w-4xl text-center'>
          ...
          >
            ...
            <p className='text-xl text-slate-300 leading-relaxed max-w-3xl mx-auto'>
              Get instant, AI-powered guidance for your immigration journey. Our
              intelligent assistant provides personalized advice, document
              requirements, and step-by-step planning.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          >
            <div className='text-center mb-8'>
              ...
              <p className='text-slate-300'>
                Ask about visa requirements, eligibility, documents, or any
            ...
            <div className='grid grid-cols-2 md:grid-cols-4 gap-4 mb-8'>
              {quickActions.map((action, index) => (
                <motion.button
                  ...
                  onClick={() =>
                    setInputMessage(
                      `Tell me about ${action.text.toLowerCase()}`
                    )
                  }
        ...
        <div className='container mx-auto max-w-4xl text-center'>
          ...
          >
            ...
            <p className='text-xl text-slate-300 mb-8'>
              Get personalized guidance from our AI assistant and take the first
