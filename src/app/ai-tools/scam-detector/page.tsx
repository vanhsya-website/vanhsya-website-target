...
const commonScams = [
  {
    ...
    prevention:
      'Always verify the company independently and never pay for job opportunities',
  },
  {
    ...
    prevention:
      'Only work with licensed immigration professionals and government agencies',
  },
  {
  ...
  },
  {
    ...
    prevention:
      'Check official government databases for accredited institutions',
  },
];

export default function ScamDetector() {
  const [activeTab, setActiveTab] = useState<
    'url' | 'email' | 'phone' | 'document'
  >('url');
  ...
  const generateMockAlerts = (): ScamAlert[] => {
    ...
    if (Math.random() > 0.5) {
      alerts.push({
        ...
        description:
          'This domain was registered recently and lacks established credibility',
        indicators: [
          'Domain registered less than 6 months ago',
          'No WHOIS information',
          'Hosted on shared servers',
        ],
        action:
          'Proceed with extreme caution and verify through alternative channels',
      });
    }
    ...
    if (Math.random() > 0.7) {
      alerts.push({
        ...
        description:
          'This communication matches patterns of known immigration scams',
        indicators: [
        ...
        <div className='container-max'>
          ...
          >
            ...
            <h1 className='heading-xl text-gray-800 mb-6'>
              Immigration Scam{' '}
              <span className='text-gradient-cyan'>Detector</span>
            </h1>
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              Protect yourself from immigration fraud with our AI-powered scam
              detection. Analyze websites, emails, phone numbers, and documents
                ...
                <div className='flex flex-wrap gap-2 mb-6'>
                  {[
                    ...
                    <button
                      ...
                      onClick={() =>
                        setActiveTab(
                          tab.id as 'url' | 'email' | 'phone' | 'document'
                        )
                      }
                  ...
                  {activeTab === 'document' ? (
                    <div className='border-2 border-dashed border-gray-300 rounded-lg p-8 text-center'>
                      ...
                      <p className='text-gray-600 mb-4'>
                        Upload a document to analyze for authenticity
                      </p>
                ...
                >
                  ...
                  <div className='flex items-center justify-between mb-6 p-4 bg-gray-50 rounded-lg'>
                    ...
                    <div className='text-right'>
                      ...
                      <div
                        className={`px-3 py-1 rounded-full text-sm font-semibold ${getRiskColor(report.risk)}`}
                      >
            ...
            <div className='space-y-6'>
              ...
              >
                ...
                <p className='text-sm text-gray-600 mb-4'>
                  Help protect others by reporting immigration scams you
                  encounter.
                </p>
