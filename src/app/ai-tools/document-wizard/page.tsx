...
export default function DocumentWizard() {
  ...
  const getCompletionStatus = () => {
    ...
    const totalItems =
      checklist.category.required.length + checklist.category.optional.length;
          ...
          <div className='container-max'>
            ...
            >
              ...
              <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
                Get personalized document checklists for your immigration
                application. Our AI ensures you have everything needed for a
              ...
              <div className='grid md:grid-cols-3 gap-6 mt-8'>
                <div className='text-center'>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Never miss a required document with our comprehensive,
                ...
                <div className='text-center'>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Securely upload and organize all your documents in one place
                  </p>
                </div>
                <div className='text-center'>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Get insider tips and best practices for each document type
                  </p>
                </div>
              </div>
            </motion.div>
        ...
        <div className='container-max'>
          ...
          >
            ...
            <div className='flex items-center gap-4 text-sm text-gray-600'>
              ...
              <span>•</span>
              <span>
                {checklist.category.required.length} required documents
              </span>
              <span>•</span>
              <span>
                {checklist.category.optional.length} optional documents
              </span>
            </div>
          </motion.div>
                ...
                <div className='space-y-3'>
                  <div className='flex justify-between text-sm'>
                    ...
                    <span className='font-semibold text-green-600'>
                      {
                        checklist.category.required.filter(item =>
                          checklist.checkedItems.has(item)
                        ).length
                      }
                      /{checklist.category.required.length}
                    </span>
                  </div>
                  <div className='flex justify-between text-sm'>
                    ...
                    <span className='font-semibold text-blue-600'>
                      {
                        checklist.category.optional.filter(item =>
                          checklist.checkedItems.has(item)
                        ).length
                      }
                      /{checklist.category.optional.length}
                    </span>
                  </div>
                  <div className='flex justify-between text-sm'>
