...
import { MessageSquare, Send, User, Bot, Sparkles, Brain, FileText, Calculator, Globe, ArrowRight } from 'lucide-react';
...
const ChatbotPage: React.FC = () => {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      type: 'bot',
      content: "Hello! I'm VANHSYA's AI Immigration Assistant. I'm here to help you with visa requirements, eligibility questions, document preparation, and more. How can I assist you today?",
      timestamp: new Date(),
      suggestions: [
  ...
  const generateBotResponse = (userInput: string): Message => {
    ...
    } else if (input.includes('eligibility') || input.includes('qualify') || input.includes('score')) {
        ...
        <div className="container mx-auto max-w-4xl text-center">
          ...
          >
            ...
            <p className="text-xl text-slate-300 leading-relaxed max-w-3xl mx-auto">
              Get instant answers to your immigration questions. Our AI assistant is trained on 
              the latest immigration policies and can help with eligibility, documents, and more.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          >
            ...
            <div className="bg-gradient-to-r from-purple-600/20 to-blue-600/20 border-b border-white/10 p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-white font-semibold">VANHSYA AI Assistant</h3>
            ...
            <div className="border-t border-white/10 p-6">
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                {countries.map((country) => (
                  <button
                    key={country.code}
                    onClick={() => handleSuggestionClick(`Tell me about ${country.name} immigration`)}
        ...
        <div className="container mx-auto max-w-4xl text-center">
          ...
          >
            ...
            <p className="text-xl text-slate-300 mb-8">
              While our AI assistant provides instant help, sometimes you need expert human guidance for complex cases.
            </p>
