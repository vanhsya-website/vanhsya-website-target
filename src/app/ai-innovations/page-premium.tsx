...
const aiFeatures = [
  {
    ...
    category: 'Processing',
    type: 'analysis',
    description: 'Advanced AI technology that analyzes immigration documents with 99.7% accuracy, ensuring compliance and detecting potential issues.',
  ...
  },
  {
    ...
    category: 'Assessment',
    type: 'calculation',
    description: 'AI-powered eligibility assessment that evaluates your immigration prospects across 50+ countries with personalized recommendations.',
  ...
  },
  {
    ...
    category: 'Support',
    type: 'communication',
    description: 'Advanced AI chatbot providing 24/7 immigration consultation with human-like understanding and expert-level responses.',
  ...
  },
  {
    ...
    category: 'Analytics',
    type: 'prediction',
    description: 'Machine learning model that predicts immigration success rates based on historical data and current immigration trends.',
  ...
  },
  {
    ...
    category: 'Security',
    type: 'verification',
    description: 'Blockchain-based document verification system ensuring tamper-proof authentication and global recognition.',
...
const aiTechnologies = [
  {
    ...
    icon: MessageSquare,
    applications: ['Document Analysis', 'Chatbot Responses', 'Translation', 'Content Generation'],
    accuracy: '98.7%'
  },
  {
    ...
    icon: Eye,
    applications: ['Document Scanning', 'ID Verification', 'Photo Analysis', 'Signature Detection'],
    accuracy: '99.3%'
  },
  {
    ...
    icon: Cpu,
    applications: ['Success Prediction', 'Risk Assessment', 'Trend Analysis', 'Optimization'],
    accuracy: '96.8%'
  },
  {
    name: 'Deep Learning',
    ...
    icon: Network,
    applications: ['Complex Decision Making', 'Pattern Recognition', 'Anomaly Detection', 'Automation'],
    accuracy: '97.5%'
  },
  {
    name: 'Blockchain Verification',
    ...
    icon: Shield,
    applications: ['Document Authentication', 'Identity Verification', 'Fraud Prevention', 'Audit Trails'],
    accuracy: '99.9%'
  },
  {
    ...
    icon: Bot,
    applications: ['Application Processing', 'Data Entry', 'Status Updates', 'Communication'],
    accuracy: '99.1%'
  }
];
    ...
    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-bold text-white hidden sm:block">AI Innovations</h1>
            </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 relative z-10">{/* Reduced pt from 32 to 20 to account for new nav */}
        ...
        <div className="text-center max-w-5xl mx-auto mb-16">
          ...
          >
            Experience revolutionary AI innovations that transform immigration processes. From document analysis 
            to success prediction - our cutting-edge technology delivers unprecedented accuracy and speed.
          </motion.p>
          ...
          >
            {[
              { label: 'AI Accuracy', value: '99.7%', icon: Target, color: 'text-green-400' },
              { label: 'Processing Speed', value: '0.3s', icon: Zap, color: 'text-blue-400' },
              { label: 'Total Users', value: '2.5M+', icon: Brain, color: 'text-purple-400' },
              { label: 'Success Rate', value: '96.8%', icon: Trophy, color: 'text-amber-400' }
            ].map((stat, index) => (
              <motion.div
                key={stat.label}
                initial={{ scale: 0 }}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {activeTab === 'overview' && (
            ...
            >
              ...
              <div className="bg-gradient-to-br from-neutral-900/80 to-neutral-900/40 backdrop-blur-xl border border-neutral-800/50 rounded-3xl p-8">
                <h2 className="text-3xl font-bold text-white mb-8 text-center">AI Innovation Dashboard</h2>
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {Object.entries(aiInnovationStats).map(([key, value]) => (
                    <div key={key} className="bg-neutral-800/30 rounded-xl p-4 text-center">
              ...
              {/* AI Technologies */}
              <div className="bg-gradient-to-br from-neutral-900/80 to-neutral-900/40 backdrop-blur-xl border border-neutral-800/50 rounded-3xl p-8">
                <h2 className="text-3xl font-bold text-white mb-8 text-center">Core AI Technologies</h2>
                    ...
                    >
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-neutral-400 text-sm">Accuracy: {tech.accuracy}</p>
                        </div>
                      </div>
              ...
              <div className="grid lg:grid-cols-5 gap-4 mb-8">
                {aiFeatures.map((feature) => (
                  ...
                  >
                    ...
                    <div className="text-sm font-semibold text-center">{feature.name}</div>
                    <div className="text-xs text-neutral-400 text-center mt-1">{feature.category}</div>
                  </motion.button>
                ))}
              </div>
                ...
                <div className="grid lg:grid-cols-2 gap-8">
                  ...
                  <div>
                    <div className="flex items-center gap-4 mb-6">
                      <div className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${selectedFeature.color} flex items-center justify-center`}>
                        <selectedFeature.icon className="w-8 h-8 text-white" />
                      </div>
                      <div>
                        <h3 className="text-2xl font-bold text-white">{selectedFeature.name}</h3>
                        <div className="text-blue-400 font-medium">{selectedFeature.category} AI</div>
                      </div>
                    </div>

                    <p className="text-neutral-300 mb-6 leading-relaxed">{selectedFeature.description}</p>

                    {/* Key Stats */}
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div className="bg-neutral-800/30 rounded-xl p-4">
                        <div className="text-green-400 font-semibold text-lg">{selectedFeature.accuracyRate}%</div>
                        <div className="text-xs text-neutral-400">Accuracy Rate</div>
                      </div>
                      <div className="bg-neutral-800/30 rounded-xl p-4">
                        <div className="text-blue-400 font-semibold text-lg">{selectedFeature.processingTime}</div>
                        <div className="text-xs text-neutral-400">Processing Speed</div>
                      </div>
                      <div className="bg-neutral-800/30 rounded-xl p-4">
                        <div className="text-purple-400 font-semibold text-lg">{formatPrice(selectedFeature.basePrice)}</div>
                      ...
                      <div className="bg-neutral-800/30 rounded-xl p-4">
                        ...
                        <div className="text-xs text-neutral-400">Flexible Payment</div>
                      </div>
                    </div>
          ...
          {activeTab === 'technology' && (
            ...
            >
              <h2 className="text-3xl font-bold text-white mb-8 text-center">Advanced AI Technology Stack</h2>
                  ...
                  >
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <div className="text-green-400 font-semibold">Accuracy: {tech.accuracy}</div>
                      </div>
                    </div>
                    <p className="text-neutral-300 mb-4">{tech.description}</p>
          ...
          {activeTab === 'referrals' && (
            ...
            >
              <div className="bg-gradient-to-br from-neutral-900/80 to-neutral-900/40 backdrop-blur-xl border border-neutral-800/50 rounded-3xl p-8">
                <h2 className="text-3xl font-bold text-white mb-8 text-center">AI Innovation Rewards</h2>
            ...
            >
              <div className="bg-gradient-to-br from-neutral-900/80 to-neutral-900/40 backdrop-blur-xl border border-neutral-800/50 rounded-3xl p-8">
                ...
                <div className="mt-8 p-6 bg-gradient-to-r from-blue-600/10 to-purple-600/10 border border-blue-500/20 rounded-xl text-center">
                  <h3 className="text-xl font-bold text-white mb-2">How to Enter AI Draws?</h3>
                  <p className="text-neutral-300 mb-4">
                    Use our AI features, refer friends, or subscribe to premium services to earn entries!
                  </p>
                  <div className="flex justify-center gap-4">
                    <div className="text-center">
                      <div className="text-2xl font-bold text-blue-400">1 Entry</div>
                      <div className="text-xs text-neutral-400">Per AI Feature Use</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-purple-400">10 Entries</div>
                      <div className="text-xs text-neutral-400">Per AI Referral</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-amber-400">25 Entries</div>
                      <div className="text-xs text-neutral-400">Premium Subscription</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {activeTab === 'pricing' && (
            ...
            >
              <div className="bg-gradient-to-br from-neutral-900/80 to-neutral-900/40 backdrop-blur-xl border border-neutral-800/50 rounded-3xl p-8">
                <h2 className="text-3xl font-bold text-white mb-8 text-center">AI Innovation Pricing</h2>
        ...
        >
          <div className="bg-gradient-to-r from-blue-600/10 to-purple-600/10 backdrop-blur-xl border border-blue-500/20 rounded-3xl p-12 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-neutral-300 mb-8">
              Join 2.5M+ users leveraging cutting-edge AI technology for immigration success. 
              Start your AI-powered journey today with exclusive rewards and flexible pricing.
            </p>
