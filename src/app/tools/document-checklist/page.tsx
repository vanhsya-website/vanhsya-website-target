...
const DocumentChecklistGenerator: React.FC = () => {
  ...
  const generateChecklist = () => {
    ...
    const baseDocuments: DocumentRequirement[] = [
      ...
      },
      {
        ...
        description:
          'Recent passport-style photographs meeting specific requirements',
        required: true,
        category: 'personal',
      ...
      },
      {
        ...
        alternatives: [
          ...
          'Baptismal certificate (if no birth certificate available)',
        ],
      },
    ];
      ...
      documents.push(
        {
          ...
          description:
            'Letters from all employers detailing job duties and salary',
          required: true,
          category: 'work',
    ...
    if (config.familySize > 1) {
      documents.push(
        ...
        },
        {
          ...
          description:
            'All required documents for spouse (passport, education, etc.)',
          required: true,
          category: 'family',
    ...
    documents.push(
      ...
      },
      {
        ...
        description:
          'Fixed deposits, property documents, investment certificates',
        required: false,
        category: 'financial',
  ...
  const getProgressPercentage = () => {
    ...
    const checkedRequired = requiredDocuments.filter(doc =>
      checkedItems.has(doc.id)
    );
    return requiredDocuments.length > 0
      ? Math.round((checkedRequired.length / requiredDocuments.length) * 100)
      : 0;
  };
        ...
        <div className='pt-20 pb-16'>
          <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'>
            ...
            <div className='text-center mb-12'>
              ...
              >
                Generate a personalized document checklist based on your
                destination country and visa type. Never miss a required
                document again.
              </motion.p>
            </div>
                ...
                {config.country && (
                  <div>
                    ...
                    >
                      ...
                      {(visaTypes as any)[config.country]?.map((visa: any) => (
                    ...
                    <div className='flex items-center'>
                      <input
                        ...
                        onChange={e =>
                          setConfig(prev => ({
                            ...prev,
                            hasPreviousTravel: e.target.checked,
                          }))
                        }
                        className='h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded'
                      />
                      <label
                        htmlFor='hasPreviousTravel'
                        className='ml-2 text-sm text-gray-700 dark:text-gray-300'
                      >
  ...
  const categorizedDocuments = categories
    .map(category => ({
      category,
        ...
        <div className='max-w-6xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <div className='text-center mb-8'>
            ...
            >
              ...
              {countries.find(c => c.code === config.country)?.name}
            </motion.h1>
            ...
            >
              {
                (visaTypes as any)[config.country]?.find(
                  (v: any) => v.code === config.visaType
                )?.name
              }
            </motion.p>
            ...
            >
              ...
              <div className='flex justify-between text-sm text-gray-600 dark:text-gray-400 mt-2'>
                <span>
                  {
                    checklist.filter(
                      doc => doc.required && checkedItems.has(doc.id)
                    ).length
                  }{' '}
                  completed
                </span>
                <span>
                  {checklist.filter(doc => doc.required).length} required
                </span>
              </div>
            </motion.div>
            ...
            <div className='flex items-start space-x-3'>
              ...
              <div>
                ...
                <p className='text-yellow-700 dark:text-yellow-300 text-sm'>
                  This checklist is based on general requirements and may not
                  include all specific requirements for your case. Always
                  consult the official government website or immigration lawyer
                  for the most up-to-date and personalized requirements.
