...
const ToolsPage: React.FC = () => {
  const tools: Tool[] = [
    {
      ...
      description:
        'Comprehensive assessment tool to evaluate your eligibility for multiple countries including Canada, Australia, USA, UK, and Germany.',
    ...
    },
    {
      ...
      description:
        'Generate a personalized checklist of required documents based on your destination country and visa type.',
    ...
    },
    {
      ...
      description:
        'Track current processing times and get real-time updates for different visa categories and countries.',
    ...
    },
    {
      ...
      description:
        'Calculate total costs including government fees, legal fees, language tests, and living expenses.',
    ...
    },
    {
      ...
      description:
        "Calculate your Comprehensive Ranking System (CRS) score for Canada's Express Entry system.",
    ...
    },
    {
      ...
      description:
        'Plan your language testing strategy with test comparisons, preparation timelines, and score requirements.',
    ...
    },
    {
      ...
      description:
        'Compare different visa pathways side-by-side to find the best option for your specific situation.',
    ...
    },
    {
      ...
      description:
        'Track your immigration application status and get insights into processing stages and next steps.',
  ...
  const categories = [
    ...
    },
    {
      id: 'calculation',
      label: 'Calculation',
      count: tools.filter(t => t.category === 'calculation').length,
    },
    {
      id: 'tracking',
      label: 'Tracking',
      count: tools.filter(t => t.category === 'tracking').length,
    },
  ];
      ...
      <div className='pt-20 pb-16'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <div className='text-center mb-16'>
            ...
            >
              Comprehensive suite of tools to help you plan, calculate, and
              track your immigration journey. Get accurate assessments and
              personalized recommendations.
            </motion.p>
                ...
                <Link href={tool.href} className='block'>
                  <div className='bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 h-full transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border border-gray-200 dark:border-gray-700'>
                    ...
                    <div className='flex items-start justify-between mb-4'>
                      ...
                      <span
                        className={`px-2 py-1 text-xs font-medium rounded-full ${getDifficultyColor(tool.difficulty)}`}
                      >
                        {tool.difficulty}
                      </span>
                    </div>
          ...
          >
            <div className='bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-8 text-white'>
              ...
              <p className='text-blue-100 mb-6 max-w-2xl mx-auto'>
                While our tools provide excellent guidance, every immigration
                case is unique. Book a consultation with our experts for
                personalized advice.
              </p>
