...
const EligibilityCalculator: React.FC = () => {
  ...
  const calculateCanadaScore = (): CountryScore => {
    ...
    if (formData.englishLevel === 'none' || formData.englishLevel === 'basic') {
      requirements.push(
        'Improve English language skills (minimum CLB 7 required)'
      );
    }
    ...
    if (formData.funds < 13000) {
      requirements.push(
        'Show proof of funds (minimum CAD $13,000 for single applicant)'
      );
    }
  ...
  const calculateAustraliaScore = (): CountryScore => {
    ...
    return {
      ...
      recommendations: [
        ...recommendations,
        'Consider regional migration for additional points',
      ],
  ...
  const calculateUSAScore = (): CountryScore => {
    ...
    return {
      ...
      recommendations: [
        ...recommendations,
        'Consider L-1 visa if employed by multinational company',
      ],
  ...
  const calculateUKScore = (): CountryScore => {
    ...
    if (
      ...
      requirements.push(
        'English language proficiency required (B2 level minimum)'
      );
    ...
    return {
      ...
      requirements: [
        ...requirements,
        'Minimum salary threshold (typically £26,200)',
      ],
      recommendations: [
        ...recommendations,
        'Consider shortage occupation list for easier qualification',
      ],
  ...
  const calculateGermanyScore = (): CountryScore => {
    ...
    if (formData.secondLanguage === 'German') {
      if (
        formData.secondLanguageLevel === 'advanced' ||
        formData.secondLanguageLevel === 'native'
      )
        score += 25;
    ...
    return {
      ...
      recommendations: [
        ...recommendations,
        'Consider obtaining German language certification',
      ],
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    updateFormData('currentCountry', e.target.value)
                  }
                  className='w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent'
          ...
          <div className='space-y-6'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    updateFormData('workExperience', parseInt(e.target.value))
                  }
                  className='w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent'
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    updateFormData('currentOccupation', e.target.value)
                  }
                  className='w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent'
            ...
            <div className='flex items-center space-x-3'>
              <input
                ...
                onChange={e =>
                  updateFormData('skillsAssessment', e.target.checked)
                }
                className='h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded'
              />
              <label
                htmlFor='skillsAssessment'
                className='text-sm text-gray-700 dark:text-gray-300'
              >
                I have completed or am willing to complete skills
                assessment/credential evaluation
              </label>
            </div>
          </div>
        );
          ...
          <div className='space-y-6'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    updateFormData('secondLanguage', e.target.value)
                  }
                  className='w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent'
              ...
              <div className='md:col-span-2'>
                ...
                <select
                  ...
                  onChange={e =>
                    updateFormData('secondLanguageLevel', e.target.value)
                  }
                  className='w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent'
            ...
            <div className='bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg'>
              ...
              <p className='text-sm text-blue-700 dark:text-blue-300'>
                Most countries require standardized language test results
                (IELTS, TOEFL, PTE for English; TEF, DELF for French). Higher
                scores significantly improve your eligibility.
              </p>
            </div>
          </div>
        );
          ...
          <div className='space-y-6'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    updateFormData('funds', parseInt(e.target.value))
                  }
                  className='w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent'
              ...
              <div className='flex items-center space-x-3'>
                <input
                  ...
                  onChange={e =>
                    updateFormData('provincialNomination', e.target.checked)
                  }
                  className='h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded'
                />
                <label
              ...
              <div className='flex items-center space-x-3'>
                <input
                  ...
                  onChange={e =>
                    updateFormData('relativesInDestination', e.target.checked)
                  }
                  className='h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded'
                />
                <label
                  htmlFor='relativesInDestination'
                  className='text-sm text-gray-700 dark:text-gray-300'
                >
            ...
            <div className='bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg'>
              ...
              <p className='text-sm text-yellow-700 dark:text-yellow-300'>
                Each country has different minimum fund requirements. Having
                more funds available shows financial stability and can improve
          ...
          <div className='space-y-6'>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                <div>
                  ...
                  <select
                    ...
                    onChange={e =>
                      updateFormData('spouseEducation', e.target.value)
                    }
                    className='w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent'
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={e =>
                      updateFormData('spouseLanguage', e.target.value)
                    }
                    className='w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent'
                  >
                    <option value='none'>No English</option>
            ...
            <div className='bg-green-50 dark:bg-green-900/20 p-4 rounded-lg'>
              ...
              <p className='text-sm text-green-700 dark:text-green-300'>
                Click "Calculate Eligibility" to see your eligibility scores for
                different countries and get personalized recommendations for
      ...
      <div className='pt-20 pb-16'>
        <div className='max-w-6xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <div className='text-center mb-12'>
            ...
            >
              Get instant eligibility assessment for multiple countries
              including Canada, Australia, USA, UK, and Germany. Our advanced
              calculator analyzes your profile and provides personalized
              recommendations.
            </motion.p>
          </div>
                ...
                >
                  ...
                  <div className='text-center'>
                    ...
                    <p className='text-gray-600 dark:text-gray-300 mb-8'>
                      Based on your profile, here's your eligibility assessment
                      ...
                      >
                        ...
                        <div className='grid grid-cols-2 gap-4 mb-4 text-sm'>
                          ...
                          <div>
                            ...
                            <span className='text-gray-600 dark:text-gray-400'>
                              Min. Investment: {result.minInvestment}
                            </span>
                          </div>
                        </div>
                          ...
                          <div className='border-t border-gray-200 dark:border-gray-700 pt-4'>
                            ...
                            <div className='text-sm'>
                              <div className='font-medium text-blue-600'>
                                {result.pathways[0].name}
                              </div>
                              <div className='text-gray-600 dark:text-gray-400'>
                                {result.pathways[0].description}
                              </div>
                              <div className='text-gray-500 text-xs mt-1'>
                                {result.pathways[0].timeframe} •{' '}
                                {result.pathways[0].difficulty} difficulty
                              </div>
                            </div>
                          </div>
                        )}
                  ...
                  <div className='text-center space-y-4'>
                    ...
                    <div className='mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg'>
                      <p className='text-sm text-blue-700 dark:text-blue-300'>
                        ...
                        estimates based on general program requirements. Actual
                        eligibility may vary. Consult with our immigration
                        experts for detailed assessment.
                      </p>
                    </div>
                  </div>
                </motion.div>
