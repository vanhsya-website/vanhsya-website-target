  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      type: 'bot',
      content:
        "Hello! I'm your Immigration Eligibility Assistant. I'll help you assess your eligibility for immigration programs. Let's start with a few questions.",
      timestamp: new Date(),
    },
  ]);
        ...
        <div className='container-max'>
          ...
          >
            <h1 className='heading-xl text-white mb-6'>
              AI Immigration{' '}
              <span className='text-gradient-cyan'>Eligibility Bot</span>
            </h1>
            <p className='text-xl text-white/90 max-w-3xl mx-auto leading-relaxed'>
              Get an instant assessment of your immigration eligibility with our
              intelligent chatbot. Answer a few questions and receive
          ...
          <div className='max-w-4xl mx-auto'>
            ...
            {eligibilityResult && (
              ...
              >
                {/* Score Card */}
                <div
                  className={`modern-card ${eligibilityResult.eligible ? 'card-green' : 'card-orange'}`}
                >
