        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Comprehensive immigration solutions designed to help you achieve your Canadian dreams. 
              Choose from our proven programs with exceptional success rates.
            </p>
          </motion.div>
              ...
              >
                <div className="flex justify-between items-start mb-6">
                  ...
                  <span className={`px-3 py-1 rounded-full text-sm font-semibold ${
                    ...
                    {program.category === 'permanent' ? 'Permanent' : 'Temporary'}
                  </span>
                </div>
                ...
                <div className="space-y-3 mb-6">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-gray-800">{program.processingTime}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Eligibility:</span>
                    <span className="font-semibold text-gray-800">{program.eligibilityScore}</span>
                  </div>
                </div>
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-blue-100 max-w-2xl mx-auto">
                Proven results across all our immigration programs with industry-leading success rates
              </p>
            </div>
            
            <div className="grid md:grid-cols-4 gap-6">
              {[
                { metric: "5,000+", label: "Successful Applications", icon: CheckCircle },
                { metric: "91%", label: "Average Success Rate", icon: TrendingUp },
          ...
          >
            ...
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
              Get personalized guidance from our immigration experts and choose the program 
