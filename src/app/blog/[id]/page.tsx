...
import { 
  ...
  BookOpen, ExternalLink, ChevronRight, Star,
  CheckCircle, Info, Globe, FileText, Lightbulb
} from 'lucide-react';
...
export default function BlogPostPage() {
  ...
  // Get category info
  const categoryInfo = migrationBlogCategories.find(cat => cat.id === post?.category);
  ...
  const getCategoryIcon = (categoryId: string) => {
    switch (categoryId) {
      case 'country-guides': return <Globe className="w-5 h-5" />;
      case 'visa-processes': return <FileText className="w-5 h-5" />;
      case 'success-stories': return <Star className="w-5 h-5" />;
      case 'policy-updates': return <Info className="w-5 h-5" />;
      case 'tips-advice': return <Lightbulb className="w-5 h-5" />;
          ...
          >
            ...
            {post.category === 'country-guides' && (
              <div className="space-y-8">
                <section>
                  ...
                  <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6">
                    <p className="text-gray-300 mb-4">
                      This comprehensive guide covers everything you need to know about immigration to this destination, 
                      including eligibility requirements, application processes, and timeline expectations.
                    </p>
                ...
                <section>
                  <h2 className="text-2xl font-bold text-white mb-4">Key Requirements</h2>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 border border-blue-400/20 rounded-2xl p-6">
                      <h3 className="text-lg font-semibold text-blue-300 mb-3">Education Requirements</h3>
                      <p className="text-gray-300 text-sm">
                        Minimum educational qualifications and credential assessment requirements.
                      </p>
                    </div>
                    <div className="bg-gradient-to-br from-green-500/10 to-blue-500/10 border border-green-400/20 rounded-2xl p-6">
                      <h3 className="text-lg font-semibold text-green-300 mb-3">Language Proficiency</h3>
                      <p className="text-gray-300 text-sm">
                        Required language test scores and acceptable testing agencies.
                      </p>
                    </div>
                    <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-400/20 rounded-2xl p-6">
                      <h3 className="text-lg font-semibold text-purple-300 mb-3">Work Experience</h3>
                      <p className="text-gray-300 text-sm">
                        Minimum years of skilled work experience in eligible occupations.
                      </p>
                    </div>
                    <div className="bg-gradient-to-br from-orange-500/10 to-red-500/10 border border-orange-400/20 rounded-2xl p-6">
                      <h3 className="text-lg font-semibold text-orange-300 mb-3">Financial Requirements</h3>
                      <p className="text-gray-300 text-sm">
            ...
            {post.category === 'visa-processes' && (
              <div className="space-y-8">
                <section>
                  <h2 className="text-2xl font-bold text-white mb-4">Step-by-Step Process</h2>
                  <div className="space-y-4">
                    {[1, 2, 3, 4, 5].map((step) => (
                      <div key={step} className="flex gap-4 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6">
                        ...
                        <div>
                          <h3 className="text-lg font-semibold text-white mb-2">Step {step}: Application Preparation</h3>
                          <p className="text-gray-300 text-sm">
                            Detailed explanation of this step in the visa application process, including required documents and timeline.
                          </p>
                        </div>
                      </div>
                    ))}
            ...
            {post.category === 'success-stories' && (
              <div className="space-y-8">
                <section>
                  <h2 className="text-2xl font-bold text-white mb-4">The Journey</h2>
                  <div className="bg-gradient-to-r from-green-500/10 to-blue-500/10 border border-green-400/20 rounded-2xl p-6">
                    <p className="text-gray-300 italic text-lg">
                      "This success story showcases the determination and strategic planning that led to a successful immigration outcome. 
                ...
                <section>
                  ...
                  <div className="grid gap-4">
                    {['Strategic Planning', 'Document Preparation', 'Timeline Management', 'Expert Guidance'].map((learning, index) => (
                      <div key={index} className="flex items-center gap-3 bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-4">
            ...
            <section className="mt-12">
              <h2 className="text-2xl font-bold text-white mb-6">Expert Tips & Recommendations</h2>
              <div className="bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-purple-400/20 rounded-2xl p-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="text-lg font-semibold text-purple-300 mb-3">Do's</h3>
                    <ul className="space-y-2">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-red-300 mb-3">Don'ts</h3>
                    <ul className="space-y-2">
                      <li className="flex items-center gap-2 text-gray-300 text-sm">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
              Get personalized guidance from our expert immigration consultants and turn your dreams into reality.
            </p>
