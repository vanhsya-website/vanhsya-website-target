...
const blogPosts = [
  {
    ...
    excerpt:
      "Everything you need to know about Canada's Express Entry system, including CRS score requirements, draw updates, and application tips.",
    ...
    featured: true,
    image:
      'https://images.unsplash.com/photo-1549692520-acc6669e2f0c?w=600&h=400&fit=crop',
  },
  {
    id: 2,
    title: 'Australia PR vs Canada PR: Which is Better?',
    excerpt:
      'Comprehensive comparison of permanent residency programs in Australia and Canada, including processing times, costs, and benefits.',
  ...
  },
  {
    ...
    excerpt:
      'Discover the most sought-after professions that can fast-track your immigration process to popular destinations.',
  ...
  },
  {
    ...
    excerpt:
      'Inspiring stories from students who successfully obtained visas and are now studying in their dream countries.',
  ...
  },
  {
    ...
    excerpt:
      "Step-by-step guide to applying for Germany's EU Blue Card, including eligibility requirements and processing timeline.",
  ...
  },
  {
    ...
    excerpt:
      'Learn about the most common mistakes applicants make during the immigration process and how to avoid them.',
    ...
    <div className='min-h-screen'>
        ...
        <div className='container-max'>
          ...
          >
            <h1 className='heading-xl text-white mb-6'>
              Immigration{' '}
              <span className='text-gradient-cyan'>Blog & Resources</span>
            </h1>
            <p className='text-xl text-white/90 max-w-3xl mx-auto leading-relaxed mb-8'>
              Stay updated with the latest immigration news, guides, tips, and
              success stories from our experts.
            </p>
      ...
      <section className='section-padding'>
        <div className='container-max'>
          ...
          >
            <h3 className='heading-md text-gradient mb-6 text-center'>
              Popular Topics
            </h3>
          ...
          >
            <div className='modern-card max-w-2xl mx-auto'>
              ...
              <p className='text-modern mb-6'>
                Get the latest immigration updates, tips, and guides delivered
