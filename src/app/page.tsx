...
const PremiumNavigation = dynamic(
  () => import('@/components/PremiumNavigation'),
  {
    ssr: false,
    loading: () => (
      <div className='h-20 bg-neutral-950/95 backdrop-blur-xl animate-pulse' />
    ),
  }
);
...
const InteractiveCountryExplorer = dynamic(
  () => import('@/components/InteractiveCountryExplorer'),
  {
    ssr: false,
    loading: () => (
      <div className='h-96 bg-gradient-to-b from-neutral-950 to-neutral-900 animate-pulse' />
    ),
  }
);

const SmoothAnimatedTimeline = dynamic(
  () => import('@/components/SmoothAnimatedTimeline'),
  {
    ssr: false,
    loading: () => (
      <div className='h-96 bg-gradient-to-b from-neutral-900 to-neutral-950 animate-pulse' />
...
const PremiumTestimonialsSection = dynamic(
  () => import('@/components/PremiumTestimonialsSection'),
  {
    ssr: false,
    loading: () => (
      <div className='h-96 bg-gradient-to-b from-neutral-950 to-neutral-900 animate-pulse' />
...
const PremiumLoadingSkeleton = ({ className = '' }: { className?: string }) => (
  <div
    className={`animate-pulse bg-gradient-to-r from-purple-600/20 via-indigo-600/10 to-cyan-600/20 rounded-lg ${className}`}
  />
);
