...
export default function ContactPage() {
  const [selectedConsultation, setSelectedConsultation] = useState('assessment');
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-24 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          >
            Connect with our certified immigration consultants for personalized guidance. 
            Available 24/7 with multilingual support and AI-powered insights.
          </motion.p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {contactMethods.map((method, index) => (
            ...
            >
              <div className={`absolute inset-0 rounded-2xl ${method.bgGlow} blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500`} />
              ...
              <div className="relative bg-gradient-to-br from-neutral-900/80 to-neutral-900/40 backdrop-blur-xl border border-neutral-800/50 rounded-2xl p-6 hover:border-neutral-700/50 transition-all duration-500">
                ...
                <div className="text-xs text-neutral-500 mb-4">{method.availability}</div>
                ...
                {consultationTypes.map((consultation) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        <h3 className="text-lg font-bold text-white">{consultation.title}</h3>
                        <div className="flex items-center gap-4 text-sm text-neutral-400 mt-1">
                          <span className="flex items-center gap-1">
                            <Clock className="w-3 h-3" />
                            {consultation.duration}
                          </span>
                          <span className="font-semibold text-green-400">{consultation.price}</span>
                        </div>
                      </div>
                    ...
                    <p className="text-neutral-300 mb-4">{consultation.description}</p>
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="text-3xl font-bold text-white text-center mb-12">Our Global Offices</h2>
        ...
        >
          <div className="bg-gradient-to-r from-purple-600/10 to-indigo-600/10 backdrop-blur-xl border border-purple-500/20 rounded-3xl p-12 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-neutral-300 mb-8">
              Take the first step towards your immigration goals with a free consultation from our experts.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
