  ...
  const teamMembers: TeamMember[] = [
    {
      ...
      certifications: [
        'RCIC',
        'ICCRC Member',
        'Canadian Immigration Law Certificate',
      ],
    },
    {
      id: 2,
        ...
        <div className='relative max-w-6xl mx-auto px-4 text-center'>
          ...
          >
            ...
            <p className='text-xl opacity-90 max-w-2xl mx-auto'>
              Dedicated professionals committed to making your immigration
              journey successful
            </p>
          </motion.div>
        </div>
      ...
      <div className='max-w-6xl mx-auto px-4 -mt-10 relative z-10'>
          ...
          {teamMembers.map((member, index) => (
            ...
            >
              ...
              >
                {/* Image */}
                <div
                  className={`relative h-96 lg:h-auto ${index % 2 === 1 ? 'lg:order-2' : ''}`}
                >
        ...
        >
          ...
          <p className='text-xl opacity-90 mb-6 max-w-2xl mx-auto'>
            Get personalized guidance from our expert team. Schedule a
          ...
          <div className='grid md:grid-cols-3 gap-8'>
            <div className='text-center'>
              ...
              <p className='text-gray-600'>
                All our consultants are RCIC certified and continuously update
                their knowledge with the latest immigration policies.
              </p>
            </div>
            <div className='text-center'>
              ...
              <p className='text-gray-600'>
                Every client gets dedicated attention with customized strategies
            ...
            <div className='text-center'>
              ...
              <p className='text-gray-600'>
                With multilingual capabilities and international experience, we
