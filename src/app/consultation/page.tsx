          ...
          <div className='space-y-6'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={e =>
                    updateFormData('preferredDestination', e.target.value)
                  }
                  className='w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent'
                  required
                >
            ...
            <div>
              ...
              <select
                ...
                onChange={e =>
                  updateFormData('immigrationGoal', e.target.value)
                }
                className='w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent'
                required
              >
              ...
              <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                {consultationTypes.map(type => (
                  <div
                    key={type.type}
                    onClick={() =>
                      updateFormData('consultationType', type.type)
                    }
          ...
          <div className='space-y-6'>
                  ...
                  <span className='font-medium'>
                    {
                      consultationTypes.find(
                        t => t.type === formData.consultationType
                      )?.name
                    }
                  </span>
                </div>
            ...
            <div className='flex items-start space-x-3'>
              ...
              >
                ...
                immigration opportunities. You can unsubscribe at any time.
              </label>
            </div>
          </div>
        );
        ...
        <div className='min-h-screen flex items-center justify-center py-12 px-4'>
          ...
          >
            ...
            <p className='text-gray-600 mb-6'>
              ...
              confirmation email shortly with the meeting details and
