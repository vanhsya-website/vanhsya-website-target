...
import { 
  Search, Filter, Download, ExternalLink, BookOpen, 
  FileText, Calculator, CheckSquare, Users,
  Star, Eye, ChevronDown, ChevronUp,
  Play, Bookmark, Share2, Calendar
} from 'lucide-react';
...
const resourceCategories = [
  ...
  { id: 'immigration-guides', name: 'Immigration Guides', icon: '🗺️', count: 12 },
  { id: 'document-checklists', name: 'Document Checklists', icon: '✅', count: 8 },
...
const featuredResources: Resource[] = [
  {
    ...
    description: 'Comprehensive 50-page guide covering all aspects of Canada Express Entry system including CRS calculator, document checklist, and timeline.',
    type: 'guide',
  ...
  },
  {
    ...
    description: 'Interactive calculator to determine your points for Australian skilled migration programs including 189, 190, and 491 visas.',
    type: 'calculator',
  ...
  },
  {
    ...
    description: 'Master checklist covering all essential documents for major immigration destinations with country-specific variations.',
    type: 'checklist',
...
const allResources: Resource[] = [
  ...featuredResources,
  {
    ...
    description: 'Comprehensive IELTS preparation guide with practice tests, tips, and strategies for achieving your target score.',
    type: 'guide',
    category: 'immigration-guides',
  ...
  },
  {
    ...
    description: 'Step-by-step video walkthrough of the Germany job seeker visa application process, requirements, and success tips.',
    type: 'video',
  ...
  },
  {
    ...
    description: 'Professional SOP templates for various visa categories including student, work, and permanent residence applications.',
    type: 'template',
    category: 'templates',
  ...
  const faqs = [
    {
      ...
      answer: 'Yes, all our basic immigration resources are completely free. Premium resources with advanced features may require a consultation booking.'
    },
    {
      question: 'How frequently are resources updated?',
      answer: 'We update our resources regularly to reflect the latest immigration policies and requirements. Critical updates are made within 48 hours of policy changes.'
    },
    {
      question: 'Can I request specific resources or tools?',
      answer: 'Absolutely! We welcome resource requests from our community. Contact us with your specific needs and we\'ll prioritize creating resources that help the most people.'
    },
    {
      question: 'Do these resources work for all countries?',
      answer: 'Many resources are country-specific, while others are universal. Each resource clearly indicates which countries or programs it covers.'
    }
  ];
      ...
      <section className="relative pt-32 pb-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            >
              Immigration
              <span className="bg-gradient-to-r from-green-400 via-blue-400 to-purple-400 bg-clip-text text-transparent"> Resources</span>
            </motion.h1>
            ...
            >
              Free guides, checklists, calculators, and tools to help you navigate your immigration journey successfully.
            </motion.p>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Link href={resource.downloadUrl || resource.externalUrl || '#'}>
                          <button className="flex items-center gap-2 bg-gradient-to-r from-green-600 to-blue-600 text-white px-4 py-2 rounded-lg font-medium hover:from-green-700 hover:to-blue-700 transition-all">
                            {resource.downloadUrl ? <Download size={16} /> : <ExternalLink size={16} />}
          ...
          >
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-2xl font-bold text-white">
                {selectedCategory === 'all' ? 'All Resources' : resourceCategories.find(cat => cat.id === selectedCategory)?.name}
              </h2>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Link href={resource.downloadUrl || resource.externalUrl || '#'}>
                          <button className="flex items-center gap-2 bg-gradient-to-r from-green-600 to-blue-600 text-white px-3 py-1.5 rounded-lg font-medium hover:from-green-700 hover:to-blue-700 transition-all text-sm">
                            {resource.downloadUrl ? <Download size={14} /> : <ExternalLink size={14} />}
                            {resource.downloadUrl ? 'Download' : 'Access'}
                          </button>
                        </Link>
                      </div>
          ...
          >
            <div className="bg-gradient-to-r from-green-600/20 to-blue-600/20 backdrop-blur-md border border-white/10 rounded-3xl p-8 md:p-12 text-center">
              ...
              <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
                While our resources provide comprehensive information, every immigration case is unique. Get personalized advice from our expert consultants.
              </p>
