...
const resources: Resource[] = [
  {
    ...
    description:
      'Comprehensive 50-page guide covering all aspects of the Express Entry system, including CRS scoring, provincial nominations, and application strategies.',
    type: 'guide',
    category: 'Canada',
  ...
  },
  {
    ...
    description:
      'Interactive calculator to determine your points score for Australian skilled visas. Includes all visa subclasses and detailed explanations.',
    type: 'calculator',
    category: 'Australia',
  ...
  },
  {
    ...
    description:
      'Generate personalized document checklists for any visa type and country. Covers over 200 different visa categories.',
    type: 'checklist',
    category: 'General',
  ...
  },
  {
    ...
    description:
      'Video series covering all major US immigration routes including family-based, employment-based, and investment-based options.',
    type: 'video',
    category: 'USA',
  ...
  },
  {
    ...
    description:
      'Live webinar recording discussing the latest UK immigration rules, new point-based system, and strategies for 2024.',
    type: 'webinar',
    category: 'UK',
  ...
  },
  {
    ...
    description:
      'Professional SOP templates for study visas with examples for different fields and countries. Includes writing guidelines.',
    type: 'template',
    category: 'Study Visa',
  ...
  },
  {
    ...
    description:
      'Everything you need to know about the EU Blue Card in Germany including salary requirements, application process, and benefits.',
    type: 'guide',
    category: 'Germany',
  ...
  },
  {
    ...
    description:
      'Real-time tracking tool for visa processing times across different countries and visa types. Updated weekly with official data.',
    type: 'calculator',
    category: 'General',
        ...
        <div className='container-max'>
          ...
          >
            ...
            <p className='text-xl md:text-2xl mb-8 text-purple-100'>
              Free guides, calculators, checklists, and tools to help you
        ...
        <div className='container-max'>
          ...
          >
            ...
            <p className='text-purple-100 mb-6 max-w-2xl mx-auto'>
              ...
              guides, calculators, and immigration updates.
            </p>
