...
export default function ResponsiveTestPage() {
  ...
  const devices: DeviceTest[] = [
    ...
    },
    {
      ...
      icon: Gamepad2,
      category: 'Gaming',
      description: 'PC gaming handheld',
    },
  ];
  ...
  const getBreakpointInfo = (width: number) => {
    if (width < 360)
      return { name: 'xs', color: 'red', description: 'Extra small' };
    if (width < 640)
      return { name: 'sm', color: 'orange', description: 'Small mobile' };
    if (width < 768)
      return { name: 'md', color: 'yellow', description: 'Large mobile' };
    if (width < 1024)
      return { name: 'lg', color: 'green', description: 'Tablet' };
    if (width < 1280)
      return { name: 'xl', color: 'blue', description: 'Small desktop' };
    if (width < 1536)
      return { name: '2xl', color: 'indigo', description: 'Large desktop' };
    if (width < 2560)
      return { name: '3xl', color: 'purple', description: 'Extra large' };
        ...
        <div className='max-w-7xl mx-auto'>
          ...
          <div className='text-center mb-12'>
            ...
            <p className='text-xl text-slate-300 max-w-3xl mx-auto'>
              Test our website's responsiveness across all devices. From
              smartwatches to 75" TVs, VANHSYA works perfectly everywhere.
            </p>
          </div>
          ...
          <div className='bg-white/10 backdrop-blur-xl rounded-2xl p-6 mb-8 border border-white/20'>
            <div className='grid md:grid-cols-3 gap-6'>
              ...
              <div className='text-center'>
                <div
                  className={`text-3xl font-bold text-${currentBreakpoint.color}-400`}
                >
              ...
              <div className='text-center'>
                <div className='text-3xl font-bold'>
                  {getDeviceCategory(viewportSize.width)}
                </div>
                ...
                {devices
                  ...
                  .map(device => (
                    ...
                    >
                      ...
                      <div
                        className={`mt-2 text-xs px-2 py-1 rounded bg-${getBreakpointInfo(device.width).color}-500/20 text-${getBreakpointInfo(device.width).color}-300 inline-block`}
                      >
            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-6'>
              {[
                ...
                },
                {
                  ...
                  description:
                    'Fluid text scaling from 14px to 72px across all devices',
                },
                {
                  icon: Tablet,
                  title: 'Adaptive Layouts',
                  description:
                    'Grid and flexbox layouts that adapt to any screen size',
                },
                {
                  icon: Tv,
                  title: 'TV Ready',
                  description:
                    'Optimized for large screens up to 75" TVs and beyond',
                },
              ].map((feature, index) => (
                <motion.div
                  key={index}
          ...
          <div className='mt-12 text-center'>
            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-6 text-left'>
              <div className='bg-white/5 rounded-xl p-6'>
                ...
                <p className='text-slate-300 text-sm'>
                  Resize your browser window to test different breakpoints. Use
                  browser dev tools to simulate specific device sizes.
                </p>
              </div>
              <div className='bg-white/5 rounded-xl p-6'>
                <h4 className='font-semibold text-lg mb-2'>📱 Mobile/Tablet</h4>
                <p className='text-slate-300 text-sm'>
                  Rotate your device between portrait and landscape. Test touch
                  interactions and swipe gestures throughout the site.
                </p>
              </div>
              <div className='bg-white/5 rounded-xl p-6'>
                <h4 className='font-semibold text-lg mb-2'>
                ...
                <p className='text-slate-300 text-sm'>
                  Access the site on your smart TV browser or connect a laptop
                  to a large display. Test navigation with remote or keyboard.
                </p>
              </div>
            </div>
          </div>
