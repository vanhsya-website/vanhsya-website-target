      ...
      const mockVouchers: Voucher[] = [
        {
          ...
          description:
            'Get 50% discount on any visa application processing fee. Valid for all countries.',
          value: '$250 OFF',
        ...
        },
        {
          ...
          description:
            'One-on-one consultation with our senior immigration expert. 90 minutes session.',
          value: '$150 VALUE',
        ...
        },
        {
          ...
          description:
            'Upgrade any standard service to premium with priority processing and dedicated support.',
          value: '$200 UPGRADE',
        ...
        },
        {
          ...
          description:
            'Credit towards any future VANHSYA service. Can be combined with other offers.',
          value: '$500 CREDIT',
  ...
  const confirmRedeem = () => {
    if (selectedVoucher) {
      setUserVouchers(prev =>
        prev.map(v =>
          v.id === selectedVoucher.id ? { ...v, isRedeemed: true } : v
        )
      );
      ...
      <div className='min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-purple-950 flex items-center justify-center'>
        ...
        >
          ...
          <p className='text-blue-100 text-lg'>
            Retrieving your lucky vouchers...
          </p>
      ...
      <div className='relative z-10 max-w-6xl mx-auto px-4'>
        ...
        >
          ...
          <p className='text-xl text-blue-100 max-w-2xl mx-auto leading-relaxed'>
            Congratulations! Here are your exclusive vouchers won through our
            lottery system. Use them to save on our premium immigration
            services.
          </p>
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12'>
          {userVouchers.map((voucher, index) => (
            ...
            >
              <div
                className={`bg-gradient-to-br ${getVoucherColor(voucher.type)} p-6 text-white relative`}
              >
                {/* Decorative Elements */}
                ...
                <div className='relative z-10'>
                  ...
                  <div className='bg-black/30 backdrop-blur-sm rounded-xl p-4 mb-4 border border-white/10'>
                    <p className='text-xs opacity-75 mb-2 uppercase tracking-wider'>
                      Voucher Code
                    </p>
                    <div className='flex items-center justify-between'>
                      <code className='font-mono text-sm bg-white/20 px-2 py-1 rounded'>
                        {voucher.code}
                      </code>
                      <motion.button
          ...
          <div className='grid md:grid-cols-3 gap-8'>
            <div className='text-center'>
              ...
              <p className='text-gray-600 text-sm'>
                Select the immigration service you want to apply for
              </p>
            </div>
            <div className='text-center'>
              ...
              <p className='text-gray-600 text-sm'>
                Enter your voucher code during checkout process
              </p>
            </div>
            <div className='text-center'>
              ...
              <p className='text-gray-600 text-sm'>
                Get instant discounts or premium upgrades
              </p>
            </div>
          </div>
        </motion.div>
          ...
          >
            ...
            >
              <div className='text-center mb-6'>
                <div
                  className={`w-16 h-16 bg-gradient-to-r ${getVoucherColor(selectedVoucher.type)} rounded-full flex items-center justify-center mx-auto mb-4`}
                >
