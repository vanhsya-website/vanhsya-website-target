      ...
      pages: [
        {
          name: 'Home',
          href: '/',
          description: 'Landing page with overview of all services',
        },
        {
          name: 'About Us',
          href: '/about',
        ...
        },
        {
          name: 'Why Choose Us',
          href: '/why-choose-us',
          description: 'Reasons to choose VANHSYA for immigration',
        },
        {
          name: 'Team',
          href: '/team',
          description: 'Meet our immigration experts and consultants',
        },
      ],
    },
    {
      ...
      pages: [
        {
          name: 'All Services',
          href: '/services',
          description: 'Complete overview of immigration services',
        },
        {
          name: 'Work Visa',
        ...
        },
        {
          ...
          description: 'Student visas and education permits',
        },
        {
          name: 'Tourist Visa',
          href: '/services/tourist-visa',
          description: 'Travel and tourism visa services',
        },
        {
          name: 'Family Visa',
        ...
        },
        {
          ...
          description: 'Business and investor visa programs',
        },
        {
          name: 'Permanent Residence',
          href: '/services/permanent-residence',
          description: 'PR and citizenship pathways',
        },
        {
          name: 'Flight Booking',
          href: '/services/flight-booking',
          description: 'Travel booking and accommodation',
        },
      ],
    },
    {
      ...
      pages: [
        {
          name: 'All Countries',
          href: '/countries',
          description: 'Overview of all destination countries',
        },
        {
          name: 'Canada',
          href: '/countries/canada',
          description: 'Immigration to Canada - Express Entry, PNP',
        },
        {
          name: 'Australia',
          href: '/countries/australia',
          description: 'Australian PR and skilled migration',
        },
        {
          name: 'USA',
          href: '/countries/usa',
          description: 'US visas and green card programs',
        },
        {
          name: 'United Kingdom',
          href: '/countries/uk',
          description: 'UK visas and settlement programs',
        },
        {
          name: 'Germany',
          href: '/countries/germany',
          description: 'German work permits and EU Blue Card',
        },
        {
          name: 'New Zealand',
          href: '/countries/new-zealand',
          description: 'New Zealand residence and work visas',
        },
        {
          name: 'UAE',
          href: '/countries/uae',
          description: 'UAE golden visa and residence permits',
        },
        {
          name: 'Singapore',
          href: '/countries/singapore',
          description: 'Singapore PR and employment passes',
        },
      ],
    },
    {
      ...
      pages: [
        {
          name: 'All AI Tools',
          href: '/ai-tools',
          description: 'Complete suite of AI immigration tools',
        },
        {
          name: 'AI Chatbot',
          href: '/ai-tools/chatbot',
          description: '24/7 AI immigration assistant',
        },
        {
          name: 'Eligibility Calculator',
          href: '/ai-tools/eligibility',
          description: 'Check your immigration eligibility',
        },
        {
        ...
        },
        {
          ...
          description: 'Personalized application checklists',
        },
        {
          name: 'Scam Detector',
          href: '/ai-tools/scam-detector',
          description: 'Protect against immigration fraud',
        },
        {
          name: 'Migration Assistant',
          href: '/ai-tools/migration-assistant',
          description: 'Complete migration planning tool',
        },
      ],
    },
    {
      ...
      pages: [
        {
          name: 'All Programs',
          href: '/programs',
          description: 'Overview of reward programs',
        },
        {
        ...
        },
        {
          name: 'Lucky Draw',
          href: '/lucky-draw',
          description: 'Monthly prize draws for clients',
        },
        {
          name: 'Lottery Voucher',
          href: '/lottery-voucher',
          description: 'Special lottery participation vouchers',
        },
        {
          name: 'AI Innovations',
          href: '/ai-innovations',
          description: 'Latest AI technology features',
        },
      ],
    },
    {
      ...
      pages: [
        {
          name: 'Blog',
          href: '/blog',
          description: 'Immigration news, tips, and guides',
        },
        {
          name: 'Resources',
          href: '/resources',
        ...
        },
        {
          name: 'Tools',
          href: '/tools',
          description: 'Various immigration calculation tools',
        },
      ],
    },
    {
      ...
      pages: [
        ...
        },
        {
          name: 'Consultation',
          href: '/consultation',
          description: 'Book a consultation with experts',
        },
        {
          name: 'Client Portal',
          href: '/portal',
          description: 'Secure client login and dashboard',
        },
        {
          name: 'Dashboard',
          href: '/dashboard',
        ...
        <div className='max-w-6xl mx-auto text-center'>
          ...
          >
            ...
            <p className='text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed'>
              ...
              From immigration services to AI tools, find everything you need
              for your global mobility journey.
            </p>
          </motion.div>
            ...
            {sections.map((section, sectionIndex) => (
              ...
              >
                <div className='flex items-center gap-4 mb-6'>
                  <div
                    className={`p-3 rounded-2xl ${section.color.split(' ')[0]} ${section.color.split(' ')[1]}`}
                  >
                    <section.icon
                      className={`w-6 h-6 ${section.color.split(' ')[2]}`}
                    />
                  </div>
                  <div>
        ...
        <div className='max-w-4xl mx-auto'>
          ...
          >
            ...
            <p className='text-xl mb-8 opacity-90 max-w-2xl mx-auto'>
              Ready to explore your options? Start with our most popular tools
              and services.
            </p>
