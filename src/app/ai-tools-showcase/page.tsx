...
const aiTools: AITool[] = [
  {
    ...
    description:
      'Get instant visa eligibility assessment for 50+ countries using advanced AI algorithms',
    icon: Calculator,
    category: 'assessment',
    features: [
  ...
  },
  {
    ...
    description:
      'AI-powered document preparation and verification system for immigration applications',
    icon: FileText,
    category: 'document',
    features: [
  ...
  },
  {
    ...
    description:
      '24/7 AI assistant trained on immigration laws and procedures for instant guidance',
    icon: MessageCircle,
    category: 'chat',
    features: [
  ...
  },
  {
    ...
    description:
      'Protect yourself from immigration scams with AI-powered verification technology',
    icon: Shield,
  ...
  },
  {
    ...
    description:
      'AI-driven personalized migration strategy with timeline and milestone tracking',
    icon: Target,
    category: 'planning',
    features: [
  ...
  },
  {
    ...
    name: 'AI Job Matcher',
    description:
      'Find the best immigration-friendly jobs based on your skills and target country',
    icon: TrendingUp,
    category: 'assessment',
    features: [
...
export default function AIToolsPage() {
  ...
  const totalUsers = aiTools.reduce((total, tool) => {
    const userCount =
      parseInt(tool.users.replace(/[^0-9]/g, '')) *
        ...
        <div className='max-w-7xl mx-auto text-center'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto mb-8'>
              ...
              migration journey. From eligibility assessment to document
              preparation, our AI tools make complex processes simple and
              accurate.
            </p>
            ...
            {filteredTools.map((tool, index) => (
              ...
              >
                ...
                <div className='flex items-start justify-between mb-4'>
                  ...
                  <div
                    className={`px-3 py-1 rounded-full text-xs font-medium border ${getPricingBadge(tool.pricing)}`}
                  >
                ...
                {tool.earnCredits && (
                  <div className='flex items-center gap-2 mb-4 p-3 bg-gradient-to-r from-green-500/20 to-blue-500/20 rounded-xl border border-green-500/30'>
                    ...
                    <span className='text-sm text-green-400 font-medium'>
                      Earn {formatPrice(tool.earnCredits)} credits for using
                      this tool!
                    </span>
                  </div>
                )}
          ...
          <div className='grid md:grid-cols-3 gap-8'>
            <div className='text-center'>
              ...
              <p className='text-gray-300'>
                Get instant results that would typically take hours or days of
            ...
            <div className='text-center'>
              ...
              <p className='text-gray-300'>
                Benefit from machine learning algorithms trained on thousands of
                successful migration cases.
              </p>
            </div>
            ...
            <div className='text-center'>
              ...
              <p className='text-gray-300'>
                Access comprehensive information for 50+ countries with
                real-time updates on immigration policies.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className='py-12 px-6'>
        <div className='max-w-4xl mx-auto text-center'>
          ...
          <p className='text-xl text-gray-300 mb-8'>
            Join thousands of successful migrants who trusted our AI tools for
            their journey.
          </p>
