...
const services: Service[] = [
  {
    ...
    description:
      'Complete Express Entry service with document preparation and application',
    successRate: '87%',
    emiPlans: [
      {
        id: 'emi-3',
  ...
  },
  {
    ...
    discountedPrice: 0, // Hidden pricing
    description:
      'Complete skilled visa service with skills assessment and application',
    successRate: '91%',
    emiPlans: [
      {
        id: 'emi-3-aus',
...
export default function EMIPaymentPage() {
  ...
  const [selectedEMI, setSelectedEMI] = useState<EMIPlan>(
    services[0].emiPlans[1]
  );
        ...
        <div className='max-w-7xl mx-auto text-center'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto mb-8'>
              Don't let budget constraints stop your migration dreams. Choose
              from flexible EMI plans starting as low as {formatPrice(179)}
              /month with instant approval and no credit checks required.
            </p>
              ...
              >
                ...
                <div className='text-center mb-6'>
                  ...
                  <div className='text-sm text-gray-400'>
                    for {plan.duration} months payment plan
                  </div>
                </div>
                ...
                <div className='space-y-3 mb-6'>
                  ...
                  <div className='text-center p-3 bg-green-500/20 rounded-xl border border-green-500/30'>
                    <span className='text-green-300 font-medium'>
                      Guaranteed Success Rate: {selectedService.successRate}
                    </span>
                  </div>
                </div>
              ...
              <div className='space-y-4'>
                ...
                <div className='space-y-3'>
                  ...
                  <div className='flex items-center gap-3'>
                    ...
                    <span className='text-gray-300'>
                      Start your process immediately
                    </span>
                  </div>
                  <div className='flex items-center gap-3'>
                  ...
                  <div className='flex items-center gap-3'>
                    ...
                    <span className='text-gray-300'>
                      Use wallet credits and referral earnings
                    </span>
                  </div>
                </div>
              </div>
          ...
          <div className='grid md:grid-cols-3 gap-6 mb-8'>
            <div className='bg-white/10 backdrop-blur-sm rounded-2xl p-6'>
              ...
              <p className='text-gray-300 text-sm'>
                Your payment data is encrypted and protected with the highest
                security standards.
              </p>
            </div>
            ...
            <div className='bg-white/10 backdrop-blur-sm rounded-2xl p-6'>
              ...
              <p className='text-gray-300 text-sm'>
                Transparent pricing with all fees clearly mentioned upfront. No
                surprises.
              </p>
            </div>
            ...
            <div className='bg-white/10 backdrop-blur-sm rounded-2xl p-6'>
              ...
              <p className='text-gray-300 text-sm'>
                Get approved for EMI instantly without credit checks or lengthy
                documentation.
              </p>
            </div>
          </div>
