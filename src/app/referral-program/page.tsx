...
import { 
  Gift, Users, TrendingUp, ArrowRight, Star, Target, Copy, Check,
  DollarSign, Crown, Award, Sparkles, Heart, Zap, Trophy
} from 'lucide-react';
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Share VANHSYA with friends and family. Get rewarded for every successful migration. 
            From discounts to completely FREE migration packages!
          </p>
        </motion.div>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-gradient-to-r from-purple-900/50 to-pink-900/50 backdrop-blur-xl rounded-3xl p-8 border border-purple-500/30">
              <div className="text-center mb-6">
                <h3 className="text-2xl font-bold text-white mb-2">Your Personal Referral Code</h3>
                <p className="text-slate-300">Share this code with friends to start earning rewards</p>
              </div>
              ...
              <div className="flex items-center justify-center space-x-4">
                <div className="flex-1 bg-slate-800/50 rounded-xl p-4 border border-slate-700">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-slate-400">Valid until Dec 2025</div>
                  </div>
                </div>
        ...
        >
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-white mb-4">Referral Tiers & Rewards</h2>
            <p className="text-xl text-slate-300">The more you refer, the bigger your rewards get!</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {referralTiers.map((tier, index) => (
              ...
              >
                <div className={`relative overflow-hidden rounded-3xl bg-gradient-to-br ${tier.color} p-1`}>
                  <div className="bg-slate-900/90 backdrop-blur-xl rounded-3xl p-6 h-full">
                    <div className="text-center mb-6">
                      <div className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br ${tier.color} mb-4`}>
                        <tier.icon className="w-8 h-8 text-white" />
                      </div>
                      <h3 className="text-2xl font-bold text-white mb-2">{tier.name}</h3>
                      <div className="text-sm text-slate-400 mb-3">{tier.referrals} Referrals</div>
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-300">Simple steps to start earning amazing rewards</p>
          </div>
            ...
            {[
              {
                ...
                description: "Share your unique referral code with friends, family, and colleagues who need migration services.",
                icon: Users,
              ...
              },
              {
                ...
                description: "When they use your code and book any VANHSYA service, you both get exclusive benefits.",
                icon: Sparkles,
              ...
              },
              {
                step: "3",
                title: "Earn Rewards",
                description: "Get instant rewards and climb tiers for bigger discounts. Even get FREE migration packages!",
                icon: Trophy,
              ...
              >
                <div className={`inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-r ${step.color} mb-6`}>
        ...
        >
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-slate-300 mb-8">
              Join thousands of VANHSYA ambassadors who have already earned amazing rewards. 
              Your migration could be completely FREE!
            </p>
