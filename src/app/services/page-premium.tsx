...
const services = [
  {
    ...
    description:
      'Fast-track your Canadian immigration through the federal Express Entry system with AI-powered profile optimization.',
    countries: ['Canada'],
  ...
  },
  {
    ...
    description:
      'Leverage provincial nominations to enhance your immigration prospects with targeted regional strategies.',
    countries: ['Canada'],
  ...
  },
  {
    ...
    description:
      'Secure work authorization in your target country with expert guidance on skills assessment and documentation.',
  ...
  },
  {
    ...
    description:
      'Pursue your educational dreams abroad with comprehensive student visa support and academic guidance.',
  ...
  },
  {
    ...
    description:
      'Reunite with your loved ones through family sponsorship programs with expert relationship documentation.',
  ...
  },
  {
    ...
    description:
      'Launch your business venture abroad with specialized investor and entrepreneur visa programs.',
    countries: ['Canada', 'Australia', 'UK', 'USA'],
    ...
    >
      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-24 relative z-10'>
        ...
        <div className='text-center max-w-4xl mx-auto mb-16'>
          ...
          >
            Comprehensive immigration solutions powered by AI technology and
            expert guidance. Choose from our range of specialized services
        ...
        <div className='grid lg:grid-cols-2 gap-8 mb-16'>
          {filteredServices.map((service, index) => (
            ...
            >
              <div
                className={`absolute inset-0 rounded-3xl ${service.bgGlow} blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
              />
        ...
        >
          <div className='bg-gradient-to-r from-purple-600/10 to-indigo-600/10 backdrop-blur-xl border border-purple-500/20 rounded-3xl p-12 max-w-4xl mx-auto'>
            ...
            <p className='text-xl text-neutral-300 mb-8'>
              Our immigration experts can create a personalized pathway tailored
