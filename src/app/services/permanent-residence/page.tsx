...
const prPrograms = [
  {
    ...
    color: 'red',
    description:
      'Multiple pathways to Canadian permanent residence with excellent social benefits',
  },
  {
    country: 'Australia',
    icon: FaMapMarkerAlt,
    ...
    color: 'orange',
    description:
      'Skilled migration programs leading to Australian citizenship eligibility',
  },
  {
    ...
    color: 'blue',
    description:
      'Employment and family-based green card pathways to US permanent residence',
  },
  {
    country: 'New Zealand',
    icon: FaMapMarkerAlt,
...
const benefits = [
  {
    ...
    description:
      'Permanent right to live, work, and study anywhere in the country without restrictions',
  },
  {
    icon: FaHeart,
    title: 'Healthcare Benefits',
    description:
      'Access to public healthcare systems and social services on par with citizens',
  },
  {
    icon: FaGraduationCap,
    title: 'Education Access',
    description:
      'Free or subsidized education for children and reduced fees for higher education',
  },
  {
    icon: FaShieldAlt,
    title: 'Social Security',
    description:
      'Eligibility for unemployment benefits, pensions, and other social safety nets',
  },
  {
    icon: FaGlobe,
    title: 'Travel Freedom',
    description:
      'Enhanced travel privileges and ability to sponsor family members for visas',
  },
  {
    icon: FaPassport,
...
const processSteps = [
  {
    ...
    description:
      'Comprehensive evaluation of your profile, points calculation, and pathway selection',
    timeframe: '1-2 weeks',
    icon: FaCalculator,
  },
  {
    ...
    description:
      'Gather and prepare all required documents, certificates, and supporting evidence',
    timeframe: '4-8 weeks',
    icon: FaFileAlt,
  },
  {
    ...
    description:
      'Complete professional skills assessment and language proficiency tests',
  ...
  },
  {
    ...
    description:
      'Submit complete application through official government portals',
    timeframe: '1-2 weeks',
    icon: FaBriefcase,
  },
  {
    ...
    description:
      'Government processing, background checks, and additional document requests',
  ...
  },
  {
    ...
    description:
      'Receive decision, complete landing procedures, and obtain PR status',
    timeframe: '2-4 weeks',
    icon: FaCheck,
  },
];
...
export default function PermanentResidencePage() {
  ...
  return (
    <div className='min-h-screen bg-white'>
      <BackNavigation currentPage='Permanent Residence' />
        ...
        <div className='relative container-max'>
          ...
          >
            ...
            <p className='text-xl md:text-2xl mb-8 text-green-100'>
              Secure your future with permanent residence status in your dream
              destination
            </p>
        ...
        <div className='container-max'>
          ...
          >
            ...
            <p className='text-gray-600 max-w-2xl mx-auto'>
              Permanent residence offers life-changing benefits for you and your
              family
            </p>
          </motion.div>
      ...
      <section className='section-padding'>
        <div className='container-max'>
          ...
          >
            ...
            <p className='text-gray-600 max-w-2xl mx-auto'>
              Choose from multiple pathways to permanent residence in top
              destinations
            </p>
          </motion.div>
      ...
      <section className='section-padding bg-gray-50'>
        <div className='container-max'>
          ...
          >
            ...
            <p className='text-gray-600 max-w-2xl mx-auto'>
              Our systematic approach ensures your permanent residence
              application success
            </p>
          </motion.div>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12'>
            ...
            >
              ...
              <p className='text-gray-600 mb-8'>
                While requirements vary by country and program, these are common
                criteria for permanent residence applications.
              </p>
              ...
              <div className='space-y-6'>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600 text-sm'>
                      Enhance your language scores, education credentials, and
                      work experience to increase your points.
                    </p>
                  </div>
                </div>
                ...
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600 text-sm'>
                      Start gathering documents early as some certificates can
                ...
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600 text-sm'>
                      Apply when you have maximum points and all documents are
                ...
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600 text-sm'>
                      Work with licensed consultants to navigate complex
      ...
      <section className='section-padding bg-gray-50'>
        <div className='container-max'>
          ...
          >
            ...
            <p className='text-gray-600 max-w-2xl mx-auto'>
              Choose the level of support that best fits your permanent
              residence journey
            </p>
          </motion.div>
        ...
        <div className='container-max'>
          ...
          >
            ...
            <p className='text-xl mb-8 text-green-100 max-w-2xl mx-auto'>
              Start your permanent residence journey today with expert guidance
              and support
            </p>
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <motion.button
