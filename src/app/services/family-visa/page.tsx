...
const familyVisaTypes = [
  {
    ...
    description:
      'Reunite with your spouse or common-law partner in their country of residence.',
    requirements: [
  ...
  },
  {
    ...
    description:
      'Bring your dependent children to join you in your new country.',
    requirements: [
      'Birth certificates',
      'Custody documents',
      'Financial support',
  ...
  },
  {
    ...
    description:
      'Sponsor your parents for permanent residence or long-term visas.',
    requirements: [
      'Income requirements',
    ...
    programs: [
      {
        ...
        requirements: '3-year undertaking',
      },
      {
        name: 'Dependent Child',
        processing: '12 months',
        requirements: 'Under 22 years old',
      },
      {
        name: 'Parent/Grandparent Program',
        processing: '24-36 months',
        requirements: 'Income threshold',
      },
      {
        name: 'Super Visa',
        processing: '8 weeks',
        requirements: 'Medical insurance $100K+',
      },
    ],
  },
  {
    ...
    programs: [
      {
        ...
        requirements: 'Genuine relationship',
      },
      {
        name: 'Child Visa (101/802)',
        processing: '14-17 months',
        requirements: 'Dependency proof',
      },
      {
        name: 'Parent Visa (103/173)',
        processing: '30+ years',
        requirements: 'Assurance of support',
      },
      {
        name: 'Contributory Parent (143)',
        processing: '12-18 months',
        requirements: 'Contribution payment',
      },
    ],
  },
  {
    ...
    programs: [
      {
        ...
        requirements: 'Financial requirement £18,600',
      },
      {
        name: 'Child Dependent Visa',
        processing: '8-24 weeks',
      ...
      {
        name: 'Adult Dependent Relative',
        processing: '12+ months',
        requirements: 'Exceptional circumstances',
      },
    ],
  },
  {
    ...
    programs: [
      {
        name: 'IR-1/CR-1 Spouse',
        processing: '12-15 months',
        requirements: 'Petitioner must be USC/LPR',
      },
      {
        name: 'IR-2/CR-2 Child',
        processing: '8-12 months',
        requirements: 'Unmarried under 21',
      },
      {
        name: 'IR-5 Parent',
        processing: '8-12 months',
        requirements: 'Petitioner 21+ USC',
      },
      {
        name: 'F2A Spouse/Child LPR',
        processing: '24+ months',
        requirements: 'Priority date current',
      },
    ],
  },
];
...
const processSteps = [
  {
    ...
    description:
      'Comprehensive evaluation of your family situation and sponsorship eligibility',
    duration: '1-2 weeks',
    activities: [
  ...
  },
  {
    ...
    description:
      'Gathering and preparing all required documentation for the application',
    duration: '4-8 weeks',
    activities: [
      'Civil documents',
  ...
  },
  {
    ...
    description:
      'Complete application preparation and submission to immigration authorities',
    duration: '2-4 weeks',
    activities: [
      'Form completion',
  ...
  },
  {
    ...
    description:
      'Government processing, background checks, and potential interview scheduling',
...
export default function FamilyVisaPage() {
  return (
    <div className='min-h-screen bg-white'>
      <BackNavigation currentPage='Family Visa' />
        ...
        <div className='relative container-max'>
          ...
          >
            ...
            <p className='text-xl md:text-2xl mb-8 text-pink-100'>
              Reunite with your loved ones through our expert family sponsorship
        ...
        <div className='container-max'>
          ...
          >
            ...
            <p className='text-gray-600 max-w-2xl mx-auto'>
              Explore different family sponsorship options to bring your loved
              ones together
            </p>
          </motion.div>
        ...
        <div className='container-max'>
          ...
          >
            <h2 className='heading-lg mb-4'>
              Family Immigration Programs by Country
            </h2>
            <p className='text-gray-600 max-w-2xl mx-auto'>
              Each country offers specific family sponsorship programs with
              unique requirements and processing times
            </p>
          </motion.div>
      ...
      <section className='section-padding bg-gray-50'>
        <div className='container-max'>
          ...
          >
            ...
            <p className='text-gray-600 max-w-2xl mx-auto'>
              Choose the right level of support for your family immigration
              journey
            </p>
          </motion.div>
        ...
        <div className='container-max'>
          ...
          >
            ...
            <p className='text-xl mb-8 text-pink-100 max-w-2xl mx-auto'>
              Let our experienced team guide you through the family visa process
              and bring your loved ones home
            </p>
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <motion.button
                whileHover={{ scale: 1.05 }}
