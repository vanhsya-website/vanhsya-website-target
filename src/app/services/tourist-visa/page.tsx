...
const keyFeatures = [
  {
    ...
    description: "Get your visa approved in record time with our streamlined process.",
    icon: Zap,
...
const popularDestinations = [
  ...
  { name: "United Kingdom", flag: "🇬🇧", processing: "2-3 weeks", price: "$130" },
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            >
              Your gateway to hassle-free tourist visa applications. 
              Experience seamless travel with our AI-powered visa processing platform.
            </motion.p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-neutral-400 max-w-3xl mx-auto">
              Experience revolutionary tourist visa services with cutting-edge technology and unmatched expertise
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {keyFeatures.map((feature, index) => (
              ...
              >
                ...
                <motion.div
                  animate={activeFeature === index ? { scale: 1.1, rotateY: 180 } : { scale: 1, rotateY: 0 }}
                ...
                <div className="relative">
                  ...
                  <div className="flex items-center justify-between pt-6 border-t border-neutral-700/50">
                    <div>
                      ...
                      <div className="text-sm text-neutral-500">{feature.stats.label}</div>
                    </div>
                    <motion.div
      ...
      <section className="relative py-32 bg-gradient-to-br from-neutral-900/50 to-neutral-800/30">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-neutral-400 max-w-3xl mx-auto">
              Discover visa requirements and processing times for the world's most sought-after travel destinations
            </p>
          </motion.div>
              ...
              >
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-neutral-400 text-sm">Processing Time</span>
                    <span className="text-white font-medium">{destination.processing}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-neutral-400 text-sm">Starting Price</span>
                    <span className="text-green-400 font-bold">{destination.price}</span>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl text-neutral-400 mb-12 max-w-2xl mx-auto">
              Don't let visa complexities hold back your travel dreams. 
              Our expert team is ready to make your tourist visa application seamless and successful.
            </p>
            ...
            >
              <div className="flex flex-col md:flex-row items-center justify-center gap-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-neutral-300">24/7 Support Available</span>
                </div>
              </div>
            </motion.div>
          </motion.div>
