...
const WorkVisaPage: React.FC = () => {
  ...
  const processSteps = [
    {
      ...
      description:
        'Free assessment of your eligibility and best pathway options',
      duration: '30 minutes',
    },
    {
      step: '2',
      ...
      description:
        'Comprehensive checklist and guidance for all required documents',
      duration: '2-4 weeks',
    },
    {
      step: '3',
      ...
      description:
        'Professional preparation and review of your complete application',
      duration: '1-2 weeks',
    },
    {
      step: '4',
    ...
    },
    {
      ...
      description:
        'Mock interviews and coaching for visa interviews (if required)',
      duration: '1 week',
    },
    {
      step: '6',
  ...
  return (
    <div className='min-h-screen'>
      <BackNavigation currentPage='Work Visa' />
        ...
        <div className='container-max'>
          ...
          >
            ...
            <p className='text-xl md:text-2xl mb-8 text-blue-100 leading-relaxed'>
              Secure your professional future abroad with our comprehensive work
              visa services. From temporary work permits to permanent residency
              pathways.
            </p>
        ...
        <div className='container-max'>
          ...
          >
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              We specialize in work visa applications for the world's most
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12'>
            ...
            >
              ...
              <p className='text-gray-600 mb-8 leading-relaxed'>
                While specific requirements vary by country and visa type, most
                work visa applications require the following basic criteria to
                be met.
              </p>
              ...
              >
                ...
                <p className='text-blue-700 text-sm mb-4'>
                  Not sure if you qualify? Our experts will assess your profile
                  at no cost and recommend the best pathway for your situation.
                </p>
                <motion.button
                  whileHover={{ scale: 1.05 }}
            ...
            >
              ...
              <p className='text-gray-600 mb-8 leading-relaxed'>
                Our comprehensive work visa service covers every aspect of your
                application from initial assessment to post-approval support.
              </p>
      ...
      <section id='process' className='section-padding bg-white'>
        <div className='container-max'>
          ...
          >
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              A step-by-step approach that has helped thousands secure work
              visas worldwide
            </p>
          </motion.div>
      ...
      <section
        id='consultation'
        className='section-padding bg-blue-600 text-white'
      >
        <div className='container-max'>
          <motion.div
            initial={{ opacity: 0, y: 30 }}
          ...
          >
            ...
            <p className='text-xl mb-8 text-blue-100 max-w-3xl mx-auto'>
              Take the first step towards your international career. Our experts
              are ready to guide you through every step of the work visa
              process.
            </p>
