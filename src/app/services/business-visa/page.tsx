...
const processSteps = [
  {
    ...
    description:
      'Comprehensive evaluation of your business concept, financial capacity, and immigration goals.',
    duration: '1-2 weeks',
    activities: [
  ...
  },
  {
    ...
    description:
      'Identify the most suitable business immigration program based on your profile.',
    duration: '1 week',
    activities: [
      'Program comparison',
      'Country selection',
  ...
  },
  {
    ...
    description:
      'Create a comprehensive business plan meeting immigration requirements.',
    duration: '4-6 weeks',
    activities: [
      'Market research',
  ...
  },
  {
    ...
    description:
      'Compile all required documents and evidence for the application.',
    duration: '2-4 weeks',
    activities: [
  ...
  },
  {
    ...
    description:
      'Submit the complete application with supporting documentation.',
    duration: '1-2 weeks',
    activities: [
      'Application forms',
      'Document filing',
  ...
  },
  {
    ...
    description:
      'Support in setting up and operating the business post-approval.',
    duration: 'Ongoing',
    activities: [
...
export default function BusinessVisaPage() {
  return (
    <div className='min-h-screen bg-white'>
      <BackNavigation currentPage='Business Visa' />
        ...
        <div className='relative container-max'>
          ...
          >
            ...
            <p className='text-xl md:text-2xl mb-8 text-blue-100'>
              Transform your business vision into global opportunities with our
        ...
        <div className='container-max'>
          ...
          >
            ...
            <p className='text-gray-600 max-w-2xl mx-auto'>
              Explore investment and entrepreneur visa options across major
              destinations
            </p>
          </motion.div>
      ...
      <section className='section-padding bg-gray-50'>
        <div className='container-max'>
          ...
          >
            ...
            <p className='text-gray-600 max-w-2xl mx-auto'>
              Various business models and industries that qualify for business
      ...
      <section className='section-padding'>
        <div className='container-max'>
          ...
          >
            ...
            <p className='text-gray-600 max-w-2xl mx-auto'>
              A structured approach to guide you through every step of your
      ...
      <section className='section-padding bg-gray-50'>
        <div className='container-max'>
          ...
          >
            ...
            <p className='text-gray-600 max-w-2xl mx-auto'>
              Comprehensive packages designed to meet different business
              immigration needs
            </p>
          </motion.div>
        ...
        <div className='container-max'>
          ...
          >
            ...
            <p className='text-xl mb-8 text-blue-100'>
              Get expert guidance on the best business immigration strategy for
              your goals
            </p>
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <motion.button
