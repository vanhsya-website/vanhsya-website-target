...
import { Plane, Calendar, MapPin, Users, Star, Clock, Shield, CheckCircle, ArrowRight } from 'lucide-react';
        ...
        <div className="relative max-w-6xl mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl opacity-90 max-w-2xl mx-auto">
              Find and book the best flights for your immigration journey with our expert assistance
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 -mt-10 relative z-10">
          ...
          {activeTab === 'results' && (
            <div className="space-y-4">
              <div className="flex items-center justify-between mb-6">
                ...
                <p className="text-gray-600">{flightResults.length} flights found</p>
              </div>
                        ...
                        <div className="flex items-center space-x-1">
                          {[...Array(5)].map((_, i) => (
                            <Star
                              key={i}
                              className={`w-4 h-4 ${
                                i < Math.floor(flight.rating) ? 'text-yellow-400 fill-current' : 'text-gray-300'
                              }`}
                            />
                          ))}
                          <span className="text-sm text-gray-600 ml-1">{flight.rating}</span>
                        </div>
                      </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          ...
          >
            ...
            <p className="text-gray-600">Safe and secure flight booking with industry-standard encryption</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-600">Compare prices from multiple airlines to get the best deals</p>
          </motion.div>
        ...
        <motion.div
          ...
          className="bg-white rounded-2xl shadow-xl p-8 mb-12"
        >
          <h2 className="text-3xl font-bold text-gray-800 text-center mb-8">Why Choose VANHSYA Flight Booking?</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <CheckCircle className="w-6 h-6 text-green-600 mt-1" />
                <div>
                  <h4 className="font-semibold text-gray-800">Immigration-Specific Routes</h4>
                  <p className="text-gray-600">Specialized in routes for immigration and visa travel</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <CheckCircle className="w-6 h-6 text-green-600 mt-1" />
                <div>
                  <h4 className="font-semibold text-gray-800">Flexible Booking</h4>
                  <p className="text-gray-600">Easy date changes and cancellation policies</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <CheckCircle className="w-6 h-6 text-green-600 mt-1" />
                <div>
                  <h4 className="font-semibold text-gray-800">Expert Assistance</h4>
                  <p className="text-gray-600">Travel experts to help with visa-related flight requirements</p>
                </div>
              </div>
            </div>
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Special rates for families and group immigrations</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <CheckCircle className="w-6 h-6 text-green-600 mt-1" />
                <div>
                  <h4 className="font-semibold text-gray-800">Comprehensive Support</h4>
                  <p className="text-gray-600">End-to-end support from booking to arrival</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <CheckCircle className="w-6 h-6 text-green-600 mt-1" />
                <div>
                  <h4 className="font-semibold text-gray-800">Insurance Options</h4>
                  <p className="text-gray-600">Travel insurance and protection plans available</p>
                </div>
              </div>
            </div>
          </div>
