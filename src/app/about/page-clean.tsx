...
const values = [
  {
    ...
    description:
      'We leverage cutting-edge AI technology and innovative solutions to revolutionize the immigration experience.',
  ...
  },
  {
    ...
    description:
      'Complete transparency in our processes and pricing, building lasting relationships based on trust and integrity.',
    color: 'text-blue-400',
  },
  {
    icon: HeartIcon,
    ...
    description:
      'Your dreams become our mission. We provide personalized attention and genuine care throughout your journey.',
    color: 'text-pink-400',
  },
  {
    ...
    description:
      'Deep knowledge of immigration laws across 50+ countries with local insights and global perspective.',
        ...
        <div className='relative container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-12 leading-relaxed max-w-3xl mx-auto'>
              At VANHSYA, we're revolutionizing global migration with AI-powered
              solutions, expert guidance, and unwavering commitment to your
              success. Join 50,000+ dreamers who've turned their migration
        ...
        <div className='container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              Our values are the foundation of everything we do, ensuring that
              every interaction reflects our commitment to excellence and
              integrity.
            </p>
          </motion.div>
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto'>
            {values.map((value, index) => (
              ...
              >
                <div
                  className={`inline-flex items-center justify-center w-16 h-16 rounded-full bg-gray-100 mb-6 group-hover:scale-110 transition-transform`}
                >
        ...
        <div className='container mx-auto px-4 text-center'>
          ...
          >
            ...
            <p className='text-xl text-purple-100 mb-10 max-w-2xl mx-auto'>
              Join thousands of successful migrants who chose VANHSYA as their
              trusted partner. Your new life abroad is just one consultation
              away.
            </p>
            <div className='flex flex-col sm:flex-row gap-6 justify-center'>
              <motion.button
