        ...
        <div className='container-max'>
          ...
          >
            ...
            <p className='text-xl text-white/90 max-w-3xl mx-auto leading-relaxed'>
              Your privacy is fundamental to our service. Learn how we protect
          ...
          <div className='max-w-4xl mx-auto'>
            ...
            >
              ...
              <p className='text-gray-700 leading-relaxed mb-4'>
                VANHSYA Global Migration ("we," "our," or "us") is committed to
                protecting your privacy and personal information. This Privacy
                Policy explains how we collect, use, disclose, and safeguard
                your information when you use our immigration services, website,
                and client portal.
              </p>
                ...
                <div className='grid md:grid-cols-2 gap-4'>
                  <div className='bg-yellow-50 rounded-lg p-4 border border-yellow-200'>
                    ...
                    <p className='text-yellow-700 text-sm'>
                      When required for visa processing, immigration
                      applications, or legal compliance with local and
                      international laws.
                    </p>
                  </div>
                  ...
                  <div className='bg-red-50 rounded-lg p-4 border border-red-200'>
                    ...
                    <p className='text-red-700 text-sm'>
                      With trusted partners who assist in providing our
                  ...
                  <div className='bg-gray-50 rounded-lg p-4 border border-gray-200'>
                    ...
                    <p className='text-gray-700 text-sm'>
                      ...
                      for specific purposes or services.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className='space-y-4'>
                ...
                <div className='grid md:grid-cols-2 gap-6'>
                  <div className='flex items-center gap-3 p-4 bg-blue-50 rounded-lg'>
                    ...
                    <div>
                      ...
                      <p className='text-blue-700'>privacy@vanhsya.com</p>
                    </div>
                  </div>
                ...
                <div className='bg-gray-50 rounded-lg p-4 border border-gray-200'>
                  <p className='text-gray-700 text-sm'>
                    ...
                    changes by email or through our website. Your continued use
