...
const applicationData = {
  ...
  notifications: [
    {
      id: 1,
      message: 'Your work experience letter is under review',
      date: '2024-01-23',
      type: 'info',
    },
    {
      id: 2,
      message: 'Medical examination required by Feb 15',
      date: '2024-01-22',
      type: 'warning',
    },
    {
      id: 3,
      message: 'IELTS results approved',
      date: '2024-01-21',
      type: 'success',
    },
  ],
              ...
              >
                ...
                <div className='modern-card card-purple'>
                  ...
                  <p className='text-white/90 mb-4'>
                    Your {applicationData.profile.visaType} application for{' '}
                    {applicationData.profile.country} is progressing well.
                  </p>
                  <div className='flex items-center gap-4'>
                    <span className='text-white/80'>
                      Consultant: {applicationData.profile.consultant}
                    </span>
                ...
                <div className='grid md:grid-cols-3 gap-6'>
                  <div className='modern-card text-center'>
                    <div className='text-3xl font-bold text-gradient mb-2'>
                      {Math.round(
                        (applicationData.progress.currentStage /
                          applicationData.progress.stages.length) *
                          100
                      )}
                      %
                    </div>
              ...
              >
                ...
                <div className='text-center py-12'>
                  ...
                  <p className='text-gray-500 mb-6'>
                    Start a conversation with your consultant
                  </p>
