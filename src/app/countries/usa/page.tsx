...
const usaData = {
  ...
  flag: '🇺🇸',
  description:
    'The United States offers unparalleled opportunities for career growth, world-class education, and innovation. Explore various immigration pathways including EB visas, H-1B, student visas, and more.',
  ...
  whyChoose: [
    ...
    },
    {
      ...
      description:
        'Leading in scientific research and technological innovation',
    },
    {
    ...
    },
    {
      title: 'Career Growth',
      description:
        'Excellent career advancement opportunities across all sectors',
    },
  ],
  stats: [
...
export const metadata = {
  ...
  description:
    'Expert USA immigration services. H-1B, EB visas, Student Visa, and more. 78% success rate with professional guidance.',
  keywords:
    'usa immigration, usa visa, h1b visa, eb visa, usa student visa, usa migration',
};
