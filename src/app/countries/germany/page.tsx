...
const germanyData = {
  ...
  flag: '🇩🇪',
  description:
    'Germany offers excellent career opportunities, world-class education, and a high standard of living. Join millions who have made Germany their new home through various immigration pathways.',
  capital: 'Berlin',
  ...
  whyChoose: [
    {
      ...
      description:
        'German culture values work-life balance with generous vacation time',
    },
    {
      title: 'Social Security',
      description:
        'Comprehensive social security system protecting workers and families',
    },
    {
      title: 'Innovation Hub',
      description:
        'Leading technology and engineering sectors with career growth opportunities',
    },
    {
      title: 'Cultural Diversity',
      description:
        'Welcoming multicultural society with international communities',
    },
  ],
  stats: [
...
export const metadata = {
  ...
  description:
    'Expert Germany immigration services. EU Blue Card, Student Visa, Job Seeker Visa, and more. 91% success rate with professional guidance.',
  keywords:
    'germany immigration, germany visa, eu blue card, germany student visa, germany work visa, germany migration',
};
