...
import { ArrowRight, MapPin, DollarSign, Clock, CheckCircle, Star, TrendingUp } from 'lucide-react';
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-black text-white-enhanced mb-8">
              Explore <span className="text-gradient-red-blue">Immigration Destinations</span>
            </h1>
          ...
          >
            <h3 className="text-3xl font-black text-gradient-red-blue mb-8 text-center">2024 Popular Destinations</h3>
            <div className="grid grid-cols-2 md:grid-cols-6 gap-6">
              {popularDestinations.map((dest, index) => (
                ...
                >
                  <div className="text-2xl font-bold text-gradient-red-blue">{dest.percentage}</div>
                  <div className="text-readable-light text-sm font-semibold">{dest.country}</div>
                  <div className="text-green-500 text-xs font-medium">{dest.trend}</div>
                </motion.div>
              ))}
            </div>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-readable-light max-w-3xl mx-auto">
              Choose from our comprehensive range of immigration services designed to make your journey smooth and successful.
            </p>
          </motion.div>
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="text-center">
                    <div className="text-xl font-bold text-gradient-red-blue">{country.stats.programs}</div>
                    <div className="text-readable-light text-xs">Programs</div>
                  </div>
                  <div className="text-center">
                    <div className="text-xl font-bold text-gradient-red-blue">{country.stats.processing}</div>
                    <div className="text-readable-light text-xs">Processing</div>
                  </div>
                  <div className="text-center">
                    <div className="text-xl font-bold text-gradient-red-blue">{country.stats.success}</div>
                    <div className="text-readable-light text-xs">Success Rate</div>
                  </div>
                  <div className="text-center">
                    <div className="text-xl font-bold text-gradient-red-blue">{country.stats.investment}</div>
                    <div className="text-readable-light text-xs">Min. Investment</div>
                  </div>
                </div>
