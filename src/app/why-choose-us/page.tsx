  ...
  const reasons = [
    {
      ...
      description:
        'Industry-leading success rate with over 10,000 successful visa applications processed.',
    ...
    },
    {
      ...
      description:
        'Average processing time 40% faster than industry standard with dedicated case managers.',
    ...
    },
    {
      ...
      description:
        'Complete transparency in fees, processes, and timelines. No hidden charges ever.',
    ...
    },
    {
      ...
      title: 'Expert Team',
      description:
        'Licensed immigration consultants and lawyers with 15+ years of experience.',
    ...
    },
    {
      ...
      title: 'Global Reach',
      description:
        'Offices in 8 countries with local expertise for 50+ destinations worldwide.',
    ...
    },
    {
      ...
      description:
        'One-on-one support throughout your journey with dedicated case managers.',
      stats: '24/7 Support',
  ...
  const testimonials = [
    {
      ...
      quote:
        'VANHSYA made my Canadian PR dream come true. Their expertise and support were invaluable.',
      rating: 5,
    ...
    },
    {
      ...
      quote:
        'Professional service from start to finish. They guided me through every step of the process.',
      rating: 5,
    ...
    },
    {
      ...
      quote:
        'Exceptional service! They turned a complex process into a smooth journey.',
      rating: 5,
        ...
        <div className='max-w-6xl mx-auto text-center'>
          ...
          >
            ...
            <p className='text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed'>
              Experience the difference with our industry-leading immigration
              services. We've helped thousands achieve their global mobility
              dreams with unmatched expertise and care.
            </p>
          </motion.div>
        </div>
      </header>
          ...
          <div className='max-w-6xl mx-auto'>
            ...
            >
              ...
              <p className='text-slate-600 max-w-2xl mx-auto'>
                We're not just another immigration consultancy. Here's what
                makes VANHSYA the preferred choice for global migration.
              </p>
            </motion.div>
              ...
              {reasons.map((reason, index) => (
                ...
                >
                  <div className='flex items-center justify-between mb-6'>
                    <div
                      className={`p-3 rounded-2xl ${reason.color.split(' ')[0]} ${reason.color.split(' ')[1]}`}
                    >
                      <reason.icon
                        className={`w-6 h-6 ${reason.color.split(' ')[2]}`}
                      />
                    </div>
                    <span
                      className={`text-sm px-3 py-1 rounded-full font-medium ${reason.color}`}
                    >
                      {reason.stats}
                    </span>
                  </div>
        ...
        <section className='py-16 px-4 bg-white'>
          <div className='max-w-6xl mx-auto'>
            ...
            >
              ...
              <p className='text-slate-600 max-w-2xl mx-auto'>
                Real stories from real people who achieved their immigration
                goals with VANHSYA.
              </p>
            </motion.div>
          ...
          <div className='max-w-4xl mx-auto'>
            ...
            >
              ...
              <p className='text-xl mb-8 opacity-90 max-w-2xl mx-auto'>
                Join thousands of satisfied clients who chose VANHSYA for their
                immigration needs. Let's make your global mobility dream a
                reality.
              </p>
