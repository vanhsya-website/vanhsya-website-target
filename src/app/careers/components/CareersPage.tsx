...
// This component exports a comprehensive careers section showcasing job opportunities at VANHSYA
...
const jobPositions: JobPosition[] = [
  {
    ...
    description:
      'Lead the development of our revolutionary AI-powered immigration platform. Build and optimize machine learning models for document analysis, eligibility prediction, and intelligent consultation systems.',
    requirements: [
  ...
  },
  {
    ...
    description:
      'Provide expert immigration guidance to clients while working with our AI tools to deliver exceptional service. Help shape the future of immigration consulting.',
    requirements: [
  ...
  },
  {
    ...
    description:
      'Build and maintain our cutting-edge web platform that serves thousands of immigration applicants. Work with modern technologies and contribute to a platform that changes lives.',
    requirements: [
  ...
  },
  {
    ...
    description:
      'Design intuitive and beautiful user experiences that make immigration accessible to everyone. Create interfaces that combine AI power with human-centered design.',
    requirements: [
  ...
  },
  {
    ...
    description:
      'Lead the product strategy for our AI-powered immigration tools. Drive innovation and ensure our products deliver exceptional value to users worldwide.',
    requirements: [
  ...
  },
  {
    ...
    description:
      'Create compelling content that educates and inspires our global audience. Help tell the VANHSYA story and build our brand in the immigration space.',
    requirements: [
...
const benefits = [
  ...
  },
  {
    ...
    description:
      'Annual learning budget, conferences, and professional development opportunities',
  },
  {
  ...
  },
  {
    ...
    description:
      'Diverse, inclusive workplace with strong emphasis on work-life balance',
  },
];
...
const values = [
  {
    ...
    description:
      'We put people first in everything we build, ensuring our AI serves humanity.',
  },
  {
    title: 'Global Impact',
    description:
      'We believe in breaking down barriers and connecting people across borders.',
  },
  {
    title: 'Continuous Learning',
    description:
      'We foster a culture of curiosity, growth, and intellectual humility.',
  },
  {
    title: 'Transparency & Trust',
    description:
      'We operate with openness, honesty, and integrity in all our relationships.',
  },
];
...
export default function CareersPage() {
  ...
  return (
    <div className='min-h-screen bg-gray-50'>
      ...
      {/* Hero Section */}
      <section
        className={`relative pb-20 bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 text-white transition-all duration-300 ${
        ...
        <div className='relative container mx-auto px-6'>
          ...
          >
            ...
            <p className='text-xl md:text-2xl text-gray-200 mb-8 leading-relaxed'>
              Join our mission to transform the immigration industry with
              AI-powered solutions. Help millions of people achieve their dreams
              of living in their ideal country.
            </p>
        ...
        <div className='container mx-auto px-6 text-center'>
          ...
          >
            ...
            <p className='text-xl mb-8 opacity-90'>
              ...
              resume and let&apos;s start a conversation about how you can
            ...
            <div className='mt-12 p-6 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20'>
              ...
              <p className='text-purple-100 mb-4'>
                We&apos;re growing fast and regularly adding new positions.
                Follow us on social media or subscribe to our newsletter to be
                the first to know about new openings.
              </p>
              <div className='flex flex-wrap gap-4 justify-center'>
                ...
                <span className='px-4 py-2 bg-white/20 rounded-full text-sm'>
                  Newsletter: careers@vanhsya.com
                </span>
              </div>
            </div>
          </motion.div>
