...
export const metadata: Metadata = {
  ...
  description: "VANHSYA Global Migration - Your trusted migration partner. Expert guidance for work, study, family, and business visas with transparent pricing and verified success rates.",
  keywords: "migration, visa, work visa, study visa, migration services, visa consultation, immigration lawyer, family visa, business visa, permanent residence, global migration, visa processing, immigration consultant",
  authors: [{ name: "VANHSYA Global Migration" }],
  robots: "index, follow",
  openGraph: {
    title: "VANHSYA Global Migration - Expert Migration & Visa Services Worldwide",
    description: "VANHSYA Global Migration - Your trusted migration partner. Where your journey begins — safely, securely, and supported. Real migration. Real guidance. Real results.",
  ...
  twitter: {
    ...
    description: "VANHSYA Global Migration - Your trusted migration partner. Professional guidance for worldwide migration.",
