        ...
        <div className='max-w-6xl mx-auto px-4'>
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8'>
            {features.map((feature, index) => (
              ...
              >
                <div
                  className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl mb-6 ${feature.color}`}
                >
        ...
        <div className='max-w-4xl mx-auto px-4 text-center'>
          ...
          >
            ...
            <p className='text-xl mb-8 opacity-90 max-w-2xl mx-auto'>
              Join thousands of satisfied clients who achieved their global
              mobility dreams with VANHSYA. Get started with a free consultation
              today.
            </p>
